...
OpenIdDiscovery result = rc.wellKnown().openidConfiguration().get();
rc.revoke();
```

- `result` is of type [OpenIdDiscovery](./src/main/java/com/ringcentral/definitions/OpenIdDiscovery.java)
...
- `getRecordingInsightsParameters` is of type [GetRecordingInsightsParameters](./src/main/java/com/ringcentral/definitions/GetRecordingInsightsParameters.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
SessionsInsightsResource result = rc.ai().ringsense().v1().public().accounts(accountId).domains(domain).sessions(sourceSessionId).insights().get(getSessionInsightsParameters);
rc.revoke();
```

- `getSessionInsightsParameters` is of type [GetSessionInsightsParameters](./src/main/java/com/ringcentral/definitions/GetSessionInsightsParameters.java)
- `result` is of type [SessionsInsightsResource](./src/main/java/com/ringcentral/definitions/SessionsInsightsResource.java)
...
- Parameter `accountId` is optional with default value `~`
- `listAccountMeetingsParameters` is of type [ListAccountMeetingsParameters](./src/main/java/com/ringcentral/definitions/ListAccountMeetingsParameters.java)
...
- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `extractSyncAccountCallLogParameters` is of type [ExtractSyncAccountCallLogParameters](./src/main/java/com/ringcentral/definitions/ExtractSyncAccountCallLogParameters.java)
- `result` is of type [CallLogExtractSyncResponse](./src/main/java/com/ringcentral/definitions/CallLogExtractSyncResponse.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
SwitchInfo result = rc.restapi(apiVersion).account(accountId).emergencyAddressAutoUpdate().switches().post(switchInfo);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `switchInfo` is of type [SwitchInfo](./src/main/java/com/ringcentral/definitions/SwitchInfo.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
SwitchInfo result = rc.restapi(apiVersion).account(accountId).emergencyAddressAutoUpdate().switches(switchId).put(switchInfo);
rc.revoke();
```
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
GetExtensionInfoResponse result = rc.restapi(apiVersion).account(accountId).extension().post(extensionCreationRequest);
rc.revoke();
```
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CustomUserGreetingInfo result = rc.restapi(apiVersion).account(accountId).extension(extensionId).greeting().holdMusic().get();
rc.revoke();
```
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
GetSingleMessageInfoResponse result = rc.restapi(apiVersion).account(accountId).extension(extensionId).messageStore(messageId).get();
rc.revoke();
```
...
- Parameter `accountId` is optional with default value `~`
- Parameter `extensionId` is optional with default value `~`
- `result` is of type [GetSingleMessageInfoResponse](./src/main/java/com/ringcentral/definitions/GetSingleMessageInfoResponse.java)
...
- Parameter `accountId` is optional with default value `~`
- Parameter `extensionId` is optional with default value `~`
- `result` is of type [SmsConfigurationResource](./src/main/java/com/ringcentral/definitions/SmsConfigurationResource.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
PresenceInfoResponse result = rc.restapi(apiVersion).account(accountId).extension(extensionId).presence().get(readUserPresenceStatusParameters);
rc.revoke();
```
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
SmsRecipientsResource result = rc.restapi(apiVersion).account(accountId).extension(extensionId).smsRecipients().get();
rc.revoke();
```
...
- Parameter `accountId` is optional with default value `~`
- Parameter `extensionId` is optional with default value `~`
- `result` is of type [SmsRecipientsResource](./src/main/java/com/ringcentral/definitions/SmsRecipientsResource.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
String result = rc.restapi(apiVersion).account(accountId).extension(extensionId).smsRecipients().bulkAssign().post(bulkAssignSmsRecipientsRequest);
rc.revoke();
```
...
- Parameter `accountId` is optional with default value `~`
- Parameter `extensionId` is optional with default value `~`
- `bulkAssignSmsRecipientsRequest` is of type [BulkAssignSmsRecipientsRequest](./src/main/java/com/ringcentral/definitions/BulkAssignSmsRecipientsRequest.java)
- `result` is an empty string
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
WebAppDevicesResponse result = rc.restapi(apiVersion).account(accountId).extension(extensionId).webappDevices().get();
rc.revoke();
```
...
- Parameter `accountId` is optional with default value `~`
- Parameter `extensionId` is optional with default value `~`
- `result` is of type [WebAppDevicesResponse](./src/main/java/com/ringcentral/definitions/WebAppDevicesResponse.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
IvrMenuInfo result = rc.restapi(apiVersion).account(accountId).ivrMenus().post(ivrMenuInfoCreate);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `ivrMenuInfoCreate` is of type [IvrMenuInfoCreate](./src/main/java/com/ringcentral/definitions/IvrMenuInfoCreate.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
IvrMenuInfo result = rc.restapi(apiVersion).account(accountId).ivrMenus(ivrMenuId).put(ivrMenuInfoUpdate);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `ivrMenuInfoUpdate` is of type [IvrMenuInfoUpdate](./src/main/java/com/ringcentral/definitions/IvrMenuInfoUpdate.java)
- `result` is of type [IvrMenuInfo](./src/main/java/com/ringcentral/definitions/IvrMenuInfo.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
MessageThreadList result = rc.restapi(apiVersion).account(accountId).messageThreads().list(mthListThreadsParameters);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `mthListThreadsParameters` is of type [MthListThreadsParameters](./src/main/java/com/ringcentral/definitions/MthListThreadsParameters.java)
- `result` is of type [MessageThreadList](./src/main/java/com/ringcentral/definitions/MessageThreadList.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
MessageThread result = rc.restapi(apiVersion).account(accountId).messageThreads(threadId).get();
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `result` is of type [MessageThread](./src/main/java/com/ringcentral/definitions/MessageThread.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
String result = rc.restapi(apiVersion).account(accountId).messageThreads(threadId).delete();
rc.revoke();
```
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
MessageThread result = rc.restapi(apiVersion).account(accountId).messageThreads(threadId).assign().post(assignMessageThreadRequest);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `assignMessageThreadRequest` is of type [AssignMessageThreadRequest](./src/main/java/com/ringcentral/definitions/AssignMessageThreadRequest.java)
- `result` is of type [MessageThread](./src/main/java/com/ringcentral/definitions/MessageThread.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
MessageThread result = rc.restapi(apiVersion).account(accountId).messageThreads(threadId).resolve().post();
rc.revoke();
```
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
ThreadEntriesSyncList result = rc.restapi(apiVersion).account(accountId).messageThreads().entries().sync().get(mthSyncEntriesParameters);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `mthSyncEntriesParameters` is of type [MthSyncEntriesParameters](./src/main/java/com/ringcentral/definitions/MthSyncEntriesParameters.java)
- `result` is of type [ThreadEntriesSyncList](./src/main/java/com/ringcentral/definitions/ThreadEntriesSyncList.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
ThreadMessageList result = rc.restapi(apiVersion).account(accountId).messageThreads().messages().get(mthListMessagesParameters);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `mthListMessagesParameters` is of type [MthListMessagesParameters](./src/main/java/com/ringcentral/definitions/MthListMessagesParameters.java)
- `result` is of type [ThreadMessageList](./src/main/java/com/ringcentral/definitions/ThreadMessageList.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
ThreadMessageModel result = rc.restapi(apiVersion).account(accountId).messageThreads().messages().post(mthSendMessageRequest);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `mthSendMessageRequest` is of type [MthSendMessageRequest](./src/main/java/com/ringcentral/definitions/MthSendMessageRequest.java)
- `result` is of type [ThreadMessageModel](./src/main/java/com/ringcentral/definitions/ThreadMessageModel.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
String result = rc.restapi(apiVersion).account(accountId).messageThreads().messages().delete(threadMessagesDeleteRequest);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `threadMessagesDeleteRequest` is of type [ThreadMessagesDeleteRequest](./src/main/java/com/ringcentral/definitions/ThreadMessagesDeleteRequest.java)
- `result` is an empty string
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
byte[] result = rc.restapi(apiVersion).account(accountId).messageThreads().messages(messageId).content(attachmentId).get(mthReadMessageContentParameters);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `mthReadMessageContentParameters` is of type [MthReadMessageContentParameters](./src/main/java/com/ringcentral/definitions/MthReadMessageContentParameters.java)
- `result` is of type `byte[]`
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
ThreadNoteList result = rc.restapi(apiVersion).account(accountId).messageThreads().notes().get(mthListNotesParameters);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `mthListNotesParameters` is of type [MthListNotesParameters](./src/main/java/com/ringcentral/definitions/MthListNotesParameters.java)
- `result` is of type [ThreadNoteList](./src/main/java/com/ringcentral/definitions/ThreadNoteList.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
ThreadNoteModel result = rc.restapi(apiVersion).account(accountId).messageThreads().notes().post(threadNoteCreateRequest);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `threadNoteCreateRequest` is of type [ThreadNoteCreateRequest](./src/main/java/com/ringcentral/definitions/ThreadNoteCreateRequest.java)
- `result` is of type [ThreadNoteModel](./src/main/java/com/ringcentral/definitions/ThreadNoteModel.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
String result = rc.restapi(apiVersion).account(accountId).messageThreads().notes().delete(threadNotesDeleteRequest);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `threadNotesDeleteRequest` is of type [ThreadNotesDeleteRequest](./src/main/java/com/ringcentral/definitions/ThreadNotesDeleteRequest.java)
- `result` is an empty string
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
ThreadNoteModel result = rc.restapi(apiVersion).account(accountId).messageThreads().notes(noteId).patch(threadNoteUpdateRequest);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `threadNoteUpdateRequest` is of type [ThreadNoteUpdateRequest](./src/main/java/com/ringcentral/definitions/ThreadNoteUpdateRequest.java)
- `result` is of type [ThreadNoteModel](./src/main/java/com/ringcentral/definitions/ThreadNoteModel.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
ThreadSyncList result = rc.restapi(apiVersion).account(accountId).messageThreads().sync().get(mthSyncThreadsParameters);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `mthSyncThreadsParameters` is of type [MthSyncThreadsParameters](./src/main/java/com/ringcentral/definitions/MthSyncThreadsParameters.java)
- `result` is of type [ThreadSyncList](./src/main/java/com/ringcentral/definitions/ThreadSyncList.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
MsTeamsUserListResponse result = rc.restapi(apiVersion).account(accountId).msTeams().directRouting().users().get(listTeamsUsersParameters);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `listTeamsUsersParameters` is of type [ListTeamsUsersParameters](./src/main/java/com/ringcentral/definitions/ListTeamsUsersParameters.java)
- `result` is of type [MsTeamsUserListResponse](./src/main/java/com/ringcentral/definitions/MsTeamsUserListResponse.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
MsTeamsUserListResponse result = rc.restapi(apiVersion).account(accountId).msTeams().directRouting().users().post(connectTeamsUsersRequest);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `connectTeamsUsersRequest` is of type [ConnectTeamsUsersRequest](./src/main/java/com/ringcentral/definitions/ConnectTeamsUsersRequest.java)
- `result` is of type [MsTeamsUserListResponse](./src/main/java/com/ringcentral/definitions/MsTeamsUserListResponse.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
String result = rc.restapi(apiVersion).account(accountId).msTeams().directRouting().users().delete(disconnectTeamsUsersParameters);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `disconnectTeamsUsersParameters` is of type [DisconnectTeamsUsersParameters](./src/main/java/com/ringcentral/definitions/DisconnectTeamsUsersParameters.java)
- `result` is an empty string
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
BrandListResponse result = rc.restapi(apiVersion).account(accountId).smsRegistrationBrands().list();
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `result` is of type [BrandListResponse](./src/main/java/com/ringcentral/definitions/BrandListResponse.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
TcrBrandRecord result = rc.restapi(apiVersion).account(accountId).smsRegistrationBrands(tcrBrandId).get();
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `result` is of type [TcrBrandRecord](./src/main/java/com/ringcentral/definitions/TcrBrandRecord.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CampaignListResponse result = rc.restapi(apiVersion).account(accountId).smsRegistrationBrands(tcrBrandId).campaigns().list();
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `result` is of type [CampaignListResponse](./src/main/java/com/ringcentral/definitions/CampaignListResponse.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
TcrCampaignRecord result = rc.restapi(apiVersion).account(accountId).smsRegistrationBrands(tcrBrandId).campaigns(tcrCampaignId).get();
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `result` is of type [TcrCampaignRecord](./src/main/java/com/ringcentral/definitions/TcrCampaignRecord.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
String result = rc.restapi(apiVersion).account(accountId).smsRegistrationBrands(tcrBrandId).campaigns(tcrCampaignId).submitPhoneNumbers().post(assignNumbersRequest);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `assignNumbersRequest` is of type [AssignNumbersRequest](./src/main/java/com/ringcentral/definitions/AssignNumbersRequest.java)
- `result` is an empty string
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
RoleResource result = rc.restapi(apiVersion).account(accountId).userRole().post(roleResource, createCustomRoleParameters);
rc.revoke();
```
...
- `createCustomRoleParameters` is of type [CreateCustomRoleParameters](./src/main/java/com/ringcentral/definitions/CreateCustomRoleParameters.java)
...
- Parameter `accountId` is optional with default value `~`
- `roleResource` is of type [RoleResource](./src/main/java/com/ringcentral/definitions/RoleResource.java)
- `updateUserRoleParameters` is of type [UpdateUserRoleParameters](./src/main/java/com/ringcentral/definitions/UpdateUserRoleParameters.java)
- `result` is of type [RoleResource](./src/main/java/com/ringcentral/definitions/RoleResource.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
PermissionResource result = rc.restapi(apiVersion).dictionary().permission(permissionId).get(readPermissionParameters);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- `readPermissionParameters` is of type [ReadPermissionParameters](./src/main/java/com/ringcentral/definitions/ReadPermissionParameters.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
TimezoneInfoBase result = rc.restapi(apiVersion).dictionary().timezone(timezoneId).get();
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- `result` is of type [TimezoneInfoBase](./src/main/java/com/ringcentral/definitions/TimezoneInfoBase.java)
...
- `result` is of type [JWKeySet](./src/main/java/com/ringcentral/definitions/JWKeySet.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CommStatesResource result = rc.restapi().v2().accounts(accountId).extensions(extensionId).commHandling().states().list(listCicStatesParameters);
rc.revoke();
```

- `listCicStatesParameters` is of type [ListCicStatesParameters](./src/main/java/com/ringcentral/definitions/ListCicStatesParameters.java)
- `result` is of type [CommStatesResource](./src/main/java/com/ringcentral/definitions/CommStatesResource.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CommStateResource result = rc.restapi().v2().accounts(accountId).extensions(extensionId).commHandling().states(stateId).get();
rc.revoke();
```

- `result` is of type [CommStateResource](./src/main/java/com/ringcentral/definitions/CommStateResource.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CommStateResource result = rc.restapi().v2().accounts(accountId).extensions(extensionId).commHandling().states(stateId).patch(commStateUpdateRequest);
rc.revoke();
```

- `commStateUpdateRequest` is of type [CommStateUpdateRequest](./src/main/java/com/ringcentral/definitions/CommStateUpdateRequest.java)
- `result` is of type [CommStateResource](./src/main/java/com/ringcentral/definitions/CommStateResource.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CommForwardingTargetsResource result = rc.restapi().v2().accounts(accountId).extensions(extensionId).commHandling().voice().forwardingTargets().get(readForwardingTargetsParameters);
rc.revoke();
```

- `readForwardingTargetsParameters` is of type [ReadForwardingTargetsParameters](./src/main/java/com/ringcentral/definitions/ReadForwardingTargetsParameters.java)
- `result` is of type [CommForwardingTargetsResource](./src/main/java/com/ringcentral/definitions/CommForwardingTargetsResource.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CommRemoveForwardingTargetsResponse result = rc.restapi().v2().accounts(accountId).extensions(extensionId).commHandling().voice().forwardingTargets().delete(commRemoveForwardingTargetsRequest);
rc.revoke();
```

- `commRemoveForwardingTargetsRequest` is of type [CommRemoveForwardingTargetsRequest](./src/main/java/com/ringcentral/definitions/CommRemoveForwardingTargetsRequest.java)
- `result` is of type [CommRemoveForwardingTargetsResponse](./src/main/java/com/ringcentral/definitions/CommRemoveForwardingTargetsResponse.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CommExtensionListResource result = rc.restapi().v2().accounts(accountId).extensions(extensionId).commHandling().voice().forwardingTargets().devices(deviceId).extensions().get();
rc.revoke();
```

- `result` is of type [CommExtensionListResource](./src/main/java/com/ringcentral/definitions/CommExtensionListResource.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CommInteractionRulesResource result = rc.restapi().v2().accounts(accountId).extensions(extensionId).commHandling().voice().interactionRules().list(listVoiceInteractionRulesParameters);
rc.revoke();
```

- `listVoiceInteractionRulesParameters` is of type [ListVoiceInteractionRulesParameters](./src/main/java/com/ringcentral/definitions/ListVoiceInteractionRulesParameters.java)
- `result` is of type [CommInteractionRulesResource](./src/main/java/com/ringcentral/definitions/CommInteractionRulesResource.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CommInteractionRuleResource result = rc.restapi().v2().accounts(accountId).extensions(extensionId).commHandling().voice().interactionRules().post(commInteractionRuleCreateRequest);
rc.revoke();
```

- `commInteractionRuleCreateRequest` is of type [CommInteractionRuleCreateRequest](./src/main/java/com/ringcentral/definitions/CommInteractionRuleCreateRequest.java)
- `result` is of type [CommInteractionRuleResource](./src/main/java/com/ringcentral/definitions/CommInteractionRuleResource.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CommInteractionRuleResource result = rc.restapi().v2().accounts(accountId).extensions(extensionId).commHandling().voice().interactionRules(ruleId).get();
rc.revoke();
```
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
String result = rc.restapi().v2().accounts(accountId).extensions(extensionId).commHandling().voice().interactionRules(ruleId).delete();
rc.revoke();
```
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CommInteractionRuleResource result = rc.restapi().v2().accounts(accountId).extensions(extensionId).commHandling().voice().interactionRules(ruleId).patch(commInteractionRuleUpdateRequest);
rc.revoke();
```

- `commInteractionRuleUpdateRequest` is of type [CommInteractionRuleUpdateRequest](./src/main/java/com/ringcentral/definitions/CommInteractionRuleUpdateRequest.java)
- `result` is of type [CommInteractionRuleResource](./src/main/java/com/ringcentral/definitions/CommInteractionRuleResource.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CommStateBasedRulesResource result = rc.restapi().v2().accounts(accountId).extensions(extensionId).commHandling().voice().stateRules().list(listVoiceStateBasedRulesParameters);
rc.revoke();
```

- `listVoiceStateBasedRulesParameters` is of type [ListVoiceStateBasedRulesParameters](./src/main/java/com/ringcentral/definitions/ListVoiceStateBasedRulesParameters.java)
- `result` is of type [CommStateBasedRulesResource](./src/main/java/com/ringcentral/definitions/CommStateBasedRulesResource.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CommStateBasedRuleResource result = rc.restapi().v2().accounts(accountId).extensions(extensionId).commHandling().voice().stateRules(stateId).get();
rc.revoke();
```

- `result` is of type [CommStateBasedRuleResource](./src/main/java/com/ringcentral/definitions/CommStateBasedRuleResource.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CommStateBasedRuleResource result = rc.restapi().v2().accounts(accountId).extensions(extensionId).commHandling().voice().stateRules(stateId).patch(commStateBasedRuleUpdateRequest);
rc.revoke();
```

- `commStateBasedRuleUpdateRequest` is of type [CommStateBasedRuleUpdateRequest](./src/main/java/com/ringcentral/definitions/CommStateBasedRuleUpdateRequest.java)
- `result` is of type [CommStateBasedRuleResource](./src/main/java/com/ringcentral/definitions/CommStateBasedRuleResource.java)
...
- `accountRegionalSettingRequest` is of type [AccountRegionalSettingRequest](./src/main/java/com/ringcentral/definitions/AccountRegionalSettingRequest.java)
- `result` is of type [RegionalSettings](./src/main/java/com/ringcentral/definitions/RegionalSettings.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
OptRecordsModificationSummary result = rc.restapi().v2().accounts(accountId).sms().consents().patch(updateOptRecordList);
rc.revoke();
```

- `updateOptRecordList` is of type [UpdateOptRecordList](./src/main/java/com/ringcentral/definitions/UpdateOptRecordList.java)
- `result` is of type [OptRecordsModificationSummary](./src/main/java/com/ringcentral/definitions/OptRecordsModificationSummary.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
String result = rc.restapi().v2().accounts(accountId).sms().consents().export().get();
rc.revoke();
```
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
ConsentHistoryRecordList result = rc.restapi().v2().accounts(accountId).sms().consents().history().get(listSmsConsentHistoryRecordsParameters);
rc.revoke();
```

- `listSmsConsentHistoryRecordsParameters` is of type [ListSmsConsentHistoryRecordsParameters](./src/main/java/com/ringcentral/definitions/ListSmsConsentHistoryRecordsParameters.java)
- `result` is of type [ConsentHistoryRecordList](./src/main/java/com/ringcentral/definitions/ConsentHistoryRecordList.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
OptRecordList result = rc.restapi().v2().accounts(accountId).sms().consents().search().post(searchSmsConsentRecordsRequest);
rc.revoke();
```

- `searchSmsConsentRecordsRequest` is of type [SearchSmsConsentRecordsRequest](./src/main/java/com/ringcentral/definitions/SearchSmsConsentRecordsRequest.java)
- `result` is of type [OptRecordList](./src/main/java/com/ringcentral/definitions/OptRecordList.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
ParsePhoneNumberResponseV2 result = rc.restapi().v2().numberParser().parse().post(parsePhoneNumbersRequest);
rc.revoke();
```

- `parsePhoneNumbersRequest` is of type [ParsePhoneNumbersRequest](./src/main/java/com/ringcentral/definitions/ParsePhoneNumbersRequest.java)
- `result` is of type [ParsePhoneNumberResponseV2](./src/main/java/com/ringcentral/definitions/ParsePhoneNumberResponseV2.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
TMPostsList result = rc.teamMessaging().v1().chats(chatId).threads(threadId).posts().get(readGlipThreadPostsNewParameters);
rc.revoke();
```

- `readGlipThreadPostsNewParameters` is of type [ReadGlipThreadPostsNewParameters](./src/main/java/com/ringcentral/definitions/ReadGlipThreadPostsNewParameters.java)
- `result` is of type [TMPostsList](./src/main/java/com/ringcentral/definitions/TMPostsList.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
HistoryWebinarResource result = rc.webinar().history().v1().webinars(webinarId).get();
rc.revoke();
```

- `result` is of type [HistoryWebinarResource](./src/main/java/com/ringcentral/definitions/HistoryWebinarResource.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
HistorySessionResource result = rc.webinar().history().v1().webinars(webinarId).sessions(sessionId).get();
rc.revoke();
```

- `result` is of type [HistorySessionResource](./src/main/java/com/ringcentral/definitions/HistorySessionResource.java)

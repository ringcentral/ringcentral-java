...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CloudRecordings result = rc.rcvideo().v1().account(accountId).recordings().list(getAccountRecordingsParameters);
rc.revoke();
```
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CloudRecording result = rc.rcvideo().v1().account(accountId).recordings(recordingId).get();
rc.revoke();
```

- Parameter `accountId` is optional with default value `~`
- `result` is of type [CloudRecording](./src/main/java/com/ringcentral/definitions/CloudRecording.java)
...
- `result` is of type [EmergencyLocationResource](./src/main/java/com/ringcentral/definitions/EmergencyLocationResource.java)
...
- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `forwardAllCompanyCallsInfo` is of type [ForwardAllCompanyCallsInfo](./src/main/java/com/ringcentral/definitions/ForwardAllCompanyCallsInfo.java)
- `result` is of type [ForwardAllCompanyCallsInfo](./src/main/java/com/ringcentral/definitions/ForwardAllCompanyCallsInfo.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CloudRecordings result = rc.rcvideo().v1().account(accountId).extension(extensionId).recordings().list(getExtensionRecordingsParameters);
rc.revoke();
```
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
CloudRecording result = rc.rcvideo().v1().account(accountId).extension(extensionId).recordings(recordingId).get();
rc.revoke();
```
...
- `rcvListDelegatorsParameters` is of type [RcvListDelegatorsParameters](./src/main/java/com/ringcentral/definitions/RcvListDelegatorsParameters.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
WcsSessionResource result = rc.webinar().configuration().v1().webinars(webinarId).sessions().post(wcsSessionBaseModel);
rc.revoke();
```

- `wcsSessionBaseModel` is of type [WcsSessionBaseModel](./src/main/java/com/ringcentral/definitions/WcsSessionBaseModel.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
WcsSessionResource result = rc.webinar().configuration().v1().webinars(webinarId).sessions(sessionId).patch(wcsSessionBaseModel);
rc.revoke();
```
...
- Parameter `accountId` is optional with default value `~`
- Parameter `extensionId` is optional with default value `~`
- `emergencyLocationResource` is of type [EmergencyLocationResource](./src/main/java/com/ringcentral/definitions/EmergencyLocationResource.java)
- `result` is of type [EmergencyLocationResource](./src/main/java/com/ringcentral/definitions/EmergencyLocationResource.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
String result = rc.restapi(apiVersion).account(accountId).telephony().sessions(telephonySessionId).parties().move().post(movePartiesRequest);
rc.revoke();
```

- Parameter `apiVersion` is optional with default value `v1.0`
- Parameter `accountId` is optional with default value `~`
- `movePartiesRequest` is of type [MovePartiesRequest](./src/main/java/com/ringcentral/definitions/MovePartiesRequest.java)
- `result` is an empty string
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
RegistrantModelResponsePost result = rc.webinar().registration().v1().sessions(sessionId).registrants().post(registrantBaseModel);
rc.revoke();
```

- `registrantBaseModel` is of type [RegistrantBaseModel](./src/main/java/com/ringcentral/definitions/RegistrantBaseModel.java)
- `result` is of type [RegistrantModelResponsePost](./src/main/java/com/ringcentral/definitions/RegistrantModelResponsePost.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
RegistrantModel result = rc.webinar().registration().v1().sessions(sessionId).registrants(registrantId).get(rcwRegGetRegistrantParameters);
rc.revoke();
```
...
- `result` is of type [RegistrantModel](./src/main/java/com/ringcentral/definitions/RegistrantModel.java)
...
RestClient rc = new RestClient(clientID, clientSecret, serverURL);
rc.authorize(jwtToken);
String result = rc.restapi(apiVersion).account(accountId).telephony().sessions(telephonySessionId).parties().promoteToRcv().post();
rc.revoke();
```

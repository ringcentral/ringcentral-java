...
public class AccountHistoryPaging {
     ...
     * parameter from the request Maximum: 1000 Minimum: 1 Format: int32 Example: 50
     */
    public Long perPage;
    ...
    /**
     * Total number of elements in a dataset. May be omitted for some resources due to performance
     * reasons Format: int32 Example: 25
     */

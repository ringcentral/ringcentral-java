...
public class AccountHistorySearchPublicRequest {
    /**
     * The beginning of the time range to return records in ISO 8601 format in UTC timezone, default
     * is &quot;eventTimeFrom&quot;-24 hours Format: date-time
     */
    ...
    /**
     * The end of the time range to return records in ISO 8601 format in UTC timezone, default is
     * the current time Format: date-time
     */
    ...
    /**
     * List of action IDs (exact keys) to search for (alternatively &quot;excludeActionIds&quot;
     * option can be used). Example: CHANGE_SECRET_INFO,CHANGE_USER_INFO
     */
     ...
     *
     * <p>- initiator.name - initiator.role - initiator.extensionNumber - target.name -
     * target.extensionNumber - details.parameters.value Example: 542617
     */
    ...
    /**
     * List of action IDs (exact keys) to exclude from your search (alternatively
     * &quot;actionIds&quot; option can be used). Example: CHANGE_SECRET_INFO,CHANGE_USER_INFO
     */

...
public class AccountInfo {
    ...
    /**
     * External account ID. Used as a primary key to link accounts between RingCentral and partner
     * systems. Example: acme-us-12345
     */
    ...
    /** Status of an account Required Enum: Initial, Unconfirmed, Confirmed, Disabled */

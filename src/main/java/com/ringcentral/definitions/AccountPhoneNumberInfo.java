...
public class AccountPhoneNumberInfo {
    ...
    /**
     * Usage type of a phone number Required Enum: MainCompanyNumber, DirectNumber, Inventory,
    ...
    public AccountPhoneNumberInfo contactCenterProvider(
     ...
     * Otherwise, it is an external number not yet ported to RingCentral Required Enum: Normal,
     * Pending, PortedIn, Temporary, Unknown
     */

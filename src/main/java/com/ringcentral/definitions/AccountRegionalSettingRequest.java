...
public class AccountRegionalSettingRequest {
    ...
    public AccountRegionalSettingRequest greetingLanguage(
            AccountGreetingLanguageInfoRequest greetingLanguage) {
    ...
    public AccountRegionalSettingRequest formattingLocale(
            AccountFormattingLocaleInfoRequest formattingLocale) {

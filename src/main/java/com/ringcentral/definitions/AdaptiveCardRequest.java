...
public class AdaptiveCardRequest {
    /**
     * Type of attachment. This field is mandatory and filled on server side - will be ignored if
     * set in request body Required Enum: AdaptiveCard
     */
    public String type;
    ...
    /**
     * Version. This field is mandatory and filled on server side - will be ignored if set in
     * request body Required Default: 1.3
     */
    ...
    /**
     * Defines how the content should be aligned vertically within the container. Only relevant for
     * fixed-height cards, or cards with a `minHeight` specified Enum: top, center, bottom
     */

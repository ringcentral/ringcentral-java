...
public class AddDeviceToInventoryRequest {
    /**
     * Device type. Use `OtherPhone` to indicate BYOD (customer provided) device Required Enum:
     * OtherPhone
     */
    public String type;
    ...
    /**
     * Quantity of devices (total quantity should not exceed 50) Required Maximum: 50 Minimum: 1
     * Format: int32
     */

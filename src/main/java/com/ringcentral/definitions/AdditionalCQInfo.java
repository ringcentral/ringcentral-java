...
public class AdditionalCQInfo {
    /**
     * Call information to be displayed as &#039;Line 2&#039; for a call queue call session Enum:
     * PhoneNumberLabel, PhoneNumber, QueueExtension, QueueName, CallerIdName, CallerIdNumber, None
     */
    public String type;

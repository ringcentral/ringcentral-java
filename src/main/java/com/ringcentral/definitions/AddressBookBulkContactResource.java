...
public class AddressBookBulkContactResource {
    ...
    /**
     * Second home phone number of a contact in e.164 (with &quot;+&quot;) format Example:
     * +15551234567
     */
    ...
    /**
     * Phone number of a contact assistant in e.164 (with &quot;+&quot;) format Example:
     * +15551234567
     */
    ...
    public AddressBookBulkContactResource businessAddress(
            AddressBookBulkContactAddressInfo businessAddress) {
    ...
    public AddressBookBulkContactResource homeAddress(
            AddressBookBulkContactAddressInfo homeAddress) {
    ...
    public AddressBookBulkContactResource otherAddress(
            AddressBookBulkContactAddressInfo otherAddress) {

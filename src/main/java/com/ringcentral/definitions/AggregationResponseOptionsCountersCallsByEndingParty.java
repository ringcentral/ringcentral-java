...
public class AggregationResponseOptionsCountersCallsByEndingParty {
    ...
    public AggregationResponseOptionsCountersCallsByEndingParty aggregationType(
    ...
    public AggregationResponseOptionsCountersCallsByEndingParty aggregationInterval(

...
/**
 * The formula is defined by `aggregationType` and `aggregationInterval` for every timer
 * individually. If `aggregationType` is `Sum` or `Percent`, `aggregationInterval` is not supported.
 * If `aggregationType` is `Min`, `Max` or `Average`, `aggregationInterval` is supported, but not
 * required. If left empty, aggregation will be performed on per-call basis
 */
public class AggregationResponseOptionsTimers {
    ...
    public AggregationResponseOptionsTimers allCallsDuration(
            AggregationResponseOptionsTimersAllCallsDuration allCallsDuration) {
    ...
    public AggregationResponseOptionsTimers callsDurationByDirection(
            AggregationResponseOptionsTimersCallsDurationByDirection callsDurationByDirection) {
    ...
    public AggregationResponseOptionsTimers callsDurationByOrigin(
            AggregationResponseOptionsTimersCallsDurationByOrigin callsDurationByOrigin) {
    ...
    public AggregationResponseOptionsTimers callsDurationByResponse(
            AggregationResponseOptionsTimersCallsDurationByResponse callsDurationByResponse) {
        this.callsDurationByResponse = callsDurationByResponse;
        return this;
    }

    /**
     * Aggregation of calls duration by segments (Ringing, LiveTalk, Hold, Park, Transfer,
     * IvrPrompt, Voicemail, VmGreeting, Setup)
     */
    public AggregationResponseOptionsTimersCallsSegmentsDuration callsSegmentsDuration;

    public AggregationResponseOptionsTimers callsSegmentsDuration(
    ...
    /**
     * Aggregation of calls duration by result (Completed, Abandoned, Voicemail, Unknown, Missed,
    ...
    public AggregationResponseOptionsTimers callsDurationByResult(
            AggregationResponseOptionsTimersCallsDurationByResult callsDurationByResult) {
    ...
    public AggregationResponseOptionsTimers callsDurationByCompanyHours(
    ...
    /**
     * Aggregation of calls duration by queue SLA (InSLA, OutSLA). This timer is only applicable to
     * Queues grouping
     */
    public AggregationResponseOptionsTimersCallsDurationByQueueSla callsDurationByQueueSla;

    public AggregationResponseOptionsTimers callsDurationByQueueSla(
            AggregationResponseOptionsTimersCallsDurationByQueueSla callsDurationByQueueSla) {
        this.callsDurationByQueueSla = callsDurationByQueueSla;
        return this;
    }

    /**
     * Aggregation of calls duration by type (Direct, FromQueue, ParkRetrieval, Transferred,
     * Outbound, QueueCallPickup)
     */
    public AggregationResponseOptionsTimersCallsDurationByType callsDurationByType;

    public AggregationResponseOptionsTimers callsDurationByType(
            AggregationResponseOptionsTimersCallsDurationByType callsDurationByType) {
    ...
    public AggregationResponseOptionsTimers callsDurationByEndingParty(
            AggregationResponseOptionsTimersCallsDurationByEndingParty callsDurationByEndingParty) {
    ...
    public AggregationResponseOptionsTimers callsDurationByQueueHours(
            AggregationResponseOptionsTimersCallsDurationByQueueHours callsDurationByQueueHours) {

...
public class AggregationResponseOptionsTimersCallsDurationByDirection {
    ...
    public AggregationResponseOptionsTimersCallsDurationByDirection aggregationType(
    ...
    public AggregationResponseOptionsTimersCallsDurationByDirection aggregationInterval(

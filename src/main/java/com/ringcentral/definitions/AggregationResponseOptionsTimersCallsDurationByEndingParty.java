...
public class AggregationResponseOptionsTimersCallsDurationByEndingParty {
    ...
    public AggregationResponseOptionsTimersCallsDurationByEndingParty aggregationType(
    ...
    public AggregationResponseOptionsTimersCallsDurationByEndingParty aggregationInterval(

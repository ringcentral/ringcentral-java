...
public class AggregationResponseOptionsTimersCallsDurationByQueueHours {
    ...
    public AggregationResponseOptionsTimersCallsDurationByQueueHours aggregationType(
    ...
    public AggregationResponseOptionsTimersCallsDurationByQueueHours aggregationInterval(

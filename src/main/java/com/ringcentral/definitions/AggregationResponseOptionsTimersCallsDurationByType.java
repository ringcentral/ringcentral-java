...
public class AggregationResponseOptionsTimersCallsDurationByType {
    ...
    public AggregationResponseOptionsTimersCallsDurationByType aggregationType(
    ...
    public AggregationResponseOptionsTimersCallsDurationByType aggregationInterval(

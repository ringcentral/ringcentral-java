...
public class AggregationResponseOptionsTimersCallsSegmentsDuration {
    ...
    public AggregationResponseOptionsTimersCallsSegmentsDuration aggregationType(
    ...
    public AggregationResponseOptionsTimersCallsSegmentsDuration aggregationInterval(

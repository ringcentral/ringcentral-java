...
public class BatchProvisionUsersRequestItem {
    ...
    /**
     * Extension status. Only &quot;Enabled&quot; can be specified Required Default: Enabled Enum:
     * Enabled
     */
    ...
    public BatchProvisionUsersRequestItem costCenter(
            BatchProvisionUsersRequestItemCostCenter costCenter) {

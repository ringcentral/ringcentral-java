...
public class BridgeJoinPreferences {
     ...
     * waiting room. Participants are not waiting for meeting start. 2) `Everybody` - All
     * participants are waiting for meeting start. 3) `GuestsOnly` - Only unauthenticated
     * participants (guests) are waiting for meeting start. 4) `OtherAccount` - Only participants
     * who have other account are waiting for meeting start.
     *
     * <p>Default value depends on the bridge type: - PMI -&gt; OtherAccount - Instant, Scheduled
     * -&gt; Nobody Example: Nobody Enum: Nobody, Everybody, GuestsOnly, OtherAccount
     */

...
public class BulkAccountCallRecordingsResource {
    ...
    public BulkAccountCallRecordingsResource addedExtensions(
            CallRecordingExtensionResource[] addedExtensions) {
    ...
    public BulkAccountCallRecordingsResource updatedExtensions(
            CallRecordingExtensionResource[] updatedExtensions) {
    ...
    public BulkAccountCallRecordingsResource removedExtensions(
            CallRecordingExtensionResource[] removedExtensions) {

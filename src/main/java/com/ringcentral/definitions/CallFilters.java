...
public class CallFilters {
    ...
    /**
     * List of queues extension ids which allows to get data only for calls that were routed through
     * any of these queues
     */
    ...
    /**
     * Specifies the call directions relative to the scope specified in grouping object (joined via
     * OR). Not applicable to internal origin calls with company scope Enum: Inbound, Outbound
     */
    ...
    /**
     * Specifies whether an external party was present in the initial segment of the call (joined
     * via OR) Enum: Internal, External
     */
    ...
    /**
     * Filtering of calls by first response (joined via OR) Enum: Answered, NotAnswered, Connected,
     * NotConnected
     */
    ...
    /**
     * Filtering of calls by the nature of call result (joined via OR) Enum: Completed, Abandoned,
     * Voicemail, Unknown, Missed, Accepted, Transferred, PickedUp, Forwarded, AnsweredElsewhere
     */
    ...
    /**
     * Filtering of calls by presence of specific action (joined via OR) Enum: HoldOff, HoldOn,
    ...
    /**
     * Filtering of calls by company&#039;s business hours or after hours (joined via OR) Enum:
    ...
    /**
     * Filtering calls that were within or out of queue SLA (joined via OR). Only applicable to
     * Queues grouping Enum: InSla, OutSla
     */
    ...
    /**
     * Filtering of calls based on how the call started from the callee perspective (joined via OR).
     * If the call is outbound relative to the grouping scope, CallType is Outbound Enum: Direct,
     * FromQueue, ParkRetrieval, Transferred, Outbound, Overflow, QueueCallPickup
     */
    ...
    /**
     * Filtering of calls based on the party that ended that call (joined via OR) Enum: Caller,
     * Callee, System
     */
    ...
    /**
     * Filtering of calls by queue&#039;s business hours or after hours (joined via OR). Only
     * applicable to Queues grouping Enum: BusinessHours, AfterHours
     */

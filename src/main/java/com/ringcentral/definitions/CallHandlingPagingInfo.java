...
public class CallHandlingPagingInfo {
    ...
    public CallHandlingPagingInfo page(Long page) {
        this.page = page;
        return this;
    }

    public CallHandlingPagingInfo perPage(Long perPage) {
        this.perPage = perPage;
        return this;
    }

    public CallHandlingPagingInfo pageStart(Long pageStart) {
        this.pageStart = pageStart;
        return this;
    }

    public CallHandlingPagingInfo pageEnd(Long pageEnd) {
        this.pageEnd = pageEnd;
        return this;
    }

    public CallHandlingPagingInfo totalPages(Long totalPages) {
        this.totalPages = totalPages;
        return this;
    }

    public CallHandlingPagingInfo totalElements(Long totalElements) {

...
public class CallLogParty {
     ...
     * or sending/receiving Company Pager message
     */
    ...
    /**
     * Contains party location (city, state) if one can be determined from phoneNumber. This
     * property is filled only when phoneNumber is not empty and server can calculate location

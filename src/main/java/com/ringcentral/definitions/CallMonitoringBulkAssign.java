...
public class CallMonitoringBulkAssign {
    ...
    public CallMonitoringBulkAssign updatedExtensions(
            CallMonitoringExtensionInfo[] updatedExtensions) {
    ...
    public CallMonitoringBulkAssign removedExtensions(
            CallMonitoringExtensionInfo[] removedExtensions) {

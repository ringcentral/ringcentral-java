...
public class CallMonitoringExtensionInfo {
    ...
    /**
     * Set of call monitoring group permissions granted to a specified extension. In order to remove
     * a specified extension from a call monitoring group use an empty value Enum: Monitoring,
     * Monitored
     */

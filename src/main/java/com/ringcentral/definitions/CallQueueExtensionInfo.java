...
/**
 * For Call Queue extension type only. Please note that legacy 'Department' extension type
...
public class CallQueueExtensionInfo {
    ...
    /**
     * Period of time in seconds specifying abandoned calls duration - calls that are shorter will
     * not be included into the calculation of service level.; zero value means that abandoned calls
     * of any duration will be included into calculation Format: int32
     */

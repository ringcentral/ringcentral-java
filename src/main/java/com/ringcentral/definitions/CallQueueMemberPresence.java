...
public class CallQueueMemberPresence {
    ...
    /**
     * Private member telephony availability status applied to calls of all queues. Please note -
     * this parameter can be passed in request body, but will be ignored
     */

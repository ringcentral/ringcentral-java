...
public class CallStatusInfo {
    /**
     * Status code of a call Enum: Setup, Proceeding, Answered, Disconnected, Gone, Parked, Hold,
     * VoiceMail, FaxReceive, Tds, VoiceMailScreening
     */
    public String code;
    ...
    /**
     * Reason for a call status, might be specified for some codes Enum: Pickup, Supervising,
     * TakeOver, Timeout, BlindTransfer, RccTransfer, AttendedTransfer, CallerInputRedirect,
     * CallFlip, ParkLocation, DtmfTransfer, AgentAnswered, AgentDropped, Rejected, Cancelled,
     * InternalError, NoAnswer, TargetBusy, InvalidNumber, InternationalDisabled,
     * DestinationBlocked, NotEnoughFunds, NoSuchUser, CallPark, CallRedirected, CallReplied,
     * CallSwitch, CallFinished, CallDropped, Voicemail
     */

...
public class CallsByResultBreakdown {
    ...
    /** Value for Transferred result Required Format: double */
    ...
    /** Value for PickedUp result Required Format: double */
    ...
    /** Value for AnsweredElsewhere result Required Format: double */
    ...
    /** Value for Forwarded result Required Format: double */

...
public class CallsByTypeBreakdown {
    ...
    /** Value for FromQueue type Required Format: double */
    ...
    /** Value for ParkRetrieval type Required Format: double */
    ...
    /** Value for QueueCallPickup type Required Format: double */

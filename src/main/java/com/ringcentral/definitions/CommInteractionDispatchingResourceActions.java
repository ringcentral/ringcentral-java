...
public class CommInteractionDispatchingResourceActions {
    ...
    public CommInteractionDispatchingResourceActions targets(
            CommInteractionDispatchingResourceActionsTargets[] targets) {
        this.targets = targets;
        return this;
    }

    /**
     * Custom start time in seconds. Applicable for &#039;Custom&#039; dispatching type Format:
     * int32 Example: 5
     */
    ...
    /** Duration of calling in seconds Format: int32 Example: 5 */
    ...
    public CommInteractionDispatchingResourceActions terminatingTargetType(
            String terminatingTargetType) {

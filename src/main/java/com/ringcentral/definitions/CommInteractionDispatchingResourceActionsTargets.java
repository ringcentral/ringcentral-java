...
public class CommInteractionDispatchingResourceActionsTargets {
    ...
    public CommInteractionDispatchingResourceActionsTargets extension(
    ...
    public CommInteractionDispatchingResourceActionsTargets destination(
    ...
    public CommInteractionDispatchingResourceActionsTargets integration(
    ...
    public CommInteractionDispatchingResourceActionsTargets prompt(
    ...
    public CommInteractionDispatchingResourceActionsTargets dispatchingType(

...
public class CommPlayWelcomePromptActionRequest {
    /**
     * Prompt action type Required Example: PlayWelcomePromptAction Enum:
     * PlayConnectingMessageAction, PlayConnectingPromptAction, PlayWelcomePromptAction,
     * ScreeningAction, RingGroupAction, RingAlwaysGroupAction, TerminatingAction
     */
    public String type;

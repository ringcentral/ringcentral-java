...
public class CompanyAnsweringRuleRequest {
    ...
    public CompanyAnsweringRuleRequest calledNumbers(
            CompanyAnsweringRuleCalledNumberInfo[] calledNumbers) {
     ...
     * greeting to go to selected extension = [&#039;Operator&#039;, &#039;Disconnect&#039;,
     * &#039;Bypass&#039;] Enum: Operator, Disconnect, Bypass
     */
    ...
    public CompanyAnsweringRuleRequest extension(
            CompanyAnsweringRuleExtensionInfoRequest extension) {

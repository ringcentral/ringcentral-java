...
public class CompanyAnsweringRuleScheduleInfo {
    ...
    public CompanyAnsweringRuleScheduleInfo weeklyRanges(
            CompanyAnsweringRuleWeeklyScheduleInfoRequest weeklyRanges) {
    ...
    /**
     * Reference to Business Hours or After Hours schedule = [&#039;BusinessHours&#039;,
     * &#039;AfterHours&#039;] Enum: BusinessHours, AfterHours
     */
    public String ref;

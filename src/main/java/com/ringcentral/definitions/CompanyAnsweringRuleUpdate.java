...
public class CompanyAnsweringRuleUpdate {
    ...
    public CompanyAnsweringRuleUpdate calledNumbers(
     ...
     * greeting to go to selected extension = [&#039;Operator&#039;,
     * &#039;Disconnect&#039;,&#039;Bypass&#039;] Enum: Operator, Disconnect, Bypass
     */
    ...
    public CompanyAnsweringRuleUpdate extension(CompanyAnsweringRuleExtensionInfo extension) {

...
public class ContactInfo {
    ...
    /**
     * User&#039;s mobile (**non** Toll Free) phone number in
    ...
    /**
     * Indicates that the contact email is enabled as a login name for this user. Please note that
     * the email must be unique in this case.
     */

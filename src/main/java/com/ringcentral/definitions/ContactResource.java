...
public class ContactResource {
    ...
    /**
     * Contact type Example: User Enum: User, Department, Announcement, Voicemail, SharedLinesGroup,
     * PagingOnly, ParkLocation, IvrMenu, Limited, ApplicationExtension, Site, Bot, Room,
     * ProxyAdmin, DelegatedLinesGroup, GroupCallPickup, External, RoomConnector, Unknown
     */
    public String type;
    ...
    /**
     * Contact status Example: Enabled Enum: Enabled, Disabled, Frozen, NotActivated, Unassigned,
     * Unknown
     */

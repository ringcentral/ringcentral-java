...
public class CreateDataExportTaskRequest {
     ...
     * time frame between `timeFrom` and `timeTo` is 6 months Format: date-time
     */
     ...
     * between `timeFrom` and `timeTo` is 6 months Format: date-time
     */
    ...
    /**
     * List of contacts which data is collected. The following data will be exported: posts, tasks,
     * events, etc. posted by the user(s); posts addressing the user(s) via direct and @Mentions;
     * tasks assigned to the listed user(s). The list of 30 users per request is supported.
     */
    ...
    /**
     * List of chats from which the data (posts, files, tasks, events, notes, etc.) will be
     * collected. Maximum number of chats supported is 10
     */

...
public class CustomAnsweringRuleInfo {
    ...
    /**
     * Specifies how incoming calls are forwarded Enum: ForwardCalls, UnconditionalForwarding,
     * AgentQueue, TransferToExtension, TakeMessagesOnly, PlayAnnouncementOnly, SharedLines
     */
    ...
    public CustomAnsweringRuleInfo unconditionalForwarding(
            UnconditionalForwardingInfo unconditionalForwarding) {
    ...
    /**
     * Call screening status. &#039;Off&#039; - no call screening; &#039;NoCallerId&#039; - if
     * caller ID is missing, then callers are asked to say their name before connecting;
     * &#039;UnknownCallerId&#039; - if caller ID is not in contact list, then callers are asked to
     * say their name before connecting; &#039;Always&#039; - the callers are always asked to say
     * their name before connecting. The default value is &#039;Off&#039; Default: Off Enum: Off,
     * NoCallerId, UnknownCallerId, Always
     */
    ...
    public CustomAnsweringRuleInfo missedCall(MissedCallInfo missedCall) {

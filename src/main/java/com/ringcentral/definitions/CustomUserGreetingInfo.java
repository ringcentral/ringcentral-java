...
public class CustomUserGreetingInfo {
    ...
    /**
     * Type of custom user greeting Enum: Introductory, Announcement, InterruptPrompt,
     * ConnectingAudio, ConnectingMessage, Voicemail, Unavailable, HoldMusic, PronouncedName,
     * TemplateGreeting
     */
    public String type;

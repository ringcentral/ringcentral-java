...
public class DetailedExtensionPresenceWithSIPEventBody {
    ...
    public DetailedExtensionPresenceWithSIPEventBody allowSeeMyPresence(
            Boolean allowSeeMyPresence) {
    ...
    public DetailedExtensionPresenceWithSIPEventBody acceptCallQueueCalls(
            Boolean acceptCallQueueCalls) {
    ...
    public DetailedExtensionPresenceWithSIPEventBody ringOnMonitoredCall(
            Boolean ringOnMonitoredCall) {

...
public class DeviceEmergencyServiceAddressResource {
    ...
    /**
     * Email of a primary contact person (receiver). Should be specified for countries except the
     * US, Canada, the UK and Australia Format: email
     */
    ...
    /**
     * Email of an additional contact person. Should be specified for countries except the US,
     * Canada, the UK and Australia Format: email
     */
    public String additionalCustomerEmail;

    public DeviceEmergencyServiceAddressResource additionalCustomerEmail(
    ...
    /**
     * Name of an additional contact person. Should be specified for countries except the US,
     * Canada, the UK and Australia
     */
    public String additionalCustomerName;

    public DeviceEmergencyServiceAddressResource additionalCustomerName(
    ...
    /**
     * Phone number of an additional contact person. Should be specified for countries except the
     * US, Canada, the UK &amp; Australia
     */
    public String additionalCustomerPhone;

    public DeviceEmergencyServiceAddressResource additionalCustomerPhone(
            String additionalCustomerPhone) {
    ...
    public DeviceEmergencyServiceAddressResource lineProvisioningStatus(

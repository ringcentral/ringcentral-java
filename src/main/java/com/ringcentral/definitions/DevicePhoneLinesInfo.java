...
public class DevicePhoneLinesInfo {
    ...
    /** Type of phone line Enum: Standalone, StandaloneFree, BlaPrimary, BlaSecondary */
    ...
    public DevicePhoneLinesInfo emergencyAddress(
            DevicePhoneLinesEmergencyAddressInfo emergencyAddress) {

...
public class EmergencyAddressAutoUpdateUsersBulkAssignResource {
    ...
    public EmergencyAddressAutoUpdateUsersBulkAssignResource enabledUserIds(
    ...
    public EmergencyAddressAutoUpdateUsersBulkAssignResource disabledUserIds(
            String[] disabledUserIds) {

...
public class EmergencyAddressInfo {
    ...
    public EmergencyAddressInfo outOfCountry(Boolean outOfCountry) {
    ...
    /**
     * Resulting status of emergency address synchronization. Returned for &#039;Get Device
     * Info&#039; request if `syncEmergencyAddress` parameter is set to `true` Enum: Verified,
     * Updated, Deleted, NotRequired, Unsupported, Failed
     */

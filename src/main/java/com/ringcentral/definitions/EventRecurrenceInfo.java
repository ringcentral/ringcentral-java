...
public class EventRecurrenceInfo {
     ...
     * equal to event duration: 1- Day/Weekday; 7 - Week; 28 - Month; 365 - Year Enum: None, Day,
    ...
    /**
     * Count of event iterations. For periodic events only. Value range is 1 - 10. Must be specified
     * if `endingCondition` is `Count` Format: int32
     */
    ...
    /**
     * Iterations ending datetime for periodic events in [ISO
     * 8601](https://en.wikipedia.org/wiki/ISO_8601) format Format: date-time
     */

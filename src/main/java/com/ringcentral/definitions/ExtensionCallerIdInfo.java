...
public class ExtensionCallerIdInfo {
    ...
    public ExtensionCallerIdInfo extensionNameForOutboundCalls(
            Boolean extensionNameForOutboundCalls) {
    ...
    public ExtensionCallerIdInfo extensionNumberForInternalCalls(

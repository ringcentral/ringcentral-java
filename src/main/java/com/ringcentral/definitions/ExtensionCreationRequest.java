...
public class ExtensionCreationRequest {
     ...
     * VirtualUser, DigitalUser, FlexibleUser, Department, Announcement, Voicemail,
     * SharedLinesGroup, PagingOnly, ParkLocation, Limited
     */
    public String type;
    ...
    /**
     * Hides extension from showing in company directory. Supported for extensions of
     * &#039;User&#039; type only. For unassigned extensions the value is set to `true` by default.
     * For assigned extensions the value is set to `false` by default
     */

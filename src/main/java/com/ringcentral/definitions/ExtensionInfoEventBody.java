...
public class ExtensionInfoEventBody {
    ...
    /**
     * Returned for &#039;Update&#039; event type only Enum: AccountSettings, AccountStatus,
     * AnsweringRules, CompanyNumbers, DialingPlan, ExtensionInfo, Features, Limits, Permissions,
     * ProfileImage, VideoConfiguration
     */
    public String[] hints;

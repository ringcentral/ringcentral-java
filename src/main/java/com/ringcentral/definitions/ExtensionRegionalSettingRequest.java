...
/**
 * Regional data (timezone, home country, language) of an extension. The default is Company
...
public class ExtensionRegionalSettingRequest {
    ...
    public ExtensionRegionalSettingRequest greetingLanguage(
            ExtensionGreetingLanguageInfoRequest greetingLanguage) {
    ...
    public ExtensionRegionalSettingRequest formattingLocale(
            ExtensionFormattingLocaleInfoRequest formattingLocale) {

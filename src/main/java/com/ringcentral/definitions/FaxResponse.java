...
public class FaxResponse {
    ...
    /**
     * Date/time when the message was modified on server in ISO 8601 format including timezone, for
     * example 2016-03-10T18:07:52.534Z Format: date-time
     */
    ...
    /**
     * Cover page identifier. If `coverIndex` is set to &#039;0&#039; (zero), a cover page is not
     * attached. For a list of available cover page identifiers (1-13) please call the Fax Cover
    ...
    /**
     * Cover page text, entered by a fax sender and printed on a cover page. Maximum length is

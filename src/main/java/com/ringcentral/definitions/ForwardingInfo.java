...
public class ForwardingInfo {
    /**
     * Specifies if the user&#039;s softphone(s) are notified before forwarding the incoming call to
     * desk phones and forwarding numbers
     */
    ...
    /**
     * Specifies the order in which the forwarding numbers ring. &#039;Sequentially&#039; means that
     * forwarding numbers are ringing one at a time, in order of priority.
     * &#039;Simultaneously&#039; means that forwarding numbers are ring all at the same time Enum:
    ...
    /**
     * Specifies if desktop and mobile applications of the user are notified before (true) or after
     * (false) forwarding the incoming call to desk phones and forwarding numbers. Applicable only
     * if `notifyMySoftPhones` parameter is set to `true`
     */

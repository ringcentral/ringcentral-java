...
public class GetCallRecordingResponse {
     ...
     * (access token must be passed via `Authorization` header or query parameter) Required Format:
     * uri
     */
    ...
    /**
     * Call recording file MIME format. Supported format is `audio/wav` and `audio/mpeg` Required
     * Example: audio/wav
     */

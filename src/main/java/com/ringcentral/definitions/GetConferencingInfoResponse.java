...
public class GetConferencingInfoResponse {
    ...
    /** Link to a branded support page Format: uri Example: http://success.ringcentral.com */
     ...
     * the user&#039;s brand. Each number is given with the country and location information, in
     * order to let the user choose less expensive way to connect to a conference. The first number
     * in the list is a primary conference number, that is default and domestic
     */

...
public class GetMessageForwardingInfo {
    ...
    public GetMessageForwardingInfo originalSender(
            MessageStoreCallerInfoResponseTo originalSender) {
        this.originalSender = originalSender;
        return this;
    }

    /**
     * Original message creation date/time in ISO 8601 format including timezone, for example

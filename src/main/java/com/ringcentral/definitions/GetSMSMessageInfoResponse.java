...
public class GetSMSMessageInfoResponse {
    ...
    /**
     * SMS only. The date/time when outbound SMS was delivered to recipient&#039;s handset in ISO
     * 8601 format including timezone, for example 2016-03-10T18:07:52.534Z. It is filled only if
     * the carrier sends a delivery receipt to RingCentral Format: date-time
     */

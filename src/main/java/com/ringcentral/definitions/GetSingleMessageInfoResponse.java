...
public class GetSingleMessageInfoResponse {
    ...
    public GetSingleMessageInfoResponse id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public GetSingleMessageInfoResponse uri(String uri) {
        this.uri = uri;
        return this;
    }
    ...
    public GetSingleMessageInfoResponse extensionId(String extensionId) {
    ...
    public GetSingleMessageInfoResponse attachments(MessageAttachmentInfo[] attachments) {
    ...
    public GetSingleMessageInfoResponse availability(String availability) {
    ...
    public GetSingleMessageInfoResponse conversationId(Long conversationId) {
    ...
    public GetSingleMessageInfoResponse conversation(ConversationInfo conversation) {
    ...
    public GetSingleMessageInfoResponse creationTime(String creationTime) {
    ...
    public GetSingleMessageInfoResponse deliveryErrorCode(String deliveryErrorCode) {
    ...
    public GetSingleMessageInfoResponse segmentCount(Long segmentCount) {
    ...
    public GetSingleMessageInfoResponse direction(String direction) {
    ...
    public GetSingleMessageInfoResponse faxPageCount(Long faxPageCount) {
    ...
    public GetSingleMessageInfoResponse faxResolution(String faxResolution) {
    ...
    public GetSingleMessageInfoResponse from(MessageStoreCallerInfoResponseFrom from) {
        this.from = from;
        return this;
    }
    ...
    public GetSingleMessageInfoResponse lastModifiedTime(String lastModifiedTime) {
    ...
    public GetSingleMessageInfoResponse messageStatus(String messageStatus) {
    ...
    public GetSingleMessageInfoResponse pgToDepartment(Boolean pgToDepartment) {
    ...
    public GetSingleMessageInfoResponse priority(String priority) {
    ...
    public GetSingleMessageInfoResponse readStatus(String readStatus) {
    ...
    public GetSingleMessageInfoResponse smsDeliveryTime(String smsDeliveryTime) {
    ...
    public GetSingleMessageInfoResponse smsSendingAttemptsCount(Long smsSendingAttemptsCount) {
    ...
    public GetSingleMessageInfoResponse subject(String subject) {
    ...
    public GetSingleMessageInfoResponse to(MessageStoreCallerInfoResponseTo[] to) {
        this.to = to;
        return this;
    }
    ...
    public GetSingleMessageInfoResponse type(String type) {
        this.type = type;
        return this;
    }
    ...
    public GetSingleMessageInfoResponse vmTranscriptionStatus(String vmTranscriptionStatus) {
    ...
    public GetSingleMessageInfoResponse coverIndex(Long coverIndex) {
    ...
    public GetSingleMessageInfoResponse coverPageText(String coverPageText) {
    ...
    public GetSingleMessageInfoResponse owner(OwnerResource owner) {
        this.owner = owner;
        return this;
    }
    ...
    public GetSingleMessageInfoResponse _private(Boolean _private) {
    ...
    public GetSingleMessageInfoResponse forwarding(GetMessageForwardingInfo forwarding) {
        this.forwarding = forwarding;
        return this;
    }

    /**
     * List of other users (side recipients) who also received the voicemail in case of VM sending
     * to multiple users or VM forwarding to multiple users. Required
     */
    public MessageStoreCallerInfoResponseTo[] vmSideRecipients;

    public GetSingleMessageInfoResponse vmSideRecipients(
            MessageStoreCallerInfoResponseTo[] vmSideRecipients) {
        this.vmSideRecipients = vmSideRecipients;
        return this;
    }
}

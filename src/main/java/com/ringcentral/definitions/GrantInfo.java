...
public class GrantInfo {
    ...
    /**
     * Specifies if picking up of other extensions&#039; calls is allowed for the extension. If
     * &#039;Presence&#039; feature is disabled for the given extension, the flag is not returned
     */
     ...
     * &#039;CallMonitoring&#039; feature is disabled for the given extension, the flag is not
     * returned
     */
    ...
    /**
     * Specifies whether the current extension is able to make or receive calls on behalf of the
     * user referenced in extension object
     */
    ...
    /**
     * Specifies whether the current extension can delegate a call to the user referenced in
     * extension object
     */
    ...
    /**
     * Specifies whether the current extension is assigned as a Full-Access manager in the call
     * queue referenced in extension object
     */
    ...
    /**
     * Specifies whether the current extension is assigned as a Members-Only manager in the call
     * queue referenced in extension object
     */
    ...
    /**
     * Specifies whether the current extension is assigned as a Messages Manager in the queue
    ...
    /**
     * Specifies whether the user referenced in extension object is sharing voicemails with the
     * current extension
     */
    ...
    public GrantInfo smsRecipient(Boolean smsRecipient) {

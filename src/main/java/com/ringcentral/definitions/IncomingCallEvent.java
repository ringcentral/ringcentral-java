...
public class IncomingCallEvent {
    ...
    /**
     * The timestamp of a call action in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format
     * including timezone, for example 2016-03-10T18:07:52.534Z Format: date-time
     */

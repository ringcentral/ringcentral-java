...
public class InteractionApiResponseResponse {
    ...
    public InteractionApiResponseResponse utteranceInsights(
    ...
    public InteractionApiResponseResponse conversationalInsights(
            ConversationalInsightsUnit[] conversationalInsights) {

...
public class ListA2PSMSParameters {
    ...
    /**
     * Direction of a message to filter the message list result. By default, there is no filter
     * applied - both Inbound and Outbound messages are returned Example: Inbound Enum: Inbound,
     * Outbound
     */
     ...
     * Default is the `dateTo` minus 24 hours Format: date-time Example: Mon Nov 09 2020 08:07:52
     ...
     * Default is the current time Format: date-time Example: Wed Nov 25 2020 08:07:52 GMT-0800
     ...
     * Default: Simple Enum: Simple, Detailed
     */
    public String view;
    ...
    /**
     * List of phone numbers (specified in &#039;to&#039; or &#039;from&#039; fields of a message)
     * to filter the results. Maximum number of phone numbers allowed to be specified as filters is
     * 15 Example: 15551234455,15551235577
     */

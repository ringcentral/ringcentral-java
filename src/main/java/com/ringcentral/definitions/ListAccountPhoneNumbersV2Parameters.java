...
public class ListAccountPhoneNumbersV2Parameters {
    ...
    /** Types of phone numbers to be returned Enum: VoiceFax, VoiceOnly, FaxOnly */
    public String[] type;
    ...
    /**
     * Usage type(s) of phone numbers to be returned Enum: MainCompanyNumber, DirectNumber,
     * Inventory, InventoryPartnerBusinessMobileNumber, InventoryFmcBusinessMobileNumber,
     * PartnerBusinessMobileNumber, AdditionalCompanyNumber, CompanyNumber, PhoneLine,
     * CompanyFaxNumber, ForwardedNumber, ForwardedCompanyNumber, ContactCenterNumber,
     * ConferencingNumber, MeetingsNumber, NumberStorage, BusinessMobileNumber,
     * FmcBusinessMobileNumber, ELIN, InventoryMobileNumber
     */
    ...
    /**
     * Phone number in e.164 format to be searched for. Parameter value can include wildcards (e.g.
     * &quot;+165012345**&quot;) or be an exact number &quot;+16501234500&quot; - single number is
     * searched in that case. Make sure you escape the &quot;+&quot; in the URL as &quot;%2B&quot;
     */

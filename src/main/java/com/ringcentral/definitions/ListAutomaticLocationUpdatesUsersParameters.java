...
public class ListAutomaticLocationUpdatesUsersParameters {
    ...
    /**
     * Filters entries containing the specified substring in user name, extension or department. The
    ...
    /**
     * Department name to filter the users. The value range is 0-64; not case-sensitive. If not
     * specified then the parameter is ignored. Multiple values are supported
     */
     ...
     * (ascending order), or minus sign &#039;-&#039; (descending order). Supported values:
     * &#039;name&#039;, &#039;modelName&#039;, &#039;siteName&#039;, &#039;featureEnabled&#039;.

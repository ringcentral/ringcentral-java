...
public class ListChatNotesNewParameters {
     ...
     * format including timezone, e.g. 2019-03-10T18:23:45. The default value is Now.
     */
    ...
    /**
     * The start datetime for resulting records in [ISO
    ...
    /**
     * Status of notes to be fetched; if not specified all notes are fetched by default. Enum:
     * Active, Draft
     */
    ...
    /**
     * Max number of notes to be fetched by one request; the value range is 1-250. Maximum: 250
     * Format: int32 Default: 30
     */

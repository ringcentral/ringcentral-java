...
public class ListDevicesAutomaticLocationUpdatesParameters {
    ...
    /**
     * Filters entries which have device name or model name containing the mentioned substring. The
     * value should be split by spaces; the range is 0 - 64 characters, not case-sensitive. If empty

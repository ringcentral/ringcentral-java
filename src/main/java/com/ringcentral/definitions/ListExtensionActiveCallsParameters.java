...
public class ListExtensionActiveCallsParameters {
    ...
    /**
     * The type of call transport. Multiple values are supported. By default, this filter is
     * disabled Enum: PSTN, VoIP
     */
    ...
    /**
     * Indicates the page number to retrieve. Only positive number values are allowed Format: int32
     * Default: 1
     */
    public Long page;

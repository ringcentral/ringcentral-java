...
public class ListExtensionDevicesParameters {
    ...
    /**
     * Pooling type of device - Host - a device with standalone paid phone line which can be linked
     * to a soft client instance - Guest - a device with a linked phone line - None - a device
     * without a phone line or with specific line (free, BLA, etc.) Enum: Host, Guest, None
     */

...
public class ListExtensionGrantsParameters {
    /**
     * Type of extension to be returned. Multiple values are supported. **Please note that legacy
     * &#039;Department&#039; extension type corresponds to &#039;Call Queue&#039; extensions in
     * modern RingCentral product terminology** Enum: User, FaxUser, VirtualUser, DigitalUser,
     * Department, Announcement, Voicemail, SharedLinesGroup, PagingOnly, IvrMenu,
     * ApplicationExtension, ParkLocation, Limited, Bot, Room, DelegatedLinesGroup
     */

...
public class ListStatesParameters {
    /**
     * If set to `true` then states of all countries are returned and `countryId` is ignored, even
     * if specified. If the value is empty then the parameter is ignored
     */

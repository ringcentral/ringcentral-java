...
public class MessageDetailsResponse {
     ...
     * message was sent Example: +15551234567
     */
    public String from;
    ...
    /**
     * List of phone numbers in [E.164](https://www.itu.int/rec/T-REC-E.164-201011-I) format to
     * which the message was sent Example: +15551234567
     */
    public String[] to;
    ...
    /** The time when this message was created. Format: date-time */
    ...
    /**
     * Status of the message Example: Queued Enum: Queued, Delivered, Sent, SendingFailed,
     * DeliveryFailed
     */

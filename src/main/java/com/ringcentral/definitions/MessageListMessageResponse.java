...
public class MessageListMessageResponse {
     ...
     * message is sent Example: +15551234567
     */
    public String from;
    ...
    /**
     * Phone number in [E.164](https://www.itu.int/rec/T-REC-E.164-201011-I) format to which a
     * message is sent Example: +15551234567
     */
    public String[] to;
    ...
    /** The time at which the message was last updated Format: date-time */

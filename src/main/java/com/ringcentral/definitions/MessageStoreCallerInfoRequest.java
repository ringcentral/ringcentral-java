...
public class MessageStoreCallerInfoRequest
{
    ...
    public MessageStoreCallerInfoRequest extensionNumber(String extensionNumber) {
        this.extensionNumber = extensionNumber;
        return this;
    }
    // Contains party location (city, state) if one can be determined from phoneNumber. This property is filled only when phoneNumber is not empty and server can calculate location information from it (for example, this information is unavailable for US toll-free numbers)
    public String location;
    public MessageStoreCallerInfoRequest location(String location) {
        this.location = location;
        return this;
    }
    // Symbolic name associated with a party. If the phone does not belong to the known extension,only the location is returned, the name is not determined then
    public String name;
    public MessageStoreCallerInfoRequest name(String name) {
        this.name = name;
        return this;
    }

...
public class MessageStoreReport {
    /**
     * Internal identifier of a message store report task Example:
     * 400142200026-400142200026-bd162f24028442489385eb3f44c18354
     */
    public String id;
    ...
    /**
     * Status of a message store report task Enum: Accepted, Pending, InProgress, AttemptFailed,

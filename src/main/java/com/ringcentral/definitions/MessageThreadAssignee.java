...
public class MessageThreadAssignee {
    ...
    public MessageThreadAssignee extensionId(String extensionId) {
    ...
    public MessageThreadAssignee name(String name) {
        this.name = name;
        return this;
    }
    ...
    public MessageThreadAssignee extensionType(String extensionType) {

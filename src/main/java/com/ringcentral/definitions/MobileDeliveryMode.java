...
public class MobileDeliveryMode {
    /** The transport type for this subscription Required Enum: RC/APNS, RC/GCM */
    ...
    /**
     * Device instance ID for mobile notification transports Required Example:
     * 38b062ae-85f8-4dcc-8734-04d3f7393d42
     */

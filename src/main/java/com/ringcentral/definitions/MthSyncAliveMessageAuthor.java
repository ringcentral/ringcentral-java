...
public class MthSyncAliveMessageAuthor {
    ...
    public MthSyncAliveMessageAuthor extensionId(String extensionId) {
    ...
    public MthSyncAliveMessageAuthor name(String name) {
        this.name = name;
        return this;
    }
    ...
    public MthSyncAliveMessageAuthor extensionType(String extensionType) {

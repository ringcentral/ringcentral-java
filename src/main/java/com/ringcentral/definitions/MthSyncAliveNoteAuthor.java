...
public class MthSyncAliveNoteAuthor {
    ...
    public MthSyncAliveNoteAuthor extensionId(String extensionId) {
    ...
    public MthSyncAliveNoteAuthor name(String name) {
        this.name = name;
        return this;
    }
    ...
    public MthSyncAliveNoteAuthor extensionType(String extensionType) {

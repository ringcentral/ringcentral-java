...
public class MthSyncAssignedHintInitiator {
    ...
    public MthSyncAssignedHintInitiator extensionId(String extensionId) {
    ...
    public MthSyncAssignedHintInitiator name(String name) {
        this.name = name;
        return this;
    }
    ...
    public MthSyncAssignedHintInitiator extensionType(String extensionType) {

...
public class MthSyncBaseHintInitiator {
    ...
    public MthSyncBaseHintInitiator extensionId(String extensionId) {
    ...
    public MthSyncBaseHintInitiator name(String name) {
        this.name = name;
        return this;
    }
    ...
    public MthSyncBaseHintInitiator extensionType(String extensionType) {

...
public class NumberDetails {
    ...
    /**
     * Absent if the request&#039;s parameter `context.siteCode` value is set to `null`. Example:
     * 303
     */
    ...
    /**
     * Absent for the `results.category` response&#039;s attribute values: `Unknown`, `ServiceCode`,
     * `SpecialService`, `Regular`, `TollFree` and `ShortCode`. Example: 10303
     */
    ...
    /**
     * Absent for the `results.category` response&#039;s attribute values: `Unknown`, `ServiceCode`,
     * `Extension`, `Regular`, `TollFree`, `ShortCode` and `Ambiguous`.
     */
    ...
    /**
     * Absent if the response&#039;s attribute `results.originalString` value doesn&#039;t contain a
     * SIP postfix. Example: @sip.ringcentral.com
     */
    ...
    /**
     * Absent if the request&#039;s parameter `context.maskedPhoneNumbersAllowed` value is set to
     * `false`.
     */
    ...
    /**
     * Absent for the `results.category` response&#039;s attribute values: `Unknown`,
     * `SpecialService`, `Extension`, `TollFree`, `ShortCode` and `Ambiguous`. Example: Valid Enum:

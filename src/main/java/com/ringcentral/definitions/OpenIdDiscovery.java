...
/**
 * The OpenID Connect configuration document as defined by the [OpenID Connect Discovery
 * 1.0](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata) specification
 */
public class OpenIdDiscovery {
    /**
     * An identifier of the ID token&#039;s issuer. This value is identical to the `iss` Claim value
     * in ID Tokens Required Format: uri Example: https://platform.ringcentral.com
     */
    ...
    /**
     * URL of the OAuth 2.0 authorization endpoint Required Format: uri Example:
    ...
    /**
     * URL of the OAuth 2.0 token endpoint Required Format: uri Example:
    ...
    /**
     * URL of the OAuth 2.0 revocation endpoint as defined by
     * [RFC-7009](https://datatracker.ietf.org/doc/html/rfc7009) Required Format: uri Example:
    ...
    /**
     * URL of the user info endpoint as defined by [OpenID Connect Core
     * 1.0](https://openid.net/specs/openid-connect-core-1_0.html#UserInfo) specification Required
     * Format: uri Example: https://platform.ringcentral.com/restapi/oauth/userinfo
     */
     ...
     * to validate ID Token signatures Required Format: uri Example:
     * https://platform.ringcentral.com/restapi/oauth/jwks
     */
    ...
    /**
     * The list of the OAuth 2.0 scope values that this server supports Required Example:
     * openid,email,profile Enum: openid, email, profile
     */
    ...
    /**
     * The list of Client Authentication methods supported by the Token Endpoint Required Example:
     * client_secret_basic Enum: client_secret_basic, client_secret_jwt, private_key_jwt
     */
    public String[] token_endpoint_auth_methods_supported;

    public OpenIdDiscovery token_endpoint_auth_methods_supported(
    ...
    /**
     * The list of the OAuth 2.0 `response_type` values supported by the provider Required Example:
     * code Enum: code
     */
    ...
    /**
     * The list of the Subject Identifier types supported by the provider (only `public` is
     * currently supported) Required Example: public Enum: public
     */
    ...
    /**
     * The list of the JWS signing algorithms (`alg` values) supported by the UserInfo Endpoint to
     * encode the Claims in a JWT Required Example: none Enum: none
     */
    public String[] userinfo_signing_alg_values_supported;

    public OpenIdDiscovery userinfo_signing_alg_values_supported(
    ...
    /**
     * The list of the JWS signing algorithms (`alg` values) supported by the provider for the ID
     * Token to encode the Claims in a JWT Required Example: RS256,HS256 Enum: RS256, HS256
     */
    public String[] id_token_signing_alg_values_supported;

    public OpenIdDiscovery id_token_signing_alg_values_supported(
    ...
    /**
     * The list of the `display` parameter values (in OAuth 2.0 Authorization Endpoint) supported by
     * the provider Enum: page, popup, touch, mobile
     */
    ...
    /**
     * The list of the Claim Names of the Claims that the OpenID Provider MAY be able to supply
     * values for Example: sub,iss,auth_time,exp Enum: sub, iss, auth_time, aud, exp, iat, jti,
     * nonce, account_id, email, email_verified, given_name, family_name
     */
     ...
     * [RFC-5646](https://datatracker.ietf.org/doc/html/rfc5646) Example: en,en-US,en-GB,fr-CA
     */
    ...
    /**
     * The list of the PKCE challenge methods supported by the provider Required Example: plain,S256
     * Enum: plain, S256
     */
    public String[] code_challenge_methods_supported;

    public OpenIdDiscovery code_challenge_methods_supported(
    ...
    public OpenIdDiscovery request_uri_parameter_supported(

...
public class OptOutBulkAssignResponseOptIns {
    /**
     * Recipients&#039; phone numbers which opt-ins were successfully added for. Example:
     * +15551237799
     */
    ...
    /**
     * Recipients&#039; phone numbers which opt-ins were failed to be added for. Plus, error

...
/**
 * Advanced permissions capabilities. Returned if `advancedPermissions` query parameter is set to
 * `true`.
 */
public class PermissionsCapabilities {
    ...
    /**
     * Specifies if the user can manage the listed permission and is allowed to enable it on other
     * users
     */
    ...
    /**
     * Specifies if the users who were enabled with the listed permission can grant it further to
     * other users
     */

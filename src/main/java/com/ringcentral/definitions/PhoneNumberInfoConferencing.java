...
public class PhoneNumberInfoConferencing {
    ...
    /**
     * The value should be `true` if the number is default for the conference. Default conference
     * number is a domestic number that can be set by user (otherwise it is set by the system). Only
     * one default number per country is allowed
     */
    ...
    /**
     * Indicates if the number is &#039;premium&#039; (account phone number with the
     * `ConferencingNumber` usageType)
     */

...
public class PhoneNumberInfoIntId {
    ...
    /**
     * Status of a phone number. If the value is &#039;Normal&#039;, the phone number is ready to be
     * used. Otherwise, it is an external number not yet ported to RingCentral
     */
    ...
    /**
     * Usage type of the phone number Enum: MainCompanyNumber, AdditionalCompanyNumber,
     * CompanyNumber, DirectNumber, CompanyFaxNumber, ForwardedNumber, ForwardedCompanyNumber,
     * ContactCenterNumber, IntegrationNumber
     */

...
public class PresenceInfoResponse {
     ...
     *
     * <p>Please note: Cannot be set for Department/Announcement/Voicemail (Take Messages Only)/Fax
     * User/Shared Lines Group/Paging Only Group/IVR Menu/Application Extension/Park Location
     * extensions.
     *
     * <p>The &#039;DoNotAcceptDepartmentCalls&#039; and &#039;TakeDepartmentCallsOnly&#039; values
     * are applicable only for extensions - members of a Department; if these values are set for
     * department outsiders, the 400 Bad Request error code is returned.
     *
     * <p>The &#039;TakeDepartmentCallsOnly&#039; status can be set through the old RingCentral user
     * interface and is available for some migrated accounts only. Enum: TakeAllCalls,
     * DoNotAcceptDepartmentCalls, TakeDepartmentCallsOnly, DoNotAcceptAnyCalls, Unknown
     */

...
public class PrivateIpRangeInfoRequest {
    ...
    public PrivateIpRangeInfoRequest emergencyAddress(
            LocationUpdatesEmergencyAddressInfoRequest emergencyAddress) {
    ...
    public PrivateIpRangeInfoRequest emergencyLocation(EmergencyLocationInfo emergencyLocation) {

...
public class PronouncedNameInfo {
    /**
     * The method used to pronounce the user&#039;s name: - `Default` - default extension name;
     * first and last name specified in user&#039;s profile are pronounced using text-to-speech; -
     * `TextToSpeech` - custom text specified by a user pronounced using text-to-speech; -
     * `Recorded` - custom audio uploaded by a user, the name recorded in user&#039;s own voice
     * (supported only for extension retrieval). Enum: Default, TextToSpeech, Recorded
     */
    public String type;

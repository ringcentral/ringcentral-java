...
/**
 * Token endpoint request parameters used in the "Refresh Token" flow with the `refresh_token` grant
 * type
 */
public class PublicGetTokenRequest {
    /**
     * The registered identifier of a client application. Used to identify a client ONLY if the
     * client authentication is not required and corresponding credentials are not provided with
     * this request Example: AZwEVwGEcfGet2PCouA7K6
     */
    ...
    /**
     * Client assertion type for the `client_secret_jwt` or `private_key_jwt` client authentication
     * types, as defined by [RFC-7523](https://datatracker.ietf.org/doc/html/rfc7523#section-2.2).
     * This parameter is mandatory if the client authentication is required and a client decided to
     * use one of these authentication types Enum:
    ...
    /**
     * Client assertion (JWT) for the `client_secret_jwt` or `private_key_jwt` client authentication
     * types, as defined by [RFC-7523](https://datatracker.ietf.org/doc/html/rfc7523#section-2.2).
     * This parameter is mandatory if the client authentication is required and a client decided to
     * use one of these authentication types
     */
    ...
    /**
     * Grant type Required Enum: authorization_code, urn:ietf:params:oauth:grant-type:jwt-bearer,
     * partner_jwt, refresh_token
     */
    ...
    /**
     * For `authorization_code` grant type only. This is a callback URI which determines where the
     * response is sent. The value of this parameter must exactly match one of the URIs you have
     * provided for your app upon registration Format: uri
     */
    ...
    /**
     * For `authorization_code` grant type only. The code verifier as defined by the PKCE
     * specification - [RFC-7636 &quot;Proof Key for Code Exchange by OAuth Public
     ...
     * Authorization grant assertion (JWT) as defined by
     * [RFC-7523](https://datatracker.ietf.org/doc/html/rfc7523#section-2.1). Required
     */

...
public class QueueInfo {
     ...
     * simultaneous transfer mode only &#039;WaitPrimaryMembers&#039; and
     * &#039;WaitPrimaryAndOverflowMembers&#039; are supported Enum: WaitPrimaryMembers,
     * WaitPrimaryAndOverflowMembers, Voicemail, TransferToExtension, UnconditionalForwarding
     */
     ...
     * queue member) expires. If &#039;TransferToExtension&#039; option is selected, the extension
     * specified in `transfer` field is used. The default value is `Voicemail` Default: Voicemail
    ...
    /**
     * Maximum time in seconds to wait for a call queue member before trying the next member Format:
     * int32
     */
     ...
     * range is from 0 to 300 sec. Maximum: 300 Format: int32 Default: 15
     */
     ...
     * maximum Enum: Voicemail, Announcement, TransferToExtension, UnconditionalForwarding
     */
    ...
    public QueueInfo unconditionalForwarding(

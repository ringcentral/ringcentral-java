...
public class ReadA2PSMSOptOutsParameters {
    /**
     * The sender&#039;s phone number in [E.164](https://www.itu.int/rec/T-REC-E.164-201011-I)
     * format for filtering messages. The asterisk value &quot;*&quot; means any number in `from`
     * field Example: 15551234455
     */
    public String from;
    ...
    /**
     * The receiver&#039;s phone number (`to` field) in
     * [E.164](https://www.itu.int/rec/T-REC-E.164-201011-I) format for filtering messages Example:
     * 15551237755
     */
    public String to;
    ...
    /**
     * The status (opted out, opted in, or both) to be used as the filter Example: optout Default:

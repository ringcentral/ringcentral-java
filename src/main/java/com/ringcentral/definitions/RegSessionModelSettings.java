...
public class RegSessionModelSettings {
    /**
     * The maximum number of registrants which forces closing the registration (0 means
     * &quot;off&quot;). Format: int32
     */
    ...
    /**
     * Indicates that emails to registrants should be suppressed (should be supported by external
     * party)
     */
    ...
    /**
     * Duration of on-demand webinar. The default value can only be used if the session is on
     * demand. Default: SixMonths Enum: OneMonth, TwoMonths, ThreeMonths, SixMonths, OneYear
     */
    ...
    public RegSessionModelSettings autoOpenPostWebinarRegistration(
            Boolean autoOpenPostWebinarRegistration) {
    ...
    public RegSessionModelSettings postWebinarRegistrationClosingTime(
            String postWebinarRegistrationClosingTime) {

...
public class ReservePhoneNumber_Request_ReserveRecord {
    ...
    public ReservePhoneNumber_Request_ReserveRecord phoneNumber(String phoneNumber) {
        this.phoneNumber = phoneNumber;
        return this;
    }

    public ReservePhoneNumber_Request_ReserveRecord reservedTill(String reservedTill) {

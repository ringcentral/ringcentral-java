...
public class ResultContent {
    /**
     * Indicates that `results.dialingDetails` section should be returned for particular result
     * items in the response. Default: true
     */
    ...
    /**
     * Indicates that `results.numberDetails` section should be returned for particular result items
     * in the response. Example: true Default: true
     */
    ...
    /**
     * Indicates that `results.formats` section should be returned for particular result items in
     * the response. Example: true Default: true
     */

...
public class ScimErrorResponse {
    ...
    /**
     * Bad request type when status code is 400 Enum: uniqueness, tooMany, mutability, sensitive,
     * invalidSyntax, invalidFilter, invalidPath, invalidValue, invalidVers, noTarget
     */

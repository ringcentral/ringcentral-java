...
public class ScimSchemaAttribute {
     ...
     * Required Enum: readOnly, readWrite, immutable, writeOnly
     */
    ...
    /**
     * Indicates when an attribute and associated values are returned Required Enum: always, never,
     * default, request
     */
    ...
    /**
     * Specifies how the service provider enforces uniqueness of attribute values Required Enum:
     * none, server, global
     */

...
public class SearchDirectoryEntriesRequest {
    ...
    /**
     * The list of field to be searched for Enum: firstName, lastName, extensionNumber, phoneNumber,
     * email, jobTitle, department, customFieldValue
     */
    ...
    /**
     * If `true` then contacts of all accounts in federation are returned, if it is in federation,
     * account section will be returned. If `false` then only contacts of the current account are
     * returned, and account section is eliminated in this case Default: true
     */
    ...
    /**
     * Type of directory contact to filter Example: User Enum: User, Department, Announcement,
     * Voicemail, SharedLinesGroup, PagingOnly, ParkLocation, IvrMenu, Limited,
    ...
    /**
     * Allows to control whether External (Hybrid) contacts should be returned in the response or
     * not Example: true
     */
    ...
    /**
     * The list of Internal identifiers of an accounts Example:
     * 854874047006,422456828004,854874151006
     */
    ...
    public SearchDirectoryEntriesRequest extensionIds(String[] extensionIds) {
        this.extensionIds = extensionIds;
        return this;
    }

    /** Enum: Carrier, Account */
    public String[] integrationRoutingTypes;

    public SearchDirectoryEntriesRequest integrationRoutingTypes(String[] integrationRoutingTypes) {
        this.integrationRoutingTypes = integrationRoutingTypes;
        return this;
    }

    /**
     * The list of SMS availability statuses to filter phone numbers Enum: Active, Inactive,
     * Disabled, Banned, Suspended, Deprovisioning, InboundOnly, Unknown
     */
    public String[] phoneNumberSmsAvailabilityStatuses;

    public SearchDirectoryEntriesRequest phoneNumberSmsAvailabilityStatuses(
            String[] phoneNumberSmsAvailabilityStatuses) {
        this.phoneNumberSmsAvailabilityStatuses = phoneNumberSmsAvailabilityStatuses;
        return this;
    }

    /** The list of SMS campaign IDs to filter phone numbers */
    public String[] phoneNumberSmsCampaignIds;

    public SearchDirectoryEntriesRequest phoneNumberSmsCampaignIds(
            String[] phoneNumberSmsCampaignIds) {
        this.phoneNumberSmsCampaignIds = phoneNumberSmsCampaignIds;
        return this;
    }

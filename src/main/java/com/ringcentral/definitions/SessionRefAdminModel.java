...
public class SessionRefAdminModel {
    ...
    public SessionRefAdminModel id(String id) {
        this.id = id;
        return this;
    }

    public SessionRefAdminModel startTime(String startTime) {
        this.startTime = startTime;
        return this;
    }

    public SessionRefAdminModel endTime(String endTime) {
        this.endTime = endTime;
        return this;
    }

    public SessionRefAdminModel duration(Long duration) {
        this.duration = duration;
        return this;
    }

    public SessionRefAdminModel title(String title) {
        this.title = title;
        return this;
    }

    public SessionRefAdminModel description(String description) {
        this.description = description;
        return this;
    }

    public SessionRefAdminModel webinar(WebinarRefModel webinar) {

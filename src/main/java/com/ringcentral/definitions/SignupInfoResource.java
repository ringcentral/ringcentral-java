...
public class SignupInfoResource {
    ...
    /**
     * Enum: AccountCreated, BillingEntered, CreditCardApproved, AccountConfirmed,
     * PhoneVerificationRequired, PhoneVerificationPassed
     */
    ...
    /**
     * Enum: CC_Failed, Phone_Suspicious, CC_Phone_Not_Match, AVS_Not_Available, MaxMind,
     * CC_Blacklisted, Email_Blacklisted, Phone_Blacklisted, Cookie_Blacklisted, Device_Blacklisted,
     * IP_Blacklisted, Agent_Instance_Blacklisted, Charge_Limit, Other_Country, Unknown
     */
    ...
    /**
     * The timestamp of account creation Format: date-time Example: Fri Mar 10 2023 10:07:52

...
public class SipInfoResponse {
    ...
    /**
     * Preferred transport. SIP info will be returned for this transport if supported Enum: UDP,
     * TCP, TLS, WSS
     */
    ...
    /**
     * The interval in seconds after which the app must try to switch back to primary proxy if it
     * was previously switched to backup. If this parameter is not returned, the app must stay on
     * backup proxy and try to switch to primary proxy after the next SIP-provision call. Format:
     * int32
     */

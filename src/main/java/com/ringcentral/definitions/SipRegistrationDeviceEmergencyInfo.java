...
public class SipRegistrationDeviceEmergencyInfo {
    ...
    public SipRegistrationDeviceEmergencyInfo address(
            DeviceEmergencyServiceAddressResource address) {
    ...
    /**
     * Specifies whether to return only private or only public (company) ERLs (Emergency Response
     * Locations) Enum: Private, Public
     */

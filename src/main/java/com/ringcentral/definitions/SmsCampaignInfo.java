...
public class SmsCampaignInfo {
    ...
    /**
     * Status of the associated TCR campaign Enum: Created, Submitted, Confirmed, SubmitFailed,
     * UpdateRequested, DeleteRequested, CampaignSuspended, CampaignExpired, Draft, PreVetFailed,
     * Unconfirmed
     */
    ...
    /** Coverage type. Enum: PhoneNumber, Account, Conversational, Informational, Promotional */

...
public class TMCompanyInfo {
    /** Internal identifier of a company (RingCentral account ID) Required */
    public String id;
    ...
    /**
     * Datetime of creation in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) Required Format:
     * date-time
     */
    ...
    /**
     * Datetime of last modification in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) Required
     * Format: date-time
     */

...
public class TaskRecurrenceInfo {
    /**
     * Recurrence settings of a task. None for non-periodic tasks Default: None Enum: None, Daily,
     * Weekdays, Weekly, Monthly, Yearly
     */
    ...
    /** Ending condition of a task Default: None Enum: None, Count, Date */
    ...
    /**
     * End date of a periodic task in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format, UTC
     * time zone Format: date-time
     */

...
public class TaxLocation {
    ...
    /**
     * Type of the location object. Only &#039;TaxLocation&#039; is currently supported for POST
     * method Required Example: TaxLocation Enum: BillingAddress, TaxLocation, Site
     */
    public String type;
    ...
    /**
     * Effective date in the ISO 8601 (`YYYY-MM-DDThh:mm:ssTZD`) format, including date, time, and
     * timezone Format: date-time Example: Sun Jun 05 2022 03:11:12 GMT-0700 (Pacific Daylight Time)
     */

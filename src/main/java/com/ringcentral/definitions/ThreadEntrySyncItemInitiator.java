...
public class ThreadEntrySyncItemInitiator {
    ...
    public ThreadEntrySyncItemInitiator extensionId(String extensionId) {
    ...
    public ThreadEntrySyncItemInitiator name(String name) {
        this.name = name;
        return this;
    }
    ...
    public ThreadEntrySyncItemInitiator extensionType(String extensionType) {

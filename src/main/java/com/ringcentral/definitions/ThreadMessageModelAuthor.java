...
public class ThreadMessageModelAuthor {
    ...
    public ThreadMessageModelAuthor extensionId(String extensionId) {
    ...
    public ThreadMessageModelAuthor name(String name) {
        this.name = name;
        return this;
    }
    ...
    public ThreadMessageModelAuthor extensionType(String extensionType) {

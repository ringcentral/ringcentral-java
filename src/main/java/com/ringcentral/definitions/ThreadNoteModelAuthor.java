...
public class ThreadNoteModelAuthor {
    ...
    public ThreadNoteModelAuthor extensionId(String extensionId) {
    ...
    public ThreadNoteModelAuthor name(String name) {
        this.name = name;
        return this;
    }
    ...
    public ThreadNoteModelAuthor extensionType(String extensionType) {

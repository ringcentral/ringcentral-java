...
public class ThreadUserModel {
    /** Thread user&#039;s extension ID Required Example: 9876453210 */
    public String extensionId;

    public ThreadUserModel extensionId(String extensionId) {
    ...
    public ThreadUserModel name(String name) {
        this.name = name;
        return this;
    }
    ...
    public ThreadUserModel extensionType(String extensionType) {

...
/**
 * Date-time range for the calls. The call is considered to be within time range if it started
...
public class TimeSettings {
     ...
     * aggregation intervals. For example &#039;America/Los_Angeles&#039;,
     * &#039;Europe/Zurich&#039;. See also *[Time Zones](https://www.iana.org/time-zones)*. Value in
     * this field doesn&#039;t affect interpretation of time in `timeRange`, as it already includes
     * offset from UTC Required
     */

...
public class TimelineResponseOptionsCounters {
    ...
    /**
     * Include breakdown of calls count by segments (Ringing, LiveTalk, Hold, Park, Transfer,
    ...
    /**
     * Include breakdown of calls count by result (Completed, Abandoned, Voicemail, Unknown, Missed,
     * Accepted)
     */
    ...
    /**
     * Include breakdown of calls count by queue SLA (InSLA, OutSLA). This counter is only
     * applicable to Queues grouping
     */
    ...
    /**
     * Include breakdown of calls count by action (HoldOff, HoldOn, ParkOn, ParkOff, BlindTransfer,
    ...
    /**
     * Include breakdown of calls count by type (Direct, FromQueue, ParkRetrieval, Transferred,
     * Outbound)
     */
    ...
    /**
     * Include breakdown of calls count by the total number of times a Queue call was presented to
     * the user. It is limited to `groupBy` Users and `groupByMembers` (Department, Queue, Site,

...
public class TimelineResponseOptionsTimers {
    ...
    public TimelineResponseOptionsTimers callsDurationByDirection(
            Boolean callsDurationByDirection) {
    ...
    /**
     * Include breakdown of calls duration by response (Answered, NotAnswered, Connected,
     * NotConnected)
     */
    ...
    /**
     * Include breakdown of calls duration by segments (Ringing, LiveTalk, Hold, Park, Transfer,
    ...
    /**
     * Include breakdown of calls duration by result (Completed, Abandoned, Voicemail, Unknown,
     * Missed, Accepted)
     */
    ...
    public TimelineResponseOptionsTimers callsDurationByEndingParty(
            Boolean callsDurationByEndingParty) {
    ...
    public TimelineResponseOptionsTimers callsDurationByCompanyHours(
            Boolean callsDurationByCompanyHours) {
        this.callsDurationByCompanyHours = callsDurationByCompanyHours;
        return this;
    }

    /**
     * Include breakdown of calls duration by queue SLA (InSLA, OutSLA). This timer is only
    ...
    /**
     * Include breakdown of calls duration by type (Direct, FromQueue, ParkRetrieval, Transferred,
     * Outbound)
     */
    ...
    public TimelineResponseOptionsTimers callsDurationByQueueHours(
            Boolean callsDurationByQueueHours) {

...
public class TokenInfo {
    /**
     * OAuth access token to pass to subsequent API requests Required Example:
    ...
    /**
     * The list of space-separated application permissions (OAuth scopes) Required Example:
     * AccountInfo CallLog ExtensionInfo Messages SMS
     */
    public String scope;
    ...
    /**
     * Type of the token. The only supported value is `bearer`. (This value has to be used along
     * with the access token in the `Authorization` header of subsequent API requests) Required
     * Example: bearer Enum: bearer
     */
    ...
    /**
     * Client application instance identifier that matches the value provided by the client, or
     * generated by the server (if a client has not provided this value) Example:
     * 8zXq6oaLT7WvwWITlGiA1A
     */
    ...
    /**
     * Remaining time in seconds until session expiration due to absolute timeout. Returned only if
     * absolute session timeout is enforced Format: int32
     */
    ...
    /**
     * Absolute value of session expiration time in ISO date formatted string. Returned only if
     * absolute session timeout is enforced Format: date-time Example: Sat Apr 01 2023 05:00:01
    ...
    /**
     * Nominal value of session idle timeout in seconds. Returned only if idle session timeout is
     * enforced Format: int32
     */

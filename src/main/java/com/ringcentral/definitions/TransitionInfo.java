...
public class TransitionInfo {
    /**
     * Specifies if a welcome/activation email is sent to the new users (with the extension status
     * transition from &#039;Unassigned&#039; to &#039;NotActivated/Disabled&#039;) Default: true
     */

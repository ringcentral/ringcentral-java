...
public class UserContactsPagingInfo {
    /**
     * Current page number. 1-indexed, so the first page is 1 by default. May be omitted if the
    ...
    /**
     * Current page size, describes how many items each page contains. Default value is 100. Maximum
    ...
    /**
     * Zero-based number of the first element on the current page. Omitted if a page is omitted or
     * the result is empty Format: int32
     */
    ...
    /**
     * Zero-based index of the last element on the current page. Omitted if a page is omitted or the

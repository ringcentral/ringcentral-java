...
public class UserInfoResource {
    /**
     * Subject - the End-User internal identifier. Contains RingCentral user (extension) ID Required
     * Example: 987654321
     */
    public String sub;
    ...
    /** End-User&#039;s preferred e-mail address Format: email Example: john.doe@acme.com */
    public String email;

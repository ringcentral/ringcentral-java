...
public class UserTransitionInfo {
    /**
     * Specifies if a welcome/activation email is sent to the existing users during account
     * confirmation
     */
    ...
    /**
     * Specifies if a welcome/activation email is sent to the new users (within extension status
     * changing from `Unassigned` to `NotActivated/Disabled`)
     */

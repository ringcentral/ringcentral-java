...
public class WebinarSettingsModel {
    ...
    /**
     * Indicates if Panelists have to be authenticated users Default: AuthenticatedCoworker Enum:
     * Guest, AuthenticatedUser, AuthenticatedCoworker
     */
    ...
    /**
     * Indicates if attendees have to be authenticated users Default: AuthenticatedCoworker Enum:
     * Guest, AuthenticatedUser, AuthenticatedCoworker
     */
    ...
    public WebinarSettingsModel artifactsAccessAuthentication(

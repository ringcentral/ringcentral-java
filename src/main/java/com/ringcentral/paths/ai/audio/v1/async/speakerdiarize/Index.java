...
public class Index {
    ...
    /**
     * Identifies who said what. Speaker diarization will identify the speaker for each segment so
     * you can tell who spoke the sentence, paragraph, or phrase.
     *
     * <p>HTTP Method: post Endpoint: /ai/audio/v1/async/speaker-diarize Rate Limit Group: Heavy App
     * Permission: AI
     */
    public CaiAsyncApiResponse post(
            DiarizeInput diarizeInput, CaiSpeakerDiarizeParameters queryParams)
    ...
    public CaiAsyncApiResponse post(DiarizeInput diarizeInput)
            throws com.ringcentral.RestException, java.io.IOException {

...
public class Index {
    ...
    /**
     * Returns Speech to Text Conversion to the provided webhook URI. HTTP Method: post Endpoint:
     * /ai/audio/v1/async/speech-to-text Rate Limit Group: Heavy App Permission: AI
     */
    public CaiAsyncApiResponse post(AsrInput asrInput, CaiSpeechToTextParameters queryParams)
    ...
    public CaiAsyncApiResponse post(AsrInput asrInput)
            throws com.ringcentral.RestException, java.io.IOException {

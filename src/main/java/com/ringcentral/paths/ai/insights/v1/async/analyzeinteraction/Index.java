...
public class Index {
    ...
    /**
     * Returns multiple insights including summaries, key phrases, questions asked, and more in a
     * single API call.
     *
     * <p>HTTP Method: post Endpoint: /ai/insights/v1/async/analyze-interaction Rate Limit Group:
     * Heavy App Permission: AI
     */
    public CaiAsyncApiResponse post(
            InteractionInput interactionInput, CaiAnalyzeInteractionParameters queryParams)
    ...
    public CaiAsyncApiResponse post(InteractionInput interactionInput)
            throws com.ringcentral.RestException, java.io.IOException {

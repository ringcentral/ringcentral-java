...
public class Index {
    ...
    public Index(
            com.ringcentral.paths.ai.ringsense.v1.public1.accounts.Index parent, String domain) {
        this.parent = parent;
        this.rc = parent.rc;
        this.domain = domain;
    }
    ...
    public com.ringcentral.paths.ai.ringsense.v1.public1.accounts.domains.records.Index records(
        ...
        return new com.ringcentral.paths.ai.ringsense.v1.public1.accounts.domains.records.Index(
                this, sourceRecordId);
    }

    public com.ringcentral.paths.ai.ringsense.v1.public1.accounts.domains.sessions.Index
            sessions() {
    ...
    public com.ringcentral.paths.ai.ringsense.v1.public1.accounts.domains.sessions.Index sessions(
        ...
        return new com.ringcentral.paths.ai.ringsense.v1.public1.accounts.domains.sessions.Index(

...
public class Index {
    ...
    public Index(
            com.ringcentral.paths.ai.ringsense.v1.public1.accounts.domains.records.Index parent) {
        this.parent = parent;
        this.rc = parent.rc;
    }
    ...
    /**
     * Returns the insights of a call recording HTTP Method: get Endpoint:
     ...
     */
    public RecordingInsights get(GetRecordingInsightsParameters queryParams)

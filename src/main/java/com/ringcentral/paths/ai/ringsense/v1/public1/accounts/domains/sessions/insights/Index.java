...
public class Index {
    ...
    public Index(
            com.ringcentral.paths.ai.ringsense.v1.public1.accounts.domains.sessions.Index parent) {
        this.parent = parent;
        this.rc = parent.rc;
    }
    ...
    /**
     * Returns the insights of all call recordings in a session HTTP Method: get Endpoint:
     * /ai/ringsense/v1/public/accounts/{accountId}/domains/{domain}/sessions/{sourceSessionId}/insights
     * Rate Limit Group: Light App Permission: RingSense
     */
    public SessionsInsightsResource get(GetSessionInsightsParameters queryParams)
    ...
    public SessionsInsightsResource get()
            throws com.ringcentral.RestException, java.io.IOException {

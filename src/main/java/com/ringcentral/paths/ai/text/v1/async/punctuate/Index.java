...
public class Index {
    ...
    /**
     * Returns Smart Punctuation to the provided webhook URI. HTTP Method: post Endpoint:
     * /ai/text/v1/async/punctuate Rate Limit Group: Heavy App Permission: AI
     */
    public CaiAsyncApiResponse post(
            PunctuateInput punctuateInput, CaiPunctuateParameters queryParams)
    ...
    public CaiAsyncApiResponse post(PunctuateInput punctuateInput)
            throws com.ringcentral.RestException, java.io.IOException {

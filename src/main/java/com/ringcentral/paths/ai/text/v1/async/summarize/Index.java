...
public class Index {
     ...
     *
     * <p>HTTP Method: post Endpoint: /ai/text/v1/async/summarize Rate Limit Group: Heavy App
     * Permission: AI
     */
    public CaiAsyncApiResponse post(SummaryInput summaryInput, CaiSummarizeParameters queryParams)
    ...
    public CaiAsyncApiResponse post(SummaryInput summaryInput)
            throws com.ringcentral.RestException, java.io.IOException {

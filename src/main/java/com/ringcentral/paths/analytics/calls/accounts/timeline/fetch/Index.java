package com.ringcentral.paths.analytics.calls.accounts.timeline.fetch;
...
public class Index {
    ...
    public com.ringcentral.paths.analytics.calls.accounts.timeline.Index parent;

    public Index(com.ringcentral.paths.analytics.calls.accounts.timeline.Index parent) {
        this.parent = parent;
        this.rc = parent.rc;
    }

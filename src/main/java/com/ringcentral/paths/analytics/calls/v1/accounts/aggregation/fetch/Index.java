...
public class Index {
    ...
    /**
     * Returns call aggregations filtered by parameters specified HTTP Method: post Endpoint:
     * /analytics/calls/v1/accounts/{accountId}/aggregation/fetch Rate Limit Group: Light App
     * Permission: Analytics
     */
    public AggregationResponse post(
            AggregationRequest aggregationRequest,
            AnalyticsCallsAggregationFetchParameters queryParams)
    ...
    public AggregationResponse post(AggregationRequest aggregationRequest)
            throws com.ringcentral.RestException, java.io.IOException {

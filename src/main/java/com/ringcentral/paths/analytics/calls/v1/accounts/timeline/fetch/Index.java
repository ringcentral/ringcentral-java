...
public class Index {
    ...
    /**
     * Returns time-value data aggregations filtered by parameters specified HTTP Method: post
     * Endpoint: /analytics/calls/v1/accounts/{accountId}/timeline/fetch Rate Limit Group: Light App
     * Permission: Analytics
     */
    public TimelineResponse post(
            TimelineRequest timelineRequest, AnalyticsCallsTimelineFetchParameters queryParams)
    ...
    public TimelineResponse post(TimelineRequest timelineRequest)
            throws com.ringcentral.RestException, java.io.IOException {

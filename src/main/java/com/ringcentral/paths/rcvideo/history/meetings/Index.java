package com.ringcentral.paths.rcvideo.history.meetings;
...
public class Index {
    ...
    public com.ringcentral.paths.rcvideo.history.Index parent;
    public String meetingId;

    public Index(com.ringcentral.paths.rcvideo.history.Index parent, String meetingId) {
        this.parent = parent;
        this.rc = parent.rc;

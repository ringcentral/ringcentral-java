...
public class Index {
    ...
    public com.ringcentral.paths.rcvideo.v1.account.extension.recordings.Index recordings(String recordingId) {
        return new com.ringcentral.paths.rcvideo.v1.account.extension.recordings.Index(this, recordingId);
    }

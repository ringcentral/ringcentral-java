...
public class Index {
    ...
    /**
     * Returns the list of users who can delegate bridge/meeting creation to the given user. HTTP
     * Method: get Endpoint: /rcvideo/v1/accounts/{accountId}/extensions/{extensionId}/delegators
     * Rate Limit Group: Medium App Permission: Video
     */

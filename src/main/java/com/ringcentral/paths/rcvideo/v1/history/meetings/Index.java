...
public class Index {
    ...
    /**
     * Returns the list of user meetings. HTTP Method: get Endpoint: /rcvideo/v1/history/meetings
     * Rate Limit Group: Light App Permission: Video
     */
    public MeetingPage list(ListVideoMeetingsParameters queryParams)
    ...
    /**
     * Returns a user meeting by ID. HTTP Method: get Endpoint:
     * /rcvideo/v1/history/meetings/{meetingId} Rate Limit Group: Light App Permission: Video
     */

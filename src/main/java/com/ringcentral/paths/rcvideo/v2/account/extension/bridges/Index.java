...
public class Index {
    ...
    /**
     * Creates a new bridge for the user specified by `accountId` and `extensionId` identifiers. The
     * request body should contain JSON object which describes properties of the new bridge. The
     * bridge can be created by the owner, a delegate or any user who has the **Super Admin**
     * privilege.
     *
     * <p>HTTP Method: post Endpoint:
     * /rcvideo/v2/account/{accountId}/extension/{extensionId}/bridges Rate Limit Group: Heavy App
     * Permission: Video
     */
    public BridgeResponse post(CreateBridgeRequest createBridgeRequest)

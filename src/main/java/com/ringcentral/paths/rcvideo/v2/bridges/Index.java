...
public class Index {
    ...
    /**
     * Returns a bridge by `bridgeId` identifier. HTTP Method: get Endpoint:
     * /rcvideo/v2/bridges/{bridgeId} Rate Limit Group: Medium App Permission: Video
     */
    public BridgeResponse get(GetBridgeParameters queryParams)
    ...
    /**
     * Deletes a bridge by `bridgeId` identifier. Deletion can only be done by the bridge owner, an
     * owner&#039;s delegate or any user who has the **Super Admin** privilege.
     *
     * <p>HTTP Method: delete Endpoint: /rcvideo/v2/bridges/{bridgeId} Rate Limit Group: Medium App
     * Permission: Video
     */
    ...
    /**
     * Updates a bridge by `bridgeId` identifier. The request body should contain JSON object with
     * updating properties. Update can only be done by the bridge owner, an owner&#039;s delegate or
     * any user who has the **Super Admin** privilege.
     *
     * <p>HTTP Method: patch Endpoint: /rcvideo/v2/bridges/{bridgeId} Rate Limit Group: Medium App
     * Permission: Video
     */
    public BridgeResponse patch(UpdateBridgeRequest updateBridgeRequest)
            throws com.ringcentral.RestException, java.io.IOException {
        if (bridgeId == null) {
            throw new IllegalArgumentException("Parameter bridgeId cannot be null");
        }

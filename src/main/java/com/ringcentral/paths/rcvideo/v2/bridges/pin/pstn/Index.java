...
public class Index {
    ...
    /**
     * Finds a bridge by Host or Participant PSTN PIN. HTTP Method: get Endpoint:
     * /rcvideo/v2/bridges/pin/pstn/{pin} Rate Limit Group: Medium App Permission: Video
     */
    public BridgeResponse get(GetBridgeByPstnPinParameters queryParams)

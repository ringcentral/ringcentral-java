...
public class Index {
    ...
    /**
     * Finds a bridge by short identifier (Web PIN). Also it can be used to find a default bridge by
     * the alias (personal meeting name).
     *
     * <p>HTTP Method: get Endpoint: /rcvideo/v2/bridges/pin/web/{pin} Rate Limit Group: Medium App
     * Permission: Video
     */
    public BridgeResponse get(GetBridgeByWebPinParameters queryParams)

...
public class Index {
    ...
    /**
     * Returns current API version(s) and server info. HTTP Method: get Endpoint: /restapi Rate
     * Limit Group: NoThrottling
     */
    ...
    /**
     * Returns current API version info by apiVersion. HTTP Method: get Endpoint:
     * /restapi/{apiVersion} Rate Limit Group: NoThrottling
     */

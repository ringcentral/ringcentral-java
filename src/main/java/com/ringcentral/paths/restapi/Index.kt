...
class Index(val rc: com.ringcentral.RestClient, val apiVersion: String? = "v1.0") {
      ...
      fun list() : com.ringcentral.definitions.GetVersionsResponse?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.GetVersionsResponse::class.java)
      ...
      fun get() : com.ringcentral.definitions.GetVersionResponse?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.GetVersionResponse::class.java)
      ...
      @JvmOverloads fun account(accountId: String? = "~") : com.ringcentral.paths.restapi.account.Index
      {
      ...
      @JvmOverloads fun subscription(subscriptionId: String? = null) : com.ringcentral.paths.restapi.subscription.Index
      {

...
public class Index {
     ...
     *
     * <p>HTTP Method: get Endpoint: /restapi/{apiVersion}/account/{accountId} Rate Limit Group:
     * Light App Permission: ReadAccounts User Permission: ReadCompanyInfo
     */
    ...
    public com.ringcentral.paths.restapi.account.msteams.Index msTeams() {
        return new com.ringcentral.paths.restapi.account.msteams.Index(this);
    }
    ...
    public com.ringcentral.paths.restapi.account.pagingonlygroups.Index pagingOnlyGroups(
        ...
        return new com.ringcentral.paths.restapi.account.pagingonlygroups.Index(
    ...
    public com.ringcentral.paths.restapi.account.smsregistrationbrands.Index
            smsRegistrationBrands() {
        return this.smsRegistrationBrands(null);
    }

    public com.ringcentral.paths.restapi.account.smsregistrationbrands.Index smsRegistrationBrands(
            String tcrBrandId) {
        return new com.ringcentral.paths.restapi.account.smsregistrationbrands.Index(
                this, tcrBrandId);
    }

    public com.ringcentral.paths.restapi.account.messagestoretemplates.Index
    ...
    public com.ringcentral.paths.restapi.account.messagestoretemplates.Index messageStoreTemplates(
            String templateId) {
        return new com.ringcentral.paths.restapi.account.messagestoretemplates.Index(
                this, templateId);
    }

    public com.ringcentral.paths.restapi.account.addressbookbulkupload.Index
            addressBookBulkUpload() {
        return new com.ringcentral.paths.restapi.account.addressbookbulkupload.Index(this);
    }

    public com.ringcentral.paths.restapi.account.messagestoreconfiguration.Index
            messageStoreConfiguration() {
        return new com.ringcentral.paths.restapi.account.messagestoreconfiguration.Index(this);
    }

    public com.ringcentral.paths.restapi.account.emergencyaddressautoupdate.Index

 ...
 * 
  ...
  public com.ringcentral.paths.restapi.account.smsregistrationbrands.Index smsRegistrationBrands(String tcrBrandId)
  {
    return new com.ringcentral.paths.restapi.account.smsregistrationbrands.Index(this, tcrBrandId);
  }

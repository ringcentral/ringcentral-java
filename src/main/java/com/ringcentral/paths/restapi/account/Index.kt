...
class Index(val parent: com.ringcentral.paths.restapi.Index, val accountId: String? = "~") {
      ...
      fun get() : com.ringcentral.definitions.GetAccountInfoResponse?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.GetAccountInfoResponse::class.java)
      
    }
    


      @JvmOverloads fun extension(extensionId: String? = "~") : com.ringcentral.paths.restapi.account.extension.Index
      {
      ...
      @JvmOverloads fun calllog(callRecordId: String? = null) : com.ringcentral.paths.restapi.account.calllog.Index
      {
      ...
      fun calllogsync() : com.ringcentral.paths.restapi.account.calllogsync.Index
      {
        return com.ringcentral.paths.restapi.account.calllogsync.Index(this)
      }
      ...
      @JvmOverloads fun recording(recordingId: String? = null) : com.ringcentral.paths.restapi.account.recording.Index
      {
      ...
      @JvmOverloads fun callqueues(groupId: String? = null) : com.ringcentral.paths.restapi.account.callqueues.Index
      {
      ...
      @JvmOverloads fun answeringrule(ruleId: String? = null) : com.ringcentral.paths.restapi.account.answeringrule.Index
      {
      ...
      @JvmOverloads fun ivrprompts(promptId: String? = null) : com.ringcentral.paths.restapi.account.ivrprompts.Index
      {
      ...
      @JvmOverloads fun ivrmenus(ivrMenuId: String? = null) : com.ringcentral.paths.restapi.account.ivrmenus.Index
      {
      ...
      fun emergencyaddressautoupdate() : com.ringcentral.paths.restapi.account.emergencyaddressautoupdate.Index
      {
        return com.ringcentral.paths.restapi.account.emergencyaddressautoupdate.Index(this)
      }
    


      @JvmOverloads fun emergencylocations(locationId: String? = null) : com.ringcentral.paths.restapi.account.emergencylocations.Index
      {
        return com.ringcentral.paths.restapi.account.emergencylocations.Index(this, locationId)
      }
      ...
      @JvmOverloads fun phonenumber(phoneNumberId: String? = null) : com.ringcentral.paths.restapi.account.phonenumber.Index
      {
      ...
      @JvmOverloads fun templates(templateId: String? = null) : com.ringcentral.paths.restapi.account.templates.Index
      {
      ...
      @JvmOverloads fun department(departmentId: String? = null) : com.ringcentral.paths.restapi.account.department.Index
      {
      ...
      @JvmOverloads fun pagingonlygroups(pagingOnlyGroupId: String? = null) : com.ringcentral.paths.restapi.account.pagingonlygroups.Index
      {
      ...
      @JvmOverloads fun callmonitoringgroups(groupId: String? = null) : com.ringcentral.paths.restapi.account.callmonitoringgroups.Index
      {
      ...
      @JvmOverloads fun device(deviceId: String? = null) : com.ringcentral.paths.restapi.account.device.Index
      {
      ...
      @JvmOverloads fun messagestorereport(taskId: String? = null) : com.ringcentral.paths.restapi.account.messagestorereport.Index
      {
      ...
      fun meetingrecordings() : com.ringcentral.paths.restapi.account.meetingrecordings.Index
      {
        return com.ringcentral.paths.restapi.account.meetingrecordings.Index(this)
      }
    


      @JvmOverloads fun customfields(fieldId: String? = null) : com.ringcentral.paths.restapi.account.customfields.Index
      {
        return com.ringcentral.paths.restapi.account.customfields.Index(this, fieldId)
      }

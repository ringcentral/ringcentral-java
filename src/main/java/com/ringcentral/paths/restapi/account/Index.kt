...
class Index(val parent: com.ringcentral.paths.restapi.Index, val accountId: String? = "~") {
    ...
    @JvmOverloads
    fun customfields(fieldId: String? = null): com.ringcentral.paths.restapi.account.customfields.Index {
    ...
    fun meeting(): com.ringcentral.paths.restapi.account.meeting.Index {
        return com.ringcentral.paths.restapi.account.meeting.Index(this)
    }
    ...
    @JvmOverloads
    fun emergencylocations(locationId: String? = null): com.ringcentral.paths.restapi.account.emergencylocations.Index {

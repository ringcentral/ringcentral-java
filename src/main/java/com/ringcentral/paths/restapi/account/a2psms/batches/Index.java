...
public class Index {
    ...
    /**
     * Returns the list of A2P batches sent from the current account. The list can be filtered by
     * message batch ID and/or from phone number.
     *
     * <p>HTTP Method: get Endpoint: /restapi/{apiVersion}/account/{accountId}/a2p-sms/batches Rate
     * Limit Group: Light App Permission: A2PSMS
     */
    public BatchListResponse list(ListA2PBatchesParameters queryParams)
    ...
    /**
     * Allows to send high volume of A2P (Application-to-Person) SMS messages (in message batches).
     * Only phone number with the `A2PSmsSender` feature can be used as a sender.
     *
     * <p>HTTP Method: post Endpoint: /restapi/{apiVersion}/account/{accountId}/a2p-sms/batches Rate
     * Limit Group: Light App Permission: A2PSMS
     */
    ...
    /**
     * Returns information on a message batch. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/a2p-sms/batches/{batchId} Rate Limit Group: Light

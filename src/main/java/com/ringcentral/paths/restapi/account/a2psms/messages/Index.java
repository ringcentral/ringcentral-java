...
public class Index {
    ...
    /**
     * Returns the list of outbound/inbound A2P messages sent from/to A2P phone numbers of the
     * current account. The list can be filtered by message batch ID and/or phone number. HTTP
     * Method: get Endpoint: /restapi/{apiVersion}/account/{accountId}/a2p-sms/messages Rate Limit
     * Group: Light App Permission: A2PSMS
     */
    public MessageListResponse list(ListA2PSMSParameters queryParams)
    ...
    /**
     * Returns the details of an A2P SMS message by ID. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/a2p-sms/messages/{messageId} Rate Limit Group:
     * Light App Permission: A2PSMS
     */

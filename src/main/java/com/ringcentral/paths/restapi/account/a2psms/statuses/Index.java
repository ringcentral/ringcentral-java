...
public class Index {
    ...
    /**
     * Retrieves a set of message counts by message status and error codes filtered by dates,
     * batchId and message direction. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/a2p-sms/statuses Rate Limit Group: Light App
     * Permission: A2PSMS
     */
    public MessageStatusesResponse get(AggregateA2PSMSStatusesParameters queryParams)

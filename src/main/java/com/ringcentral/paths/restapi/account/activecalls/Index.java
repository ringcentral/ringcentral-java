...
public class Index {
     ...
     * HTTP Method: get Endpoint: /restapi/{apiVersion}/account/{accountId}/active-calls Rate Limit
     * Group: Heavy App Permission: ReadCallLog User Permission: ReadCallLog
     */
    public CallLogResponse get(ListCompanyActiveCallsParameters queryParams)

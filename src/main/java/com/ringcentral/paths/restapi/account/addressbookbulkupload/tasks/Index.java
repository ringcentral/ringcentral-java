...
public class Index {
    ...
    public Index(
            com.ringcentral.paths.restapi.account.addressbookbulkupload.Index parent,
            String taskId) {
        this.parent = parent;
        this.rc = parent.rc;
        this.taskId = taskId;
     ...
     * /restapi/{apiVersion}/account/{accountId}/address-book-bulk-upload/tasks/{taskId} Rate Limit
     * Group: Light App Permission: Contacts User Permission: EditPersonalContacts
     */
    public AddressBookBulkUploadResponse get()

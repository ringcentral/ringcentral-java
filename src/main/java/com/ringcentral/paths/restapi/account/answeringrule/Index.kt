...
class Index(val parent: com.ringcentral.paths.restapi.account.Index, val ruleId: String? = null) {
      ...
      fun post(companyAnsweringRuleRequest: com.ringcentral.definitions.CompanyAnsweringRuleRequest) : com.ringcentral.definitions.CompanyAnsweringRuleInfo?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.CompanyAnsweringRuleInfo::class.java)
       ...
       */
      @JvmOverloads fun list(queryParams: com.ringcentral.definitions.ListCompanyAnsweringRulesParameters? = null) : com.ringcentral.definitions.CompanyAnsweringRuleList?
      {
        val rb: okhttp3.ResponseBody = rc.get(this.path(false), queryParams)
        
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.CompanyAnsweringRuleList::class.java)

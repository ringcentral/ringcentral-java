...
public class Index {
    ...
    /**
     * Synchronizes company call log records. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/call-log-sync Rate Limit Group: Heavy App
     * Permission: ReadCallLog User Permission: ReadCallLog
     */
    public CallLogSyncResponse get(SyncAccountCallLogParameters queryParams)

...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/call-monitoring-groups Rate Limit Group: Medium App
     * Permission: ReadAccounts User Permission: ReadExtensions
     */
    public CallMonitoringGroups get(ListCallMonitoringGroupsParameters queryParams)
     ...
     * /restapi/{apiVersion}/account/{accountId}/call-monitoring-groups Rate Limit Group: Medium App
     * Permission: EditExtensions User Permission: Groups
     */
    public CallMonitoringGroup post(
            CreateCallMonitoringGroupRequest createCallMonitoringGroupRequest)
            throws com.ringcentral.RestException, java.io.IOException {
        okhttp3.ResponseBody rb =
                this.rc.post(this.path(false), createCallMonitoringGroupRequest, null);
     ...
     * /restapi/{apiVersion}/account/{accountId}/call-monitoring-groups/{groupId} Rate Limit Group:
     * Medium App Permission: EditExtensions User Permission: Groups
     */
    public CallMonitoringGroup put(
            CreateCallMonitoringGroupRequest createCallMonitoringGroupRequest)
            throws com.ringcentral.RestException, java.io.IOException {
        if (groupId == null) {
    ...
    public com.ringcentral.paths.restapi.account.callmonitoringgroups.bulkassign.Index
            bulkAssign() {
        return new com.ringcentral.paths.restapi.account.callmonitoringgroups.bulkassign.Index(
                this);
    }
}

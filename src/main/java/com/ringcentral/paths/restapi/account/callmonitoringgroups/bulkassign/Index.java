...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/call-monitoring-groups/{groupId}/bulk-assign Rate
     * Limit Group: Heavy App Permission: EditExtensions User Permission: Groups
     */
    public String post(CallMonitoringBulkAssign callMonitoringBulkAssign)

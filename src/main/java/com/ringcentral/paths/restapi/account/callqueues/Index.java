...
public class Index {
    ...
    /**
     * Returns a call queue list. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/call-queues Rate Limit Group: Medium App
     * Permission: ReadAccounts User Permission: ReadExtensions
     */
    public CallQueueList list(ListCallQueuesParameters queryParams)
    ...
    /**
     * Returns basic information on a call queue group extension. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/call-queues/{groupId} Rate Limit Group: Light App
     * Permission: ReadAccounts User Permission: ReadExtensions
     */
     ...
     *
     * <p>HTTP Method: put Endpoint: /restapi/{apiVersion}/account/{accountId}/call-queues/{groupId}
     * Rate Limit Group: Light App Permission: EditExtensions User Permission: EditUserInfo
     */
    public CallQueueDetails put(CallQueueDetailsForUpdate callQueueDetailsForUpdate)
            throws com.ringcentral.RestException, java.io.IOException {
        if (groupId == null) {
            throw new IllegalArgumentException("Parameter groupId cannot be null");
        }

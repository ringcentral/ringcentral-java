...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/call-queues/{groupId}/bulk-assign Rate Limit Group:
     * Heavy App Permission: EditExtensions User Permission: Groups
     */
    public String post(CallQueueBulkAssignResource callQueueBulkAssignResource)

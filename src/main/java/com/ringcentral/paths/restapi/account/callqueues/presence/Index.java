...
public class Index {
    ...
    /**
     * Returns presence status of the call queue members. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/call-queues/{groupId}/presence Rate Limit Group:
     * Light App Permission: ReadPresence
     */
    ...
    /**
     * Updates presence status of the call queue members in the specified queue. HTTP Method: put
     * Endpoint: /restapi/{apiVersion}/account/{accountId}/call-queues/{groupId}/presence Rate Limit
     * Group: Medium App Permission: EditPresence
     */
    public CallQueuePresence put(CallQueueUpdatePresence callQueueUpdatePresence)

...
public class Index {
    ...
    /**
     * Returns call recording settings. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/call-recording Rate Limit Group: Light App
     * Permission: ReadAccounts User Permission: ReadCompanyInfo
     */
    public CallRecordingSettingsResource get()
            throws com.ringcentral.RestException, java.io.IOException {
        okhttp3.ResponseBody rb = this.rc.get(this.path(), null);
        return com.ringcentral.Utils.gson.fromJson(
                rb.string(), CallRecordingSettingsResource.class);
    }

    /**
     * Updates current call recording settings. HTTP Method: put Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/call-recording Rate Limit Group: Medium App
     * Permission: EditAccounts User Permission: EditCompanyInfo
     */
    public CallRecordingSettingsResource put(
    ...
    public com.ringcentral.paths.restapi.account.callrecording.customgreetings.Index
            customGreetings() {
        return this.customGreetings(null);
    }

    public com.ringcentral.paths.restapi.account.callrecording.customgreetings.Index
            customGreetings(String greetingId) {
        return new com.ringcentral.paths.restapi.account.callrecording.customgreetings.Index(
                this, greetingId);
    }
}

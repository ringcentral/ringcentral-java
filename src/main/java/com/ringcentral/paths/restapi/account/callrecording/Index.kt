...
class Index(val parent: com.ringcentral.paths.restapi.account.Index) {
      ...
      fun get() : com.ringcentral.definitions.CallRecordingSettingsResource?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.CallRecordingSettingsResource::class.java)
      ...
      @JvmOverloads fun customgreetings(greetingId: String? = null) : com.ringcentral.paths.restapi.account.callrecording.customgreetings.Index
      {

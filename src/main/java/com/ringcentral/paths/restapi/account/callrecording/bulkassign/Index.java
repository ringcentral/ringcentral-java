...
public class Index {
    ...
    /**
     * Creates or updates the list of extensions to be recorded. HTTP Method: post Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/call-recording/bulk-assign Rate Limit Group: Medium
     * App Permission: ReadAccounts User Permission: ReadCompanyInfo
     */
    public String post(BulkAccountCallRecordingsResource bulkAccountCallRecordingsResource)
            throws com.ringcentral.RestException, java.io.IOException {
        okhttp3.ResponseBody rb =
                this.rc.post(this.path(), bulkAccountCallRecordingsResource, null);
        return rb.string();
    }
}

...
public class Index {
    ...
    /**
     * Returns the list of extensions to be recorded. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/call-recording/extensions Rate Limit Group: Medium

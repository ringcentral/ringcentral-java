...
public class Index {
    ...
    /**
     * Returns the list of created custom fields. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/custom-fields Rate Limit Group: Light App
     * Permission: ReadAccounts User Permission: ReadUserInfo
     */
    ...
    /**
     * Creates custom field attached to the object. HTTP Method: post Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/custom-fields Rate Limit Group: Medium App
     * Permission: EditAccounts User Permission: Users
     */
    public CustomFieldModel post(CustomFieldCreateRequest customFieldCreateRequest)
    ...
    /**
     * Updates custom field by ID specified in path. HTTP Method: put Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/custom-fields/{fieldId} Rate Limit Group: Medium
     * App Permission: EditAccounts User Permission: Users
     */
    public CustomFieldModel put(CustomFieldUpdateRequest customFieldUpdateRequest)
            throws com.ringcentral.RestException, java.io.IOException {
        if (fieldId == null) {
    ...
    /**
     * Deletes custom field(s) by ID(s) with the corresponding values. HTTP Method: delete Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/custom-fields/{fieldId} Rate Limit Group: Medium
     * App Permission: EditAccounts User Permission: Users
     */

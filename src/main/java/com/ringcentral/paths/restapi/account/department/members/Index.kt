...
class Index(val parent: com.ringcentral.paths.restapi.account.department.Index) {
       ...
       */
      @JvmOverloads fun get(queryParams: com.ringcentral.definitions.ListDepartmentMembersParameters? = null) : com.ringcentral.definitions.DepartmentMemberList?
      {
        val rb: okhttp3.ResponseBody = rc.get(this.path(), queryParams)
        
        return com.ringcentral.Utils.gson.fromJson(rb.string(), com.ringcentral.definitions.DepartmentMemberList::class.java)

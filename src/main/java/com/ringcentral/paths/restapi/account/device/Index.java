...
public class Index {
    ...
    /**
     * Returns account device(s) by their ID(s). HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/device/{deviceId} Rate Limit Group: Light App
     * Permission: ReadAccounts User Permission: ReadCompanyDevices
     */
    public DeviceResource get(ReadDeviceParameters queryParams)
    ...
    /**
     * Updates account device(s) by their ID(s). HTTP Method: put Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/device/{deviceId} Rate Limit Group: Medium App
     * Permission: EditAccounts User Permission: EditCompanyDevices
     */
    public DeviceResource put(
            AccountDeviceUpdate accountDeviceUpdate, UpdateDeviceParameters queryParams)
            throws com.ringcentral.RestException, java.io.IOException {
        if (deviceId == null) {
            throw new IllegalArgumentException("Parameter deviceId cannot be null");
        }
    ...
    public DeviceResource put(AccountDeviceUpdate accountDeviceUpdate)
            throws com.ringcentral.RestException, java.io.IOException {

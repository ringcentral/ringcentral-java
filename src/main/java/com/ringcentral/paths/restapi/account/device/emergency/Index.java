...
public class Index {
    ...
    /**
     * Updates account device emergency information. HTTP Method: put Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/device/{deviceId}/emergency Rate Limit Group:
     * Medium App Permission: EditAccounts User Permission: EditCompanyDevices
     */

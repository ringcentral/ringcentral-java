...
public class Index {
    ...
    /**
     * Returns device SIP information. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/device/{deviceId}/sip-info Rate Limit Group: Light
     * App Permission: ReadAccounts User Permission: ReadCompanyDevices
     */

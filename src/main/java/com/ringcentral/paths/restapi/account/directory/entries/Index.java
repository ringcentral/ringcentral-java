...
public class Index {
     ...
     * `NotActivated` state are returned. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/directory/entries Rate Limit Group: Medium App
     * Permission: ReadAccounts
     */
    public DirectoryResource list(ListDirectoryEntriesParameters queryParams)
    ...
    /**
     * Returns contact information on a particular corporate user of a federated account. HTTP
     * Method: get Endpoint: /restapi/{apiVersion}/account/{accountId}/directory/entries/{entryId}
     * Rate Limit Group: Medium App Permission: ReadAccounts
     */
    public ContactResource get(ReadDirectoryEntryParameters queryParams)
            throws com.ringcentral.RestException, java.io.IOException {
        if (entryId == null) {

...
class Index(val parent: com.ringcentral.paths.restapi.account.directory.Index, val entryId: String? = null) {
       ...
       */
      @JvmOverloads fun list(queryParams: com.ringcentral.definitions.ListDirectoryEntriesParameters? = null) : com.ringcentral.definitions.DirectoryResource?
      {
        val rb: okhttp3.ResponseBody = rc.get(this.path(false), queryParams)
        
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.DirectoryResource::class.java)
      ...
      fun get() : com.ringcentral.definitions.ContactResource?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.ContactResource::class.java)

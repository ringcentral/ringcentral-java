...
public class Index {
    ...
    /**
     * Returns information on a federation and associated accounts. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/directory/federation Rate Limit Group: Medium App
     * Permission: ReadAccounts User Permission: ReadCompanyInfo
     */
    public FederationResource get(ReadDirectoryFederationParameters queryParams)

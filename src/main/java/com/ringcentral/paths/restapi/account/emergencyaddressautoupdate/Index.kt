...
class Index(val parent: com.ringcentral.paths.restapi.account.Index) {
      ...
      @JvmOverloads fun wirelesspoints(pointId: String? = null) : com.ringcentral.paths.restapi.account.emergencyaddressautoupdate.wirelesspoints.Index
      {
      ...
      @JvmOverloads fun networks(networkId: String? = null) : com.ringcentral.paths.restapi.account.emergencyaddressautoupdate.networks.Index
      {
      ...
      @JvmOverloads fun switches(switchId: String? = null) : com.ringcentral.paths.restapi.account.emergencyaddressautoupdate.switches.Index
      {
      ...
      @JvmOverloads fun tasks(taskId: String? = null) : com.ringcentral.paths.restapi.account.emergencyaddressautoupdate.tasks.Index
      {

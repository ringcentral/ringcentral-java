...
public class Index {
    ...
    public Index(
            com.ringcentral.paths.restapi.account.emergencyaddressautoupdate.devices.Index parent) {
        this.parent = parent;
        this.rc = parent.rc;
    }
     ...
     * /restapi/{apiVersion}/account/{accountId}/emergency-address-auto-update/devices/bulk-assign
    ...
    public String post(
        ...
        okhttp3.ResponseBody rb =
                this.rc.post(this.path(), assignMultipleDevicesAutomaticLocationUpdates, null);
        return rb.string();
    }
}

...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/emergency-address-auto-update/networks Rate Limit
     * Group: Heavy App Permission: EditAccounts User Permission: ConfigureEmergencyMaps
     */
    public NetworksList list(ListNetworksParameters queryParams)
    ...
    /**
     * Creates a new network in a corporate ethernet map for assignment of emergency addresses to
     ...
     * Group: Heavy App Permission: EditAccounts User Permission: ConfigureEmergencyMaps
     */
    public NetworkInfo post(CreateNetworkRequest createNetworkRequest)
            throws com.ringcentral.RestException, java.io.IOException {
     ...
     *
     * <p>HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/emergency-address-auto-update/networks/{networkId}
    ...
    /**
     * Updates a network in a corporate ethernet map for assignment of emergency addresses to
     * network access points.
     *
     ...
     */
    public NetworkInfo put(UpdateNetworkRequest updateNetworkRequest)
            throws com.ringcentral.RestException, java.io.IOException {
        if (networkId == null) {
            throw new IllegalArgumentException("Parameter networkId cannot be null");
        }

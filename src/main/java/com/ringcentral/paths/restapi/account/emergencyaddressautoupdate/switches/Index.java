 ...
 * 
         ...
         * User Permission: ConfigureEmergencyMaps
         */
  public SwitchInfo post(SwitchInfo switchInfo) throws com.ringcentral.RestException, java.io.IOException
  {
 ...
 * 
         ...
         * User Permission: ConfigureEmergencyMaps
         */
  public SwitchInfo put(SwitchInfo switchInfo) throws com.ringcentral.RestException, java.io.IOException
  {
    if (switchId == null)
    {
        throw new IllegalArgumentException("Parameter switchId cannot be null");

...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/emergency-address-auto-update/switches-bulk-create
     * Rate Limit Group: Heavy App Permission: EditAccounts User Permission: ConfigureEmergencyMaps
     */
    public CreateMultipleSwitchesResponse post(
        ...
        return com.ringcentral.Utils.gson.fromJson(
                rb.string(), CreateMultipleSwitchesResponse.class);
    }
}

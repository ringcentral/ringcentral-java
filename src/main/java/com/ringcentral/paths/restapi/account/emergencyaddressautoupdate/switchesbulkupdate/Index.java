...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/emergency-address-auto-update/switches-bulk-update
     * Rate Limit Group: Heavy App Permission: EditAccounts User Permission: ConfigureEmergencyMaps
     */
    public UpdateMultipleSwitchesResponse post(
        ...
        return com.ringcentral.Utils.gson.fromJson(
                rb.string(), UpdateMultipleSwitchesResponse.class);
    }
}

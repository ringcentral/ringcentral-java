...
public class Index {
    ...
    /**
     * Validates switches before creation or update. The maximum number of switches per request is
     * 10 000.
     *
     * <p>HTTP Method: post Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/emergency-address-auto-update/switches-bulk-validate
     * Rate Limit Group: Heavy App Permission: EditAccounts User Permission: ConfigureEmergencyMaps
     */
    public ValidateMultipleSwitchesResponse post(
        ...
        return com.ringcentral.Utils.gson.fromJson(
                rb.string(), ValidateMultipleSwitchesResponse.class);
    }
}

...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/emergency-address-auto-update/wireless-points Rate
     * Limit Group: Medium App Permission: EditAccounts User Permission: ConfigureEmergencyMaps
     */
    public WirelessPointsList list(ListWirelessPointsParameters queryParams)
     ...
     * /restapi/{apiVersion}/account/{accountId}/emergency-address-auto-update/wireless-points Rate
     * Limit Group: Heavy App Permission: EditAccounts User Permission: ConfigureEmergencyMaps
     */
    public WirelessPointInfo post(CreateWirelessPoint createWirelessPoint)
            throws com.ringcentral.RestException, java.io.IOException {
     ...
     *
     * <p>HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/emergency-address-auto-update/wireless-points/{pointId}
     ...
     */
    public WirelessPointInfo put(UpdateWirelessPoint updateWirelessPoint)
            throws com.ringcentral.RestException, java.io.IOException {
        if (pointId == null) {
            throw new IllegalArgumentException("Parameter pointId cannot be null");
        }
    ...
    /**
     * Deletes wireless point(s) of a corporate map by ID(s). HTTP Method: delete Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/emergency-address-auto-update/wireless-points/{pointId}
     * Rate Limit Group: Heavy App Permission: EditAccounts User Permission: ConfigureEmergencyMaps
     */

...
class Index(val parent: com.ringcentral.paths.restapi.account.emergencyaddressautoupdate.Index, val pointId: String? = null) {
       ...
       */
      @JvmOverloads fun list(queryParams: com.ringcentral.definitions.ListWirelessPointsParameters? = null) : com.ringcentral.definitions.WirelessPointsList?
      {
        val rb: okhttp3.ResponseBody = rc.get(this.path(false), queryParams)
        
        return com.alibaba.fastjson.JSON.parseObject(rb.string(), com.ringcentral.definitions.WirelessPointsList::class.java)
      ...
      fun post(createWirelessPoint: com.ringcentral.definitions.CreateWirelessPoint) : com.ringcentral.definitions.WirelessPointInfo?
      {
        ...
        return com.alibaba.fastjson.JSON.parseObject(rb.string(), com.ringcentral.definitions.WirelessPointInfo::class.java)

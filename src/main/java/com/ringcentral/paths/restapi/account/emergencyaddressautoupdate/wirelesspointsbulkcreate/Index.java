...
public class Index {
    ...
    /**
     * Creates multiple wireless points in a corporate map. The maximum number of wireless points
     * per request is 10 000; limitation for account is 70 000.
     *
     * <p>HTTP Method: post Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/emergency-address-auto-update/wireless-points-bulk-create
     * Rate Limit Group: Heavy App Permission: EditAccounts User Permission: ConfigureEmergencyMaps
     */
    public CreateMultipleWirelessPointsResponse post(
        ...
        okhttp3.ResponseBody rb =
                this.rc.post(this.path(), createMultipleWirelessPointsRequest, null);
        return com.ringcentral.Utils.gson.fromJson(
                rb.string(), CreateMultipleWirelessPointsResponse.class);
    }
}

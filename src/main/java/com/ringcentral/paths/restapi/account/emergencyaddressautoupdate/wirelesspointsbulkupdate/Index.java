...
public class Index {
    ...
    /**
     * Updates wireless points in corporate map. The maximum number of wireless points per request
     * is 10 000; limitation for account is 70 000.
     *
     * <p>HTTP Method: post Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/emergency-address-auto-update/wireless-points-bulk-update
     * Rate Limit Group: Heavy App Permission: EditAccounts User Permission: ConfigureEmergencyMaps
     */
    public UpdateMultipleWirelessPointsResponse post(
        ...
        okhttp3.ResponseBody rb =
                this.rc.post(this.path(), updateMultipleWirelessPointsRequest, null);
        return com.ringcentral.Utils.gson.fromJson(
                rb.string(), UpdateMultipleWirelessPointsResponse.class);
    }
}

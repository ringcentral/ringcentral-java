...
public class Index {
    ...
    /**
     * Validates wireless points before creation or update. The maximum number of wireless points
     * per request is 10 000.
     *
     * <p>HTTP Method: post Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/emergency-address-auto-update/wireless-points-bulk-validate
     * Rate Limit Group: Heavy App Permission: EditAccounts User Permission: ConfigureEmergencyMaps
     */
    public ValidateMultipleWirelessPointsResponse post(
        ...
        okhttp3.ResponseBody rb =
                this.rc.post(this.path(), validateMultipleWirelessPointsRequest, null);
        return com.ringcentral.Utils.gson.fromJson(
                rb.string(), ValidateMultipleWirelessPointsResponse.class);
    }
}

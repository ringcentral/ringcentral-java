...
class Index(val parent: com.ringcentral.paths.restapi.account.Index, val locationId: String? = null) {
       ...
       */
      @JvmOverloads fun list(queryParams: com.ringcentral.definitions.ListEmergencyLocationsParameters? = null) : com.ringcentral.definitions.EmergencyLocationList?
      {
        val rb: okhttp3.ResponseBody = rc.get(this.path(false), queryParams)
        
        return com.alibaba.fastjson.JSON.parseObject(rb.string(), com.ringcentral.definitions.EmergencyLocationList::class.java)
      ...
      fun get() : com.ringcentral.definitions.EmergencyLocationInfo?
      {
        ...
        return com.alibaba.fastjson.JSON.parseObject(rb.string(), com.ringcentral.definitions.EmergencyLocationInfo::class.java)

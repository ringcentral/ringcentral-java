 ...
 * 
         ...
         */
  public GetExtensionInfoResponse post(ExtensionCreationRequest extensionCreationRequest) throws com.ringcentral.RestException, java.io.IOException
  {
 ...
 * 
    ...
    public com.ringcentral.paths.restapi.account.extension.addressbooksync.Index addressBookSync()
  {
    ...
    public com.ringcentral.paths.restapi.account.extension.overflowsettings.Index overflowSettings()
  {

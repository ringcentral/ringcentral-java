...
public class Index {
     ...
     *
     * <p>HTTP Method: get Endpoint: /restapi/{apiVersion}/account/{accountId}/extension Rate Limit
     * Group: Medium App Permission: ReadAccounts User Permission: ReadExtensions
     */
    public GetExtensionListResponse list(ListExtensionsParameters queryParams)
    ...
    public GetExtensionListResponse list()
            throws com.ringcentral.RestException, java.io.IOException {
     ...
     *
     * <p>HTTP Method: post Endpoint: /restapi/{apiVersion}/account/{accountId}/extension Rate Limit
     * Group: Medium App Permission: EditAccounts User Permission: AddRemoveUsers
     */
    public GetExtensionInfoResponse post(ExtensionCreationRequest extensionCreationRequest)
            throws com.ringcentral.RestException, java.io.IOException {
     ...
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId} Rate Limit Group: Light App
     * Permission: ReadAccounts User Permission: ReadExtensions
     */
    public GetExtensionInfoResponse get()
            throws com.ringcentral.RestException, java.io.IOException {
        if (extensionId == null) {
    ...
    /**
     * Updates the user settings. HTTP Method: put Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId} Rate Limit Group: Medium
     * App Permission: EditExtensions User Permission: EditUserInfo OR EditUserCredentials
     */
    public GetExtensionInfoResponse put(ExtensionUpdateRequest extensionUpdateRequest)
            throws com.ringcentral.RestException, java.io.IOException {
        if (extensionId == null) {
            throw new IllegalArgumentException("Parameter extensionId cannot be null");
        }
    ...
    public com.ringcentral.paths.restapi.account.extension.calllog.Index callLog(
            String callRecordId) {
        return new com.ringcentral.paths.restapi.account.extension.calllog.Index(
                this, callRecordId);
    }
    ...
    public com.ringcentral.paths.restapi.account.extension.profileimage.Index profileImage(
            String scaleSize) {
        return new com.ringcentral.paths.restapi.account.extension.profileimage.Index(
                this, scaleSize);
    }
    ...
    public com.ringcentral.paths.restapi.account.extension.messagestore.Index messageStore(
            String messageId) {
        return new com.ringcentral.paths.restapi.account.extension.messagestore.Index(
                this, messageId);
    }
    ...
    public com.ringcentral.paths.restapi.account.extension.answeringrule.Index answeringRule(
            String ruleId) {
        return new com.ringcentral.paths.restapi.account.extension.answeringrule.Index(
                this, ruleId);
    }
    ...
    public com.ringcentral.paths.restapi.account.extension.webappdevices.Index webappDevices() {
        return new com.ringcentral.paths.restapi.account.extension.webappdevices.Index(this);
    }
    ...
    public com.ringcentral.paths.restapi.account.extension.forwardingnumber.Index
            forwardingNumber() {
    ...
    public com.ringcentral.paths.restapi.account.extension.forwardingnumber.Index forwardingNumber(
            String forwardingNumberId) {
        return new com.ringcentral.paths.restapi.account.extension.forwardingnumber.Index(
    ...
    public com.ringcentral.paths.restapi.account.extension.overflowsettings.Index
            overflowSettings() {
        return new com.ringcentral.paths.restapi.account.extension.overflowsettings.Index(this);
    }

    public com.ringcentral.paths.restapi.account.extension.administeredsites.Index
            administeredSites() {
        return new com.ringcentral.paths.restapi.account.extension.administeredsites.Index(this);
    }

    public com.ringcentral.paths.restapi.account.extension.emergencylocations.Index
            emergencyLocations() {
        return this.emergencyLocations(null);
    }

    public com.ringcentral.paths.restapi.account.extension.emergencylocations.Index
            emergencyLocations(String locationId) {
        return new com.ringcentral.paths.restapi.account.extension.emergencylocations.Index(
                this, locationId);
    }

    public com.ringcentral.paths.restapi.account.extension.videoconfiguration.Index
            videoConfiguration() {
        return new com.ringcentral.paths.restapi.account.extension.videoconfiguration.Index(this);
    }

    public com.ringcentral.paths.restapi.account.extension.callqueuepresence.Index
            callQueuePresence() {
        return new com.ringcentral.paths.restapi.account.extension.callqueuepresence.Index(this);
    }

    public com.ringcentral.paths.restapi.account.extension.notificationsettings.Index
            notificationSettings() {
        return new com.ringcentral.paths.restapi.account.extension.notificationsettings.Index(this);
    }

    public com.ringcentral.paths.restapi.account.extension.messagestoretemplates.Index
            messageStoreTemplates() {
        return this.messageStoreTemplates(null);
    }

    public com.ringcentral.paths.restapi.account.extension.messagestoretemplates.Index
            messageStoreTemplates(String templateId) {
        return new com.ringcentral.paths.restapi.account.extension.messagestoretemplates.Index(
                this, templateId);
    }
}

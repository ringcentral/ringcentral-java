...
class Index(val parent: com.ringcentral.paths.restapi.account.Index, val extensionId: String? = "~") {
       ...
       */
      @JvmOverloads fun list(queryParams: com.ringcentral.definitions.ListExtensionsParameters? = null) : com.ringcentral.definitions.GetExtensionListResponse?
      {
        val rb: okhttp3.ResponseBody = rc.get(this.path(false), queryParams)
        
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.GetExtensionListResponse::class.java)
      ...
      fun post(extensionCreationRequest: com.ringcentral.definitions.ExtensionCreationRequest) : com.ringcentral.definitions.ExtensionCreationResponse?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.ExtensionCreationResponse::class.java)
      ...
      fun get() : com.ringcentral.definitions.GetExtensionInfoResponse?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.GetExtensionInfoResponse::class.java)
       ...
       */
      @JvmOverloads fun delete(queryParams: com.ringcentral.definitions.DeleteExtensionParameters? = null) : String?
      {
          if (this.extensionId == null)
          {
              throw NullPointerException("extensionId");
      ...
      @JvmOverloads fun calllog(callRecordId: String? = null) : com.ringcentral.paths.restapi.account.extension.calllog.Index
      {
      ...
      @JvmOverloads fun messagestore(messageId: String? = null) : com.ringcentral.paths.restapi.account.extension.messagestore.Index
      {
      ...
      @JvmOverloads fun ringout(ringoutId: String? = null) : com.ringcentral.paths.restapi.account.extension.ringout.Index
      {
      ...
      @JvmOverloads fun meeting(meetingId: String? = null) : com.ringcentral.paths.restapi.account.extension.meeting.Index
      {
      ...
      @JvmOverloads fun forwardingnumber(forwardingNumberId: String? = null) : com.ringcentral.paths.restapi.account.extension.forwardingnumber.Index
      {
      ...
      @JvmOverloads fun answeringrule(ruleId: String? = null) : com.ringcentral.paths.restapi.account.extension.answeringrule.Index
      {
      ...
      @JvmOverloads fun greeting(greetingId: String? = null) : com.ringcentral.paths.restapi.account.extension.greeting.Index
      {
      ...
      @JvmOverloads fun profileimage(scaleSize: String? = null) : com.ringcentral.paths.restapi.account.extension.profileimage.Index
      {

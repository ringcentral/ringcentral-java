...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/active-calls Rate Limit
     * Group: Heavy App Permission: ReadCallLog User Permission: ReadCallLog
     */
    public CallLogResponse get(ListExtensionActiveCallsParameters queryParams)

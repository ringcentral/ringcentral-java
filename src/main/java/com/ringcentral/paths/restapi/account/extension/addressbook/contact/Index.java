...
public class Index {
    ...
    public Index(
            com.ringcentral.paths.restapi.account.extension.addressbook.Index parent,
            String contactId) {
        this.parent = parent;
        this.rc = parent.rc;
     ...
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/address-book/contact Rate
     * Limit Group: Heavy App Permission: ReadContacts User Permission: ReadPersonalContacts
     */
    public ContactList list(ListContactsParameters queryParams)
     ...
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/address-book/contact Rate
     * Limit Group: Heavy App Permission: Contacts User Permission: EditPersonalContacts
     */
    public PersonalContactResource post(
            PersonalContactRequest personalContactRequest, CreateContactParameters queryParams)
            throws com.ringcentral.RestException, java.io.IOException {
        okhttp3.ResponseBody rb =
                this.rc.post(this.path(false), personalContactRequest, queryParams);
    ...
    /**
     * Returns the user personal contact(s). [Bulk request
     * syntax](https://developers.ringcentral.com/guide/basics/batch-requests) is supported.
     *
     * <p>HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/address-book/contact/{contactId}
     * Rate Limit Group: Heavy App Permission: ReadContacts User Permission: ReadPersonalContacts
     */
    ...
    /**
     * Updates the user personal contact(s) (full resource update). [Bulk request
     * syntax](https://developers.ringcentral.com/guide/basics/batch-requests) is supported.
     *
     * <p>HTTP Method: put Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/address-book/contact/{contactId}
     * Rate Limit Group: Heavy App Permission: Contacts User Permission: EditPersonalContacts
     */
    public PersonalContactResource put(
            PersonalContactRequest personalContactRequest, UpdateContactParameters queryParams)
            throws com.ringcentral.RestException, java.io.IOException {
        if (contactId == null) {
            throw new IllegalArgumentException("Parameter contactId cannot be null");
        }
    ...
    public PersonalContactResource put(PersonalContactRequest personalContactRequest)
            throws com.ringcentral.RestException, java.io.IOException {
        return this.put(personalContactRequest, null);
    }

    /**
     * Deletes the user personal contact(s). [Bulk request
     * syntax](https://developers.ringcentral.com/guide/basics/batch-requests) is supported.
     *
     ...
     * resource update). Omitted attributes will remain unchanged. If any attribute is passed in
     * request body with the null value, then this attribute value will be removed.
     *
     * <p>HTTP Method: patch Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/address-book/contact/{contactId}
     * Rate Limit Group: Heavy App Permission: Contacts User Permission: EditPersonalContacts
     */
    public PersonalContactResource patch(
            PersonalContactRequest personalContactRequest, PatchContactParameters queryParams)
            throws com.ringcentral.RestException, java.io.IOException {
        if (contactId == null) {
            throw new IllegalArgumentException("Parameter contactId cannot be null");
        }

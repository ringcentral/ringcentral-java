...
class Index(val parent: com.ringcentral.paths.restapi.account.extension.Index, val ruleId: String? = null) {
       ...
       */
      @JvmOverloads fun list(queryParams: com.ringcentral.definitions.ListAnsweringRulesParameters? = null) : com.ringcentral.definitions.UserAnsweringRuleList?
      {
      ...
      fun post(createAnsweringRuleRequest: com.ringcentral.definitions.CreateAnsweringRuleRequest) : com.ringcentral.definitions.CustomAnsweringRuleInfo?
      {
        ...
        return com.alibaba.fastjson.JSON.parseObject(rb.string(), com.ringcentral.definitions.CustomAnsweringRuleInfo::class.java)
       ...
       */
      @JvmOverloads fun get(queryParams: com.ringcentral.definitions.ReadAnsweringRuleParameters? = null) : com.ringcentral.definitions.AnsweringRuleInfo?
      {
          if (this.ruleId == null)
          {

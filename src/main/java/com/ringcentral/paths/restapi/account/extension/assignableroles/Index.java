...
public class Index {
    ...
    /**
     * Returns a list of roles which can be assigned to a given extension. HTTP Method: get
     * Endpoint: /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/assignable-roles
     * Rate Limit Group: Medium App Permission: RoleManagement
     */
    public RolesCollectionResource get(ListOfAvailableForAssigningRolesParameters queryParams)

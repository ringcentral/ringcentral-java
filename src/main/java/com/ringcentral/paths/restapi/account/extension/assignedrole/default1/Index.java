...
public class Index {
    ...
    /**
     * Assigns the default role to the currently logged-in user extension. HTTP Method: put
     * Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/assigned-role/default Rate
     * Limit Group: Medium App Permission: RoleManagement User Permission: Users
     */

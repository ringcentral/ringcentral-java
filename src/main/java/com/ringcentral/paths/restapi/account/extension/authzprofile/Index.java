...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/authz-profile Rate Limit
     * Group: Medium
     */
    public AuthProfileResource get(ReadAuthorizationProfileParameters queryParams)

...
public class Index {
    ...
    /**
     * Checks if a certain user permission is activated for a particular extension. HTTP Method: get
     * Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/authz-profile/check Rate
     * Limit Group: Light
     */
    public AuthProfileCheckResource get(CheckUserPermissionParameters queryParams)
    ...
    public AuthProfileCheckResource get()
            throws com.ringcentral.RestException, java.io.IOException {

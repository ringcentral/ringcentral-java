...
class Index(val parent: com.ringcentral.paths.restapi.account.extension.Index) {
      ...
      fun get() : com.ringcentral.definitions.GetUserBusinessHoursResponse?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.GetUserBusinessHoursResponse::class.java)
      ...
      fun put(userBusinessHoursUpdateRequest: com.ringcentral.definitions.UserBusinessHoursUpdateRequest) : com.ringcentral.definitions.UserBusinessHoursUpdateResponse?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.UserBusinessHoursUpdateResponse::class.java)

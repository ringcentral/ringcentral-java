...
class Index(val parent: com.ringcentral.paths.restapi.account.extension.callerblocking.Index, val blockedNumberId: String? = null) {
       ...
       */
      @JvmOverloads fun list(queryParams: com.ringcentral.definitions.ListBlockedAllowedNumbersParameters? = null) : com.ringcentral.definitions.BlockedAllowedPhoneNumbersList?
      {
        val rb: okhttp3.ResponseBody = rc.get(this.path(false), queryParams)
        
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.BlockedAllowedPhoneNumbersList::class.java)
      ...
      fun post(addBlockedAllowedPhoneNumber: com.ringcentral.definitions.AddBlockedAllowedPhoneNumber) : com.ringcentral.definitions.BlockedAllowedPhoneNumberInfo?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.BlockedAllowedPhoneNumberInfo::class.java)

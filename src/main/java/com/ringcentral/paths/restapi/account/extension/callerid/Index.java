...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/caller-id Rate Limit Group:
     * Light App Permission: ReadAccounts User Permission: ReadCallerIDSettings
     */
     ...
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/caller-id Rate Limit Group:
     * Medium App Permission: EditExtensions User Permission: EditCallerIDSettings
     */
    public ExtensionCallerIdInfo put(ExtensionCallerIdInfo extensionCallerIdInfo)

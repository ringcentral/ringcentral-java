...
public class Index {
    ...
    /**
     * Synchronizes the user call log records. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/call-log-sync Rate Limit
     * Group: Heavy App Permission: ReadCallLog User Permission: ReadCallLog
     */
    public CallLogSyncResponse get(SyncUserCallLogParameters queryParams)

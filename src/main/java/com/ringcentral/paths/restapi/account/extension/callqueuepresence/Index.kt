...
class Index(val parent: com.ringcentral.paths.restapi.account.extension.Index) {
       ...
       */
      @JvmOverloads fun get(queryParams: com.ringcentral.definitions.ReadExtensionCallQueuePresenceParameters? = null) : com.ringcentral.definitions.ExtensionCallQueuePresenceList?
      {
        val rb: okhttp3.ResponseBody = rc.get(this.path(), queryParams)
        
        return com.alibaba.fastjson.JSON.parseObject(rb.string(), com.ringcentral.definitions.ExtensionCallQueuePresenceList::class.java)

...
public class Index {
    ...
    /**
     * Creates and sends an internal text message (company pager message). HTTP Method: post
     * Endpoint: /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/company-pager
     * Rate Limit Group: Medium App Permission: InternalMessages User Permission: InternalSMS
     */
    public GetInternalTextMessageInfoResponse post(
        ...
        return com.ringcentral.Utils.gson.fromJson(
                rb.string(), GetInternalTextMessageInfoResponse.class);
    }
}

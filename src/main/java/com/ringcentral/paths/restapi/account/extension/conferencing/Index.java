...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/conferencing Rate Limit
     * Group: Light App Permission: ReadAccounts User Permission: OrganizeConference
     */
    public GetConferencingInfoResponse get(ReadConferencingSettingsParameters queryParams)
    ...
    public GetConferencingInfoResponse get()
            throws com.ringcentral.RestException, java.io.IOException {
     ...
     * from conferencing numbers of the current extension. Updates the setting, allowing
     * participants join the conference before host.
     *
     * <p>HTTP Method: put Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/conferencing Rate Limit
     * Group: Medium App Permission: EditExtensions User Permission: OrganizeConference
     */
    public GetConferencingInfoResponse put(

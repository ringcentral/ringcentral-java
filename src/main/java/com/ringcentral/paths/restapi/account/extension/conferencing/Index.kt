...
class Index(val parent: com.ringcentral.paths.restapi.account.extension.Index) {
       ...
       */
      @JvmOverloads fun get(queryParams: com.ringcentral.definitions.ReadConferencingSettingsParameters? = null) : com.ringcentral.definitions.GetConferencingInfoResponse?
      {
        val rb: okhttp3.ResponseBody = rc.get(this.path(), queryParams)
        
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.GetConferencingInfoResponse::class.java)

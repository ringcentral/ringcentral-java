...
public class Index {
    ...
    /**
     * Returns devices of an extension or multiple extensions by their ID(s). [Bulk request
     * syntax](https://developers.ringcentral.com/guide/basics/batch-requests) is supported.
     *
     * <p>HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/device Rate Limit Group:
     * Light App Permission: ReadAccounts User Permission: ReadUserDevices
     */
    ...
    public GetExtensionDevicesResponse get()
            throws com.ringcentral.RestException, java.io.IOException {

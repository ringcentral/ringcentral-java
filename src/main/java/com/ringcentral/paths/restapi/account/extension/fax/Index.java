...
public class Index {
    ...
    /**
     * Creates and sends/re-sends a fax message. Re-send can be implemented if sending has failed.
     * Fax attachment size (both single and total) is limited to 50Mb.
     *
     * <p>HTTP Method: post Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/fax Rate Limit Group: Heavy
     * App Permission: Faxes User Permission: OutboundFaxes
     */

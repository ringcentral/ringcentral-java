...
public class Index {
    ...
    /**
     * Creates custom greeting for an extension user. HTTP Method: post Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/greeting Rate Limit Group:
     * Heavy App Permission: EditExtensions User Permission: EditUserAnsweringRules
     */
    public CustomUserGreetingInfo post(
    ...
    /**
     * Returns a custom user greeting by ID. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/greeting/{greetingId} Rate
    ...
    public com.ringcentral.paths.restapi.account.extension.greeting.holdmusic.Index holdMusic() {
        return new com.ringcentral.paths.restapi.account.extension.greeting.holdmusic.Index(this);
    }
}

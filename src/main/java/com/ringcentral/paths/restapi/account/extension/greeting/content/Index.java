...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/greeting/{greetingId}/content
     * Rate Limit Group: Heavy App Permission: ReadAccounts
     */
    public byte[] get(ReadGreetingContentParameters queryParams)

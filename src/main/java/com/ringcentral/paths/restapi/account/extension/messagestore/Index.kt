...
class Index(val parent: com.ringcentral.paths.restapi.account.extension.Index, val messageId: String? = null) {
       ...
       */
      @JvmOverloads fun list(queryParams: com.ringcentral.definitions.ListMessagesParameters? = null) : com.ringcentral.definitions.GetMessageList?
      {
       ...
       */
      @JvmOverloads fun delete(queryParams: com.ringcentral.definitions.DeleteMessageParameters? = null) : String?
      {
          if (this.messageId == null)
          {
              throw NullPointerException("messageId");
      ...
      @JvmOverloads fun content(attachmentId: String? = null) : com.ringcentral.paths.restapi.account.extension.messagestore.content.Index
      {

...
public class Index {
    ...
    public Index(
            com.ringcentral.paths.restapi.account.extension.messagestore.Index parent,
            String attachmentId) {
        this.parent = parent;
        this.rc = parent.rc;
    ...
    /**
     * Returns media content of a message attachment. The content is typically an audio file
     * (`audio/mpeg` or `audio/wav`) for voicemails, TIFF or PDF for faxes and image/audio/video for
     * MMS.
     *
     ...
     * Rate Limit Group: Medium App Permission: ReadMessages
     */
    public byte[] get(ReadMessageContentParameters queryParams)

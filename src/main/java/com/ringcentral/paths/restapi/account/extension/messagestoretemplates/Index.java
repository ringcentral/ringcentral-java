...
public class Index {
    ...
    /**
     * Returns a list of user&#039;s personal text message templates. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/message-store-templates
     * Rate Limit Group: Light App Permission: ReadAccounts
     */
    public MessageTemplatesListResponse list(ListUserMessageTemplatesParameters queryParams)
    ...
    /**
     * Creates a user personal text message template. Maximum number of personal templates is 25 per
     * user. Max length of the `body` property is 1000 symbols (2-byte UTF-16 encoded).
     *
    ...
    /**
     * Returns a user personal text message template by ID. HTTP Method: get Endpoint:
    ...
    /**
     * Updates a user personal text message template. HTTP Method: put Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/message-store-templates/{templateId}
     * Rate Limit Group: Medium App Permission: EditExtensions
     */
    ...
    /**
     * Deletes a user personal text message template. HTTP Method: delete Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/message-store-templates/{templateId}
     * Rate Limit Group: Medium App Permission: EditExtensions
     */

...
public class Index {
     ...
     *
     * <p>Knowledge Article: [User Settings - Set Up Message
     * Notifications](https://success.ringcentral.com/articles/RC_Knowledge_Article/9740)
     *
     * <p>HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/notification-settings Rate
    ...
    /**
     * Updates notification settings for the current extension. Knowledge Article: [User Settings -
     * Set Up Message
     * Notifications](https://success.ringcentral.com/articles/RC_Knowledge_Article/9740)
     *
     ...
     */
    public NotificationSettings put(

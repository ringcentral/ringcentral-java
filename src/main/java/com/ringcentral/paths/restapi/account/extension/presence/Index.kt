...
class Index(val parent: com.ringcentral.paths.restapi.account.extension.Index) {
       ...
       */
      @JvmOverloads fun get(queryParams: com.ringcentral.definitions.ReadUserPresenceStatusParameters? = null) : com.ringcentral.definitions.GetPresenceInfo?
      {
        val rb: okhttp3.ResponseBody = rc.get(this.path(), queryParams)
        
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.GetPresenceInfo::class.java)
      ...
      fun put(presenceInfoResource: com.ringcentral.definitions.PresenceInfoResource) : com.ringcentral.definitions.PresenceInfoResource?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.PresenceInfoResource::class.java)

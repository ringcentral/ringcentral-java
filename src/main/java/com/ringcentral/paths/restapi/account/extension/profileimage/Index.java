...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/profile-image Rate Limit
     ...
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/profile-image Rate Limit
     * Group: Heavy App Permission: EditExtensions User Permission: EditUserInfo
     */
    public String post(CreateUserProfileImageRequest createUserProfileImageRequest)
     ...
     * Group: Heavy App Permission: EditExtensions User Permission: EditUserInfo
     */
    public String put(UpdateUserProfileImageRequest updateUserProfileImageRequest)
            throws com.ringcentral.RestException, java.io.IOException {
        okhttp3.ResponseBody rb =
                this.rc.put(
                        this.path(false),
     ...
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/profile-image Rate Limit
     * Group: Medium App Permission: EditExtensions User Permission: EditUserInfo
     */
     ...
     *
     * <p>HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/profile-image/{scaleSize}
     * Rate Limit Group: Medium App Permission: ReadAccounts
     */
    public byte[] get(ReadScaledProfileImageParameters queryParams)
            throws com.ringcentral.RestException, java.io.IOException {
        if (scaleSize == null) {

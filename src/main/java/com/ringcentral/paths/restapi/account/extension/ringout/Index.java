...
public class Index {
    ...
    /**
     * Makes a 2-legged RingOut call. HTTP Method: post Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/ring-out Rate Limit Group:
     * Heavy App Permission: RingOut
     */
    public GetRingOutStatusResponse post(MakeRingOutRequest makeRingOutRequest)
    ...
    /**
     * Returns a status of a 2-legged RingOut call. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/ring-out/{ringoutId} Rate
     * Limit Group: Light App Permission: RingOut
     */
    public GetRingOutStatusResponse get()
            throws com.ringcentral.RestException, java.io.IOException {
        if (ringoutId == null) {
    ...
    /**
     * Cancels a 2-legged RingOut call. HTTP Method: delete Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/ring-out/{ringoutId} Rate
     * Limit Group: Heavy App Permission: RingOut
     */

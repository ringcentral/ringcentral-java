...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/extension/{extensionId}/video-configuration Rate
     * Limit Group: Light App Permission: ReadAccounts User Permission: Meetings
     */

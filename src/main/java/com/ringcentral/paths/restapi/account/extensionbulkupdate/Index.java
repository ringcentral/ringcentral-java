...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/extension-bulk-update Rate Limit Group: Heavy App
     * Permission: EditExtensions User Permission: EditExtensionInfo
     */
    public ExtensionBulkUpdateTaskResource post(
    ...
    public com.ringcentral.paths.restapi.account.extensionbulkupdate.tasks.Index tasks(
            String taskId) {
        return new com.ringcentral.paths.restapi.account.extensionbulkupdate.tasks.Index(
                this, taskId);
    }
}

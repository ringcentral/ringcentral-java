...
public class Index {
    ...
    public Index(
            com.ringcentral.paths.restapi.account.extensionbulkupdate.Index parent, String taskId) {
        this.parent = parent;
        this.rc = parent.rc;
        this.taskId = taskId;
    }
     ...
     * /restapi/{apiVersion}/account/{accountId}/extension-bulk-update/tasks/{taskId} Rate Limit
     * Group: Light App Permission: EditExtensions User Permission: EditExtensionInfo
     */
    public ExtensionBulkUpdateTaskResource get()
        ...
        return com.ringcentral.Utils.gson.fromJson(
                rb.string(), ExtensionBulkUpdateTaskResource.class);
    }
}

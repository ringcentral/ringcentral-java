...
public class Index {
    ...
    /**
     * Creates a custom company greeting. HTTP Method: post Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/greeting Rate Limit Group: Medium App Permission:
     * EditAccounts User Permission: ReadUserInfo
     */
    public CustomCompanyGreetingInfo post(CreateCompanyGreetingRequest createCompanyGreetingRequest)

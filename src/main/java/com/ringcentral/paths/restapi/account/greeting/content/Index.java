...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/greeting/{greetingId}/content Rate Limit Group:
     * Heavy App Permission: ReadAccounts
     */
    public byte[] get(ReadAccountGreetingContentParameters queryParams)

...
public class Index {
    ...
    /**
     * Returns the list of IVR prompts. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/ivr-prompts Rate Limit Group: Medium App
     * Permission: ReadAccounts User Permission: ReadCompanyGreetings
     */
    ...
    /**
     * Creates an IVR prompt. HTTP Method: post Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/ivr-prompts Rate Limit Group: Heavy App Permission:
     * EditAccounts User Permission: EditCompanyGreetings
     */
    public PromptInfo post(CreateIVRPromptRequest createIVRPromptRequest)
    ...
    /**
     * Returns an IVR prompt by ID. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/ivr-prompts/{promptId} Rate Limit Group: Medium App
     * Permission: ReadAccounts User Permission: ReadCompanyGreetings
     */
    ...
    /**
     * Updates an IVR prompt by ID HTTP Method: put Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/ivr-prompts/{promptId} Rate Limit Group: Medium App
     * Permission: EditAccounts User Permission: EditCompanyGreetings
     */
    public PromptInfo put(UpdateIVRPromptRequest updateIVRPromptRequest)
            throws com.ringcentral.RestException, java.io.IOException {
        if (promptId == null) {
            throw new IllegalArgumentException("Parameter promptId cannot be null");
        }
    ...
    /**
     * Deletes an IVR prompt by ID. HTTP Method: delete Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/ivr-prompts/{promptId} Rate Limit Group: Heavy App
     * Permission: EditAccounts User Permission: EditCompanyGreetings
     */

...
public class Index {
    ...
    /**
     * Returns message store settings. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/message-store-configuration Rate Limit Group: Light
     * App Permission: EditAccounts User Permission: AccountAdministration
     */
    public MessageStoreConfiguration get()
    ...
    /**
     * Updates message store settings. HTTP Method: put Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/message-store-configuration Rate Limit Group: Light
     * App Permission: EditAccounts User Permission: AccountAdministration
     */
    public MessageStoreConfiguration put(MessageStoreConfiguration messageStoreConfiguration)
            throws com.ringcentral.RestException, java.io.IOException {

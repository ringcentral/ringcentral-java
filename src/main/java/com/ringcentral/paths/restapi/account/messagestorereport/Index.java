...
public class Index {
     ...
     * number of simultaneous tasks per account is 2.
     *
     * <p>HTTP Method: post Endpoint: /restapi/{apiVersion}/account/{accountId}/message-store-report
     * Rate Limit Group: Heavy App Permission: ReadMessages User Permission: Users
     */
    public MessageStoreReport post(CreateMessageStoreReportRequest createMessageStoreReportRequest)
        ...
        okhttp3.ResponseBody rb =
                this.rc.post(this.path(false), createMessageStoreReportRequest, null);
        return com.ringcentral.Utils.gson.fromJson(rb.string(), MessageStoreReport.class);
    }

    /**
     * Returns the current status of a task on report creation. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/message-store-report/{taskId} Rate Limit Group:
     * Heavy App Permission: ReadMessages User Permission: Users
     */

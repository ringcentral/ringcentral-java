...
public class Index {
    ...
    /**
     * Returns a list of company text message templates. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/message-store-templates Rate Limit Group: Light App
     * Permission: ReadAccounts
     */
    public MessageTemplatesListResponse list(ListCompanyMessageTemplatesParameters queryParams)
    ...
    public MessageTemplatesListResponse list()
            throws com.ringcentral.RestException, java.io.IOException {
        return this.list(null);
    }

    /**
     * Creates a new text message template on a company level. Maximum number of company templates
     * is 50. HTTP Method: post Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/message-store-templates Rate Limit Group: Medium
     * App Permission: EditAccounts
     */
    public MessageTemplateResponse post(MessageTemplateRequest messageTemplateRequest)
            throws com.ringcentral.RestException, java.io.IOException {
    ...
    /**
     * Returns a company text message template by ID. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/message-store-templates/{templateId} Rate Limit
    ...
    /**
     * Updates a company text message template. HTTP Method: put Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/message-store-templates/{templateId} Rate Limit
     * Group: Medium App Permission: EditAccounts
     */
    ...
    /**
     * Deletes a company text message template. HTTP Method: delete Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/message-store-templates/{templateId} Rate Limit
     * Group: Medium App Permission: EditAccounts
     */

...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/paging-only-groups/{pagingOnlyGroupId}/bulk-assign
     * Rate Limit Group: Heavy App Permission: EditAccounts User Permission: Groups
     */
    public String post(EditPagingGroupRequest editPagingGroupRequest)

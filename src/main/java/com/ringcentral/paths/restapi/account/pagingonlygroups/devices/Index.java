...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/paging-only-groups/{pagingOnlyGroupId}/devices Rate
     * Limit Group: Light App Permission: ReadAccounts User Permission: ReadCompanyDevices
     */
    public PagingOnlyGroupDevices get(ListPagingGroupDevicesParameters queryParams)

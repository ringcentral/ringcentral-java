...
public class Index {
     ...
     * company-level and extension-level numbers are returned.
     *
     * <p>HTTP Method: get Endpoint: /restapi/{apiVersion}/account/{accountId}/phone-number Rate
     * Limit Group: Heavy App Permission: ReadAccounts User Permission: ReadCompanyPhoneNumbers
     */
    public AccountPhoneNumbers list(ListAccountPhoneNumbersParameters queryParams)
     ...
     * [Bulk request syntax](https://developers.ringcentral.com/guide/basics/batch-requests) is
     * supported.
     *
     * <p>HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/phone-number/{phoneNumberId} Rate Limit Group:
     * Light App Permission: ReadAccounts User Permission: ReadCompanyPhoneNumbers
     */

...
public class Index {
    ...
    /**
     * Returns call recordings by ID(s). HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/recording/{recordingId} Rate Limit Group: Heavy App
     * Permission: ReadCallRecording User Permission: ReadCallRecording
     */
    public GetCallRecordingResponse get()

...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/recording/{recordingId}/content Rate Limit Group:
     * Heavy App Permission: ReadCallRecording
     */
    public byte[] get(ReadCallRecordingContentParameters queryParams)

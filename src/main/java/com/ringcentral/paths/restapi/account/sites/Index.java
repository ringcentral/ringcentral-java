...
public class Index {
     ...
     *
     * <p>HTTP Method: get Endpoint: /restapi/{apiVersion}/account/{accountId}/sites Rate Limit
     * Group: Light App Permission: ReadAccounts User Permission: ReadExtensions
     */
     ...
     *
     * <p>HTTP Method: post Endpoint: /restapi/{apiVersion}/account/{accountId}/sites Rate Limit
     * Group: Medium App Permission: EditAccounts
     */
    public SiteInfo post(CreateSiteRequest createSiteRequest)
     ...
     *
     * <p>HTTP Method: get Endpoint: /restapi/{apiVersion}/account/{accountId}/sites/{siteId} Rate
     * Limit Group: Light App Permission: ReadAccounts User Permission: ReadExtensions
     */
     ...
     *
     * <p>HTTP Method: put Endpoint: /restapi/{apiVersion}/account/{accountId}/sites/{siteId} Rate
     * Limit Group: Light App Permission: EditExtensions User Permission: Sites
     */
    public SiteInfo put(SiteUpdateRequest siteUpdateRequest)
            throws com.ringcentral.RestException, java.io.IOException {
        if (siteId == null) {
            throw new IllegalArgumentException("Parameter siteId cannot be null");
        }
     ...
     *
     * <p>HTTP Method: delete Endpoint: /restapi/{apiVersion}/account/{accountId}/sites/{siteId}
     * Rate Limit Group: Light App Permission: EditAccounts User Permission: Sites
     */

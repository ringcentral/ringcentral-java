...
public class Index {
     ...
     * /restapi/{apiVersion}/account/{accountId}/sites/{siteId}/bulk-assign Rate Limit Group: Medium
     * App Permission: EditExtensions User Permission: Sites
     */
    public String post(SiteMembersBulkUpdate siteMembersBulkUpdate)

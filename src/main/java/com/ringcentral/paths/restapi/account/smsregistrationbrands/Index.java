...
this.tcrBrandId = tcrBrandId;
  ...
  public com.ringcentral.paths.restapi.account.smsregistrationbrands.campaigns.Index campaigns(String tcrCampaignId)
  {
    return new com.ringcentral.paths.restapi.account.smsregistrationbrands.campaigns.Index(this, tcrCampaignId);
  }

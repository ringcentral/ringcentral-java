...
public Index(com.ringcentral.paths.restapi.account.smsregistrationbrands.Index parent, String tcrCampaignId)
      {
this.parent = parent;
this.rc = parent.rc;
this.tcrCampaignId = tcrCampaignId;
  ...
  public TcrCampaignRecord get() throws com.ringcentral.RestException, java.io.IOException
  {
    ...
    public com.ringcentral.paths.restapi.account.smsregistrationbrands.campaigns.submitphonenumbers.Index submitPhoneNumbers()
  {
    return new com.ringcentral.paths.restapi.account.smsregistrationbrands.campaigns.submitphonenumbers.Index(this);
  }

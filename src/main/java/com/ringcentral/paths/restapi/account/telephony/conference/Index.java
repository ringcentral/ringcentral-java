...
public class Index {
    ...
    /**
     * Initiates a conference call session. HTTP Method: post Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/telephony/conference Rate Limit Group: Heavy App
     * Permission: CallControl
     */

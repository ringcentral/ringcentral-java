...
public class Index {
    ...
    public Index(
            com.ringcentral.paths.restapi.account.telephony.Index parent,
    ...
    /**
     * Returns the status of a call session by ID. HTTP Method: get Endpoint:
    ...
    /**
     * Drops a call session. HTTP Method: delete Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/telephony/sessions/{telephonySessionId} Rate Limit
     * Group: Light App Permission: CallControl
     */
    ...
    public com.ringcentral.paths.restapi.account.telephony.sessions.parties.Index parties(
            String partyId) {
        return new com.ringcentral.paths.restapi.account.telephony.sessions.parties.Index(
                this, partyId);
    }

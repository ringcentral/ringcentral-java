...
class Index(val parent: com.ringcentral.paths.restapi.account.telephony.sessions.Index, val partyId: String? = null) {
      ...
      fun play() : com.ringcentral.paths.restapi.account.telephony.sessions.parties.play.Index
      {
        return com.ringcentral.paths.restapi.account.telephony.sessions.parties.play.Index(this)
      }

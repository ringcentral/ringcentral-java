...
class Index(val parent: com.ringcentral.paths.restapi.account.telephony.sessions.Index, val partyId: String? = null) {
    ...
    fun bridge(): com.ringcentral.paths.restapi.account.telephony.sessions.parties.bridge.Index {
        return com.ringcentral.paths.restapi.account.telephony.sessions.parties.bridge.Index(this)
    }

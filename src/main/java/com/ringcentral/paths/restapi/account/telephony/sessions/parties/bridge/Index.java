...
public class Index {
     ...
     * The current active call session ID and party ID of the user within this session should be
     * specified in path; the bridged call session ID and party ID of the user within that session
     * should be specified in request body. Thus, the user connects participants of two sessions
     * into the one conference call using his/her own party IDs from both sessions.&quot;
     *
     ...
     */
    public CallParty post(BridgeTargetRequest bridgeTargetRequest)

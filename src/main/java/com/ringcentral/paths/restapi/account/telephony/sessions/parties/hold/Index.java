...
public class Index {
     ...
     * &amp; state to peers. There is a known limitation for Hold API - hold via REST API
     * doesn&#039;t work with hold placed via RingCentral apps or HardPhone. It means that if you
     * muted participant via Call Control API and RingCentral Desktop app, then you need to un-hold
     * both endpoints to remove Hold Music and bring media back. HTTP Method: post Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/telephony/sessions/{telephonySessionId}/parties/{partyId}/hold
     * Rate Limit Group: Light App Permission: CallControl
     */
    public CallParty post(HoldCallPartyRequest holdCallPartyRequest)

...
public class Index {
    ...
    public Index(
            com.ringcentral.paths.restapi.account.telephony.sessions.parties.Index parent,
            String recordingId) {
        this.parent = parent;
        this.rc = parent.rc;
    ...
    /**
     * Starts a new call recording for a call party. *Please note* this API does not allow
     * conference calls to be recorded.
     *
    ...
    /**
     * Pause/resume recording HTTP Method: patch Endpoint:

...
public class Index {
    ...
    /**
     * Replies with text/pattern without picking up a call. HTTP Method: post Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/telephony/sessions/{telephonySessionId}/parties/{partyId}/reply
     * Rate Limit Group: Light App Permission: CallControl
     */
    public ReplyParty post(CallPartyReply callPartyReply)

...
public class Index {
     ...
     * Hold API - hold via REST API doesn&#039;t work with hold placed via RingCentral apps or
     * HardPhone. It means that if you muted participant via Call Control API and RingCentral
     * Desktop app, then you need to un-hold both endpoints to remove Hold Music and bring media
     * back. HTTP Method: post Endpoint:

...
public class Index {
     ...
     *
     * <p>HTTP Method: get Endpoint: /restapi/{apiVersion}/account/{accountId}/templates Rate Limit
     * Group: Medium App Permission: ReadAccounts User Permission: ReadCompanyInfo
     */
    public UserTemplates list(ListUserTemplatesParameters queryParams)
     ...
     * /restapi/{apiVersion}/account/{accountId}/templates/{templateId} Rate Limit Group: Light App

...
class Index(val parent: com.ringcentral.paths.restapi.account.Index, val templateId: String? = null) {
      ...
      @JvmOverloads fun list(queryParams: com.ringcentral.definitions.ListUserTemplatesParameters? = null) : com.ringcentral.definitions.UserTemplates?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.UserTemplates::class.java)
      ...
      fun get() : com.ringcentral.definitions.TemplateInfo?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.TemplateInfo::class.java)

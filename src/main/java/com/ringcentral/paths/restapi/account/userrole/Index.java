...
public class Index {
    ...
    /**
     * Returns a list of account user roles. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/user-role Rate Limit Group: Medium App Permission:
     * ReadAccounts User Permission: ReadUserRoles
     */
    public RolesCollectionResource list(ListUserRolesParameters queryParams)
    ...
    public RolesCollectionResource list()
            throws com.ringcentral.RestException, java.io.IOException {
        return this.list(null);
    }

    /**
     * Creates a custom user role. HTTP Method: post Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/user-role Rate Limit Group: Medium App Permission:
    ...
    /**
     * Returns a user role assigned to the current account. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/user-role/{roleId} Rate Limit Group: Light App
     * Permission: ReadAccounts User Permission: ReadUserRoles
     */
    public RoleResource get(ReadUserRoleParameters queryParams)
            throws com.ringcentral.RestException, java.io.IOException {
        if (roleId == null) {
    ...
    /**
     * Updates a user role assigned to the current account by ID. HTTP Method: put Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/user-role/{roleId} Rate Limit Group: Medium App
     * Permission: RoleManagement User Permission: EditUserRoles
     */
    public RoleResource put(RoleResource roleResource, UpdateUserRoleParameters queryParams)
            throws com.ringcentral.RestException, java.io.IOException {
        if (roleId == null) {
            throw new IllegalArgumentException("Parameter roleId cannot be null");
        }
    ...
    public RoleResource put(RoleResource roleResource)
            throws com.ringcentral.RestException, java.io.IOException {
        return this.put(roleResource, null);
    }

    /**
     * Deletes a custom user role by ID. HTTP Method: delete Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/user-role/{roleId} Rate Limit Group: Medium App
     * Permission: RoleManagement User Permission: EditUserRoles
     */
    public String delete(DeleteCustomRoleParameters queryParams)
            throws com.ringcentral.RestException, java.io.IOException {
        if (roleId == null) {
            throw new IllegalArgumentException("Parameter roleId cannot be null");
        }

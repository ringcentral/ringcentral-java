...
public class Index {
    ...
    /**
     * Assigns multiple user roles. HTTP Method: post Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/user-role/{roleId}/bulk-assign Rate Limit Group:
     * Heavy App Permission: RoleManagement User Permission: EditUserRoles
     */
    public String post(BulkRoleAssignResource bulkRoleAssignResource)

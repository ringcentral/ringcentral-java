...
public class Index {
    ...
    /**
     * Returns the default user role of the current account. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/user-role/default Rate Limit Group: Light App
     * Permission: RoleManagement User Permission: Roles
     */
    ...
    /**
     * Updates the account default user role. HTTP Method: put Endpoint:
     * /restapi/{apiVersion}/account/{accountId}/user-role/default Rate Limit Group: Medium App
     * Permission: RoleManagement User Permission: Roles
     */
    public DefaultUserRole put(DefaultUserRoleRequest defaultUserRoleRequest)

...
public class Index {
     ...
     *
     * <p>HTTP Method: post Endpoint: /restapi/{apiVersion}/client-info/sip-provision Rate Limit
     * Group: Heavy App Permission: VoipCalling
     */
    public CreateSipRegistrationResponse post(
        ...
        return com.ringcentral.Utils.gson.fromJson(
                rb.string(), CreateSipRegistrationResponse.class);
    }
}

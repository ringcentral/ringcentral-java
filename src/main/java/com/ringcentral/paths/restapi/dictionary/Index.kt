...
class Index(val parent: com.ringcentral.paths.restapi.Index) {
      ...
      @JvmOverloads fun greeting(greetingId: String? = null) : com.ringcentral.paths.restapi.dictionary.greeting.Index
      {
      ...
      @JvmOverloads fun country(countryId: String? = null) : com.ringcentral.paths.restapi.dictionary.country.Index
      {
      ...
      @JvmOverloads fun state(stateId: String? = null) : com.ringcentral.paths.restapi.dictionary.state.Index
      {
      ...
      @JvmOverloads fun timezone(timezoneId: String? = null) : com.ringcentral.paths.restapi.dictionary.timezone.Index
      {

...
public class Index {
    ...
    public com.ringcentral.paths.restapi.dictionary.brand.contractedcountry.Index
            contractedCountry() {
    ...
    public com.ringcentral.paths.restapi.dictionary.brand.contractedcountry.Index contractedCountry(
        ...
        return new com.ringcentral.paths.restapi.dictionary.brand.contractedcountry.Index(

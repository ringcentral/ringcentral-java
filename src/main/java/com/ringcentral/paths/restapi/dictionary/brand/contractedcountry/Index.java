...
public class Index {
    ...
    public Index(
            com.ringcentral.paths.restapi.dictionary.brand.Index parent,
            String contractedCountryId) {
        this.parent = parent;
        this.rc = parent.rc;
    ...
    /**
     * Returns the list of contracted countries for the given brand. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/dictionary/brand/{brandId}/contracted-country Rate Limit Group: Light
     */
    public ContractedCountryListResponse list()
            throws com.ringcentral.RestException, java.io.IOException {
        okhttp3.ResponseBody rb = this.rc.get(this.path(false), null);
        return com.ringcentral.Utils.gson.fromJson(
                rb.string(), ContractedCountryListResponse.class);
    }
     ...
     * /restapi/{apiVersion}/dictionary/brand/{brandId}/contracted-country/{contractedCountryId}
     * Rate Limit Group: Light
     */
    public CountryListDictionaryModel get(ListDomesticCountriesParameters queryParams)
            throws com.ringcentral.RestException, java.io.IOException {
    ...
    public CountryListDictionaryModel get()
            throws com.ringcentral.RestException, java.io.IOException {

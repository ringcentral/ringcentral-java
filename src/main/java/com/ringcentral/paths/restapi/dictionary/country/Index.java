...
public class Index {
     ...
     *
     * <p>HTTP Method: get Endpoint: /restapi/{apiVersion}/dictionary/country Rate Limit Group:
     * Light
     */
    public CountryListDictionaryModel list(ListCountriesParameters queryParams)
    ...
    public CountryListDictionaryModel list()
            throws com.ringcentral.RestException, java.io.IOException {
     ...
     *
     * <p>HTTP Method: get Endpoint: /restapi/{apiVersion}/dictionary/country/{countryId} Rate Limit
     * Group: Light
     */
    public CountryInfoDictionaryModel get()
            throws com.ringcentral.RestException, java.io.IOException {
        if (countryId == null) {

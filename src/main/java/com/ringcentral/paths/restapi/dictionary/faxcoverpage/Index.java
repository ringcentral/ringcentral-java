...
public class Index {
    ...
    /**
     * Returns fax cover pages available for the current extension. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/dictionary/fax-cover-page Rate Limit Group: Light
     */
    public ListFaxCoverPagesResponse get(ListFaxCoverPagesParameters queryParams)
    ...
    public ListFaxCoverPagesResponse get()
            throws com.ringcentral.RestException, java.io.IOException {

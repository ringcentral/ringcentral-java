...
public class Index {
     ...
     *
     * <p>HTTP Method: get Endpoint: /restapi/{apiVersion}/dictionary/greeting Rate Limit Group:
     * Medium
     */
    public DictionaryGreetingList list(ListStandardGreetingsParameters queryParams)
    ...
    /**
     * Returns a standard greeting by ID. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/dictionary/greeting/{greetingId} Rate Limit Group: Medium
     */

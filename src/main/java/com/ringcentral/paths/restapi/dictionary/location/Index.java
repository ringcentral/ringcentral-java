...
public class Index {
     ...
     *
     * <p>HTTP Method: get Endpoint: /restapi/{apiVersion}/dictionary/location Rate Limit Group:
     * Light
     */
    public GetLocationListResponse get(ListLocationsParameters queryParams)

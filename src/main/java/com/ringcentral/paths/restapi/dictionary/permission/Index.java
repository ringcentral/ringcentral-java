...
public class Index {
    ...
    /**
     * Returns a list of extension user permissions. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/dictionary/permission Rate Limit Group: Light
     */
    public PermissionCollectionResource list(ListPermissionsParameters queryParams)
    ...
    public PermissionCollectionResource list()
            throws com.ringcentral.RestException, java.io.IOException {
        return this.list(null);
    }

    /**
     * Returns a user permission by ID. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/dictionary/permission/{permissionId} Rate Limit Group: Light
     */
    public PermissionResource get(ReadPermissionParameters queryParams)
            throws com.ringcentral.RestException, java.io.IOException {

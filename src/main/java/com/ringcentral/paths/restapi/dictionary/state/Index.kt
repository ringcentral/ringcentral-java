...
class Index(val parent: com.ringcentral.paths.restapi.dictionary.Index, val stateId: String? = null) {
       ...
       */
      @JvmOverloads fun list(queryParams: com.ringcentral.definitions.ListStatesParameters? = null) : com.ringcentral.definitions.GetStateListResponse?
      {
        val rb: okhttp3.ResponseBody = rc.get(this.path(false), queryParams)
        
        return com.ringcentral.Utils.gson.fromJson(rb.string(), com.ringcentral.definitions.GetStateListResponse::class.java)
      ...
      fun get() : com.ringcentral.definitions.GetStateInfoResponse?
      {
        ...
        return com.ringcentral.Utils.gson.fromJson(rb.string(), com.ringcentral.definitions.GetStateInfoResponse::class.java)

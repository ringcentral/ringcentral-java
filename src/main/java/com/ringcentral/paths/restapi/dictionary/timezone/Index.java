...
public class Index {
     ...
     *
     * <p>HTTP Method: get Endpoint: /restapi/{apiVersion}/dictionary/timezone Rate Limit Group:
     * Light
     */
    public GetTimezoneListResponse list(ListTimezonesParameters queryParams)
    ...
    public GetTimezoneListResponse list()
            throws com.ringcentral.RestException, java.io.IOException {
     ...
     *
     * <p>HTTP Method: get Endpoint: /restapi/{apiVersion}/dictionary/timezone/{timezoneId} Rate
     * Limit Group: Light
     */

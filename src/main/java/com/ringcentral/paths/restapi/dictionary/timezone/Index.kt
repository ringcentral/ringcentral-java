...
class Index(val parent: com.ringcentral.paths.restapi.dictionary.Index, val timezoneId: String? = null) {
       ...
       */
      @JvmOverloads fun list(queryParams: com.ringcentral.definitions.ListTimezonesParameters? = null) : com.ringcentral.definitions.GetTimezoneListResponse?
      {
       ...
       */
      @JvmOverloads fun get(queryParams: com.ringcentral.definitions.ReadTimezoneParameters? = null) : com.ringcentral.definitions.GetTimezoneInfoResponse?
      {

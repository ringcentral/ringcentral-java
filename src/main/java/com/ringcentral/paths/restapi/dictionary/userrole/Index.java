...
public class Index {
    ...
    /**
     * Returns a list of standard user roles. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/dictionary/user-role Rate Limit Group: Light
     */
    public RolesCollectionResource list(ListStandardUserRoleParameters queryParams)
    ...
    /**
     * Returns a standard user role by ID. HTTP Method: get Endpoint:
     * /restapi/{apiVersion}/dictionary/user-role/{roleId} Rate Limit Group: Light
     */

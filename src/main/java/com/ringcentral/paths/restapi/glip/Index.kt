...
class Index(val parent: com.ringcentral.paths.restapi.Index) {
      ...
      @JvmOverloads fun chats(chatId: String? = null) : com.ringcentral.paths.restapi.glip.chats.Index
      {
      ...
      @JvmOverloads fun conversations(chatId: String? = null) : com.ringcentral.paths.restapi.glip.conversations.Index
      {
      ...
      @JvmOverloads fun teams(chatId: String? = null) : com.ringcentral.paths.restapi.glip.teams.Index
      {
      ...
      @JvmOverloads fun groups(groupId: String? = null) : com.ringcentral.paths.restapi.glip.groups.Index
      {
      ...
      @JvmOverloads fun cards(cardId: String? = null) : com.ringcentral.paths.restapi.glip.cards.Index
      {
      ...
      @JvmOverloads fun events(eventId: String? = null) : com.ringcentral.paths.restapi.glip.events.Index
      {
      ...
      @JvmOverloads fun notes(noteId: String? = null) : com.ringcentral.paths.restapi.glip.notes.Index
      {
        return com.ringcentral.paths.restapi.glip.notes.Index(this, noteId)
      }
    


      @JvmOverloads fun tasks(taskId: String? = null) : com.ringcentral.paths.restapi.glip.tasks.Index
      {
        return com.ringcentral.paths.restapi.glip.tasks.Index(this, taskId)
      }
    


      @JvmOverloads fun persons(personId: String? = null) : com.ringcentral.paths.restapi.glip.persons.Index
      {
      ...
      @JvmOverloads fun companies(companyId: String? = null) : com.ringcentral.paths.restapi.glip.companies.Index
      {
      ...
      @JvmOverloads fun webhooks(webhookId: String? = null) : com.ringcentral.paths.restapi.glip.webhooks.Index
      {
      ...
      @JvmOverloads fun dataexport(taskId: String? = null) : com.ringcentral.paths.restapi.glip.dataexport.Index
      {

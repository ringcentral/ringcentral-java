...
class Index(val parent: com.ringcentral.paths.restapi.Index) {
    ...
    @JvmOverloads
    fun notes(noteId: String? = null): com.ringcentral.paths.restapi.glip.notes.Index {
        return com.ringcentral.paths.restapi.glip.notes.Index(this, noteId)
    }


    @JvmOverloads
    fun tasks(taskId: String? = null): com.ringcentral.paths.restapi.glip.tasks.Index {

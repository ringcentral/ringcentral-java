...
class Index(val parent: com.ringcentral.paths.restapi.glip.Index, val cardId: String? = null) {
       ...
       */
      @JvmOverloads fun post(glipMessageAttachmentInfoRequest: com.ringcentral.definitions.GlipMessageAttachmentInfoRequest, queryParams: com.ringcentral.definitions.CreateGlipCardParameters? = null) : com.ringcentral.definitions.GlipMessageAttachmentInfo?
      {
        val rb: okhttp3.ResponseBody = rc.post(this.path(false), glipMessageAttachmentInfoRequest, queryParams)
        
        return com.ringcentral.Utils.gson.fromJson(rb.string(), com.ringcentral.definitions.GlipMessageAttachmentInfo::class.java)

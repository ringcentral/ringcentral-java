...
class Index(val parent: com.ringcentral.paths.restapi.glip.Index, val chatId: String? = null) {
       ...
       */
      @JvmOverloads fun list(queryParams: com.ringcentral.definitions.ListGlipChatsParameters? = null) : com.ringcentral.definitions.GlipChatsList?
      {
        val rb: okhttp3.ResponseBody = rc.get(this.path(false), queryParams)
        
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.GlipChatsList::class.java)
      ...
      fun get() : com.ringcentral.definitions.GlipChatInfo?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.GlipChatInfo::class.java)
      ...
      @JvmOverloads fun posts(postId: String? = null) : com.ringcentral.paths.restapi.glip.chats.posts.Index
      {

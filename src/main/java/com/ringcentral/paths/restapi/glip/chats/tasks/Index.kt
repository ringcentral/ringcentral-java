...
class Index(val parent: com.ringcentral.paths.restapi.glip.chats.Index) {
      ...
      @JvmOverloads fun get(queryParams: com.ringcentral.definitions.ListChatTasksParameters? = null) : com.ringcentral.definitions.GlipTaskList?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.GlipTaskList::class.java)
      ...
      fun post(glipCreateTask: com.ringcentral.definitions.GlipCreateTask) : com.ringcentral.definitions.GlipTaskInfo?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.GlipTaskInfo::class.java)

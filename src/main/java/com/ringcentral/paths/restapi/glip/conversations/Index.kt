...
class Index(val parent: com.ringcentral.paths.restapi.glip.Index, val chatId: String? = null) {
       ...
       */
      @JvmOverloads fun list(queryParams: com.ringcentral.definitions.ListGlipConversationsParameters? = null) : com.ringcentral.definitions.GlipConversationsList?
      {
        val rb: okhttp3.ResponseBody = rc.get(this.path(false), queryParams)
        
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.GlipConversationsList::class.java)
      ...
      fun post(createGlipConversationRequest: com.ringcentral.definitions.CreateGlipConversationRequest) : com.ringcentral.definitions.GlipConversationInfo?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.GlipConversationInfo::class.java)

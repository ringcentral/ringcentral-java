...
class Index(val parent: com.ringcentral.paths.restapi.glip.Index, val eventId: String? = null) {
       ...
       */
      @JvmOverloads fun list(queryParams: com.ringcentral.definitions.ReadGlipEventsParameters? = null) : com.ringcentral.definitions.GlipEventsInfo?
      {
        val rb: okhttp3.ResponseBody = rc.get(this.path(false), queryParams)
        
        return com.ringcentral.Utils.gson.fromJson(rb.string(), com.ringcentral.definitions.GlipEventsInfo::class.java)
      ...
      fun post(glipEventCreate: com.ringcentral.definitions.GlipEventCreate) : com.ringcentral.definitions.GlipEventInfo?
      {
        ...
        return com.ringcentral.Utils.gson.fromJson(rb.string(), com.ringcentral.definitions.GlipEventInfo::class.java)

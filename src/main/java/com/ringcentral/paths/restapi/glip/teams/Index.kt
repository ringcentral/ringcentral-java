...
class Index(val parent: com.ringcentral.paths.restapi.glip.Index, val chatId: String? = null) {
       ...
       */
      @JvmOverloads fun list(queryParams: com.ringcentral.definitions.ListGlipTeamsParameters? = null) : com.ringcentral.definitions.GlipTeamsList?
      {
        val rb: okhttp3.ResponseBody = rc.get(this.path(false), queryParams)
        
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.GlipTeamsList::class.java)
      ...
      fun post(glipPostTeamBody: com.ringcentral.definitions.GlipPostTeamBody) : com.ringcentral.definitions.GlipTeamInfo?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.GlipTeamInfo::class.java)

...
public class Index {
     ...
     * (e.g. OpenID Connect ID Token) issued by the Authorization Server (see
     * [RFC-7517](https://www.rfc-editor.org/rfc/rfc7517.html#section-5))
     *
     * <p>HTTP Method: get Endpoint: /restapi/oauth/jwks Rate Limit Group: NoThrottling
     */

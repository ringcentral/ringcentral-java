...
public class Index {
    ...
    /**
     * Returns a special short lived token to authorize a dedicated web socket connection between
     * this client and a backend.
     *
     * <p>This API needs to be called if a client plans to use &quot;Websocket&quot; transport to
     * receive RingCentral push notifications. The token returned by this API should be provided
     * when establishing a connection to the RingCentral Websocket Gateway.
     *
     * <p>HTTP Method: post Endpoint: /restapi/oauth/wstoken Rate Limit Group: Auth App Permission:
     * WebSocket
     */

...
class Index(val parent: com.ringcentral.paths.restapi.Index, val subscriptionId: String? = null) {
      ...
      fun list() : com.ringcentral.definitions.RecordsCollectionResourceSubscriptionResponse?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.RecordsCollectionResourceSubscriptionResponse::class.java)
      ...
      fun post(createSubscriptionRequest: com.ringcentral.definitions.CreateSubscriptionRequest) : com.ringcentral.definitions.SubscriptionInfo?
      {
        ...
        return com.google.gson.Gson().fromJson(rb.string(), com.ringcentral.definitions.SubscriptionInfo::class.java)
       ...
       */
      @JvmOverloads fun put(modifySubscriptionRequest: com.ringcentral.definitions.ModifySubscriptionRequest, queryParams: com.ringcentral.definitions.UpdateSubscriptionParameters? = null) : com.ringcentral.definitions.SubscriptionInfo?
      {
          if (this.subscriptionId == null)
          {
              throw NullPointerException("subscriptionId");

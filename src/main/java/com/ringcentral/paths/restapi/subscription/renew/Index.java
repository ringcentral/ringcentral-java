...
public class Index {
     ...
     *
     * <p>Please note that `WebSocket` subscriptions are renewed automatically while websocket
     * session is alive.
     *
     * <p>HTTP Method: post Endpoint: /restapi/{apiVersion}/subscription/{subscriptionId}/renew Rate
     * Limit Group: Light
     */

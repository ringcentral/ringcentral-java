...
public class Index {
    ...
    /**
     * Returns basic information about particular RingCentral account HTTP Method: get Endpoint:
     * /restapi/v2/accounts/{accountId} Rate Limit Group: Light App Permission: ReadAccounts User
    ...
    public com.ringcentral.paths.restapi.v2.accounts.extensions.Index extensions(
            String extensionId) {
        return new com.ringcentral.paths.restapi.v2.accounts.extensions.Index(this, extensionId);
    }
    ...
    public com.ringcentral.paths.restapi.v2.accounts.phonenumbers.Index phoneNumbers(
        ...
        return new com.ringcentral.paths.restapi.v2.accounts.phonenumbers.Index(
                this, phoneNumberId);
    }
    ...
    public com.ringcentral.paths.restapi.v2.accounts.sendactivationemail.Index
            sendActivationEmail() {

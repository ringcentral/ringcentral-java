...
public class Index {
    ...
    /**
     * Creates multiple user extensions with BYOD (customer provided) devices. If
     * &quot;extensionNumber&quot; is not specified, the next available extension number will be
     * assigned.
     *
     * <p>HTTP Method: post Endpoint: /restapi/v2/accounts/{accountId}/batch-provisioning/users Rate
     * Limit Group: Heavy App Permission: EditAccounts
     */
    public BatchProvisionUsersResponse post(BatchProvisionUsersRequest batchProvisionUsersRequest)

...
public class Index {
    ...
    /**
     * Returns the list of cost centers of the account specified in path. HTTP Method: get Endpoint:
     * /restapi/v2/accounts/{accountId}/cost-centers Rate Limit Group: Light App Permission:
     * ReadAccounts User Permission: CostCenterManagement
     */

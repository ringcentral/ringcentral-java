...
public class Index {
    ...
    /**
     * Adds an existing phone (customer provided device - BYOD) as an unassigned device to the
     * account inventory. HTTP Method: post Endpoint:
     * /restapi/v2/accounts/{accountId}/device-inventory Rate Limit Group: Heavy App Permission:
     * EditAccounts
     */
    public AddDeviceToInventoryResponse post(
     ...
     * devices from the account inventory. It is possible to delete up to 10 devices per request.
     *
     * <p>HTTP Method: delete Endpoint: /restapi/v2/accounts/{accountId}/device-inventory Rate Limit
     * Group: Heavy App Permission: EditAccounts
     */
    public DeleteDeviceFromInventoryResponse delete(
            DeleteDeviceFromInventoryRequest deleteDeviceFromInventoryRequest)
            throws com.ringcentral.RestException, java.io.IOException {
        okhttp3.ResponseBody rb =
                this.rc.delete(this.path(), deleteDeviceFromInventoryRequest, null);
        return com.ringcentral.Utils.gson.fromJson(
                rb.string(), DeleteDeviceFromInventoryResponse.class);
    }
}

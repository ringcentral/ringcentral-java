...
public class Index {
    ...
    /**
     * Adds multiple BYOD (customer provided) devices to an account. HTTP Method: post Endpoint:
     * /restapi/v2/accounts/{accountId}/devices/bulk-add Rate Limit Group: Heavy App Permission:
     * EditAccounts User Permission: AddRemoveDevices
     */
    public BulkAddDevicesResponse post(BulkAddDevicesRequest bulkAddDevicesRequest)

...
public class Index {
    ...
    /**
     * Deletes extension(s) of User and Limited types, and depending on device type either keeps or
     * destroys the assets - numbers and devices. If a device is rented or bought in RC, it will be
     * moved to the inventory. A BYOD (Other Phone) device will be deleted. Multiple extensions can
     * be deleted by a single API call.
     *
     * <p>HTTP Method: delete Endpoint: /restapi/v2/accounts/{accountId}/extensions Rate Limit
     * Group: Heavy App Permission: EditAccounts User Permission: Users
     */
    public BulkDeleteUsersResponse delete(BulkDeleteUsersRequest bulkDeleteUsersRequest)
    ...
    public com.ringcentral.paths.restapi.v2.accounts.extensions.devices.Index devices(
            String deviceId) {
        return new com.ringcentral.paths.restapi.v2.accounts.extensions.devices.Index(
                this, deviceId);
    }
    ...
    public com.ringcentral.paths.restapi.v2.accounts.extensions.callflipnumbers.Index
            callFlipNumbers() {

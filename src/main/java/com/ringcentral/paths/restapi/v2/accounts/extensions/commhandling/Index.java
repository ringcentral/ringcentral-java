...
public class Index {
    ...
    public com.ringcentral.paths.restapi.v2.accounts.extensions.commhandling.voice.Index voice() {
        return new com.ringcentral.paths.restapi.v2.accounts.extensions.commhandling.voice.Index(
                this);
    }
    ...
    public com.ringcentral.paths.restapi.v2.accounts.extensions.commhandling.states.Index states(
            String stateId) {
        return new com.ringcentral.paths.restapi.v2.accounts.extensions.commhandling.states.Index(
                this, stateId);
    }
}

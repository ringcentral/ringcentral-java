...
public class Index {
    ...
    public Index(
            com.ringcentral.paths.restapi.v2.accounts.extensions.commhandling.Index parent,
            String stateId) {
        this.parent = parent;
        this.rc = parent.rc;
    ...
    /**
     * Returns a list of communication handling states. HTTP Method: get Endpoint:
     * /restapi/v2/accounts/{accountId}/extensions/{extensionId}/comm-handling/states Rate Limit
     * Group: Medium App Permission: ReadAccounts
     */
    public CommStatesResource list(ListCicStatesParameters queryParams)
    ...
    /**
     * Returns a communication handling state. HTTP Method: get Endpoint:

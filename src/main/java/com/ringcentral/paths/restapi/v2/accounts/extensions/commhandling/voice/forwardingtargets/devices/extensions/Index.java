...
public class Index {
    ...
    public Index(
            com.ringcentral.paths.restapi.v2.accounts.extensions.commhandling.voice
                            .forwardingtargets.devices.Index
                    parent) {
        this.parent = parent;
        this.rc = parent.rc;
    }
    ...
    /**
     * Returns a list of extensions which use the specified device as a forwarding target. HTTP
     * Method: get Endpoint:
     ...
     */
    public CommExtensionListResource get()

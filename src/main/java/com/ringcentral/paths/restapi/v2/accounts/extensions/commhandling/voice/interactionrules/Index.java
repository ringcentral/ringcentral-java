...
public class Index {
    ...
    /**
     * Returns a list of extension&#039;s interaction rules with the detailed information on each
     * rule.
     *
     * <p>*Interaction* rule is a call handling rule, managing voice call on the basis of the
     * user&#039;s **contact** or a **phone number** which is calling and/or being called.
     *
     * <p>**Please note:** Interaction rules are applicable to the User extension types only: User,
     ...
     */
    public CommInteractionRulesResource list(ListVoiceInteractionRulesParameters queryParams)
    ...
    public CommInteractionRulesResource list()
            throws com.ringcentral.RestException, java.io.IOException {
     ...
     */
    public CommInteractionRuleResource post(
            CommInteractionRuleCreateRequest commInteractionRuleCreateRequest)
            throws com.ringcentral.RestException, java.io.IOException {
        okhttp3.ResponseBody rb =
                this.rc.post(this.path(false), commInteractionRuleCreateRequest, null);
     ...
     * Rate Limit Group: Medium App Permission: ReadAccounts
     */
    public CommInteractionRuleResource get()
            throws com.ringcentral.RestException, java.io.IOException {
        if (ruleId == null) {
    ...
    /**
     * Deletes the extension&#039;s interaction rule by ID specified in URL. HTTP Method: delete
     * Endpoint:
     * /restapi/v2/accounts/{accountId}/extensions/{extensionId}/comm-handling/voice/interaction-rules/{ruleId}
     * Rate Limit Group: Medium App Permission: EditExtensions
     */
    ...
    /**
     * Updates the extension&#039;s interaction rule by ID specified in URL. HTTP Method: patch
     * Endpoint:
     * /restapi/v2/accounts/{accountId}/extensions/{extensionId}/comm-handling/voice/interaction-rules/{ruleId}
     * Rate Limit Group: Medium App Permission: EditExtensions
     */
    public CommInteractionRuleResource patch(
        ...
        okhttp3.ResponseBody rb =
                this.rc.patch(this.path(), commInteractionRuleUpdateRequest, null);
        return com.ringcentral.Utils.gson.fromJson(rb.string(), CommInteractionRuleResource.class);
    }
}

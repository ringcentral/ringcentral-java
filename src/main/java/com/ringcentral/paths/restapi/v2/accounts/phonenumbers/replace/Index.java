...
public class Index {
    ...
    /**
     * Replaces (swaps) phone numbers from inventory with the main, company, direct or company fax
     * numbers. This method is used to replace temporary numbers when the porting process is
     * complete.
     *
     * <p>HTTP Method: post Endpoint:
     * /restapi/v2/accounts/{accountId}/phone-numbers/{phoneNumberId}/replace Rate Limit Group:
     * Medium App Permission: EditAccounts User Permission: EditCompanyPhoneNumbers
     */
    public AccountPhoneNumberInfo post(ReplacePhoneNumberRequest replacePhoneNumberRequest)

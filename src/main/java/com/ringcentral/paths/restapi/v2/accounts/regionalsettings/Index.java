...
public class Index {
    ...
    /**
     * Returns the account&#039;s regional settings. HTTP Method: get Endpoint:
     * /restapi/v2/accounts/{accountId}/regional-settings Rate Limit Group: Light App Permission:
     * ReadAccounts
     */
    ...
    /**
     * Updates the account&#039;s regional settings. HTTP Method: patch Endpoint:
     * /restapi/v2/accounts/{accountId}/regional-settings Rate Limit Group: Medium App Permission:
     * EditAccounts
     */
    public RegionalSettings patch(AccountRegionalSettingRequest accountRegionalSettingRequest)

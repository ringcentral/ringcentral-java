...
public class Index {
    ...
    /**
     * Sends/resends activation email to the system user of unconfirmed account. HTTP Method: post
     * Endpoint: /restapi/v2/accounts/{accountId}/send-activation-email Rate Limit Group: Medium App
     * Permission: EditAccounts User Permission: AccountAdministration
     */

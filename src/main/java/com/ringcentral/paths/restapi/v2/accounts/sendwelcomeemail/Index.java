...
public class Index {
    ...
    /**
     * Sends or re-sends welcome email to the system user of confirmed account HTTP Method: post
     * Endpoint: /restapi/v2/accounts/{accountId}/send-welcome-email Rate Limit Group: Medium App
     * Permission: EditExtensions User Permission: Users
     */
    public String post(SendWelcomeEmailV2Request sendWelcomeEmailV2Request)

...
public class Index {
    ...
    /**
     * Returns the list of supported SCIM resource types HTTP Method: get Endpoint:
     * /scim/{version}/ResourceTypes Rate Limit Group: Light App Permission: ReadAccounts
     */
    public ScimResourceTypeSearchResponse list()
            throws com.ringcentral.RestException, java.io.IOException {
        okhttp3.ResponseBody rb = this.rc.get(this.path(false), null);
        return com.ringcentral.Utils.gson.fromJson(
                rb.string(), ScimResourceTypeSearchResponse.class);
    }

    /**
     * Returns resource type by ID HTTP Method: get Endpoint: /scim/{version}/ResourceTypes/{type}
     * Rate Limit Group: Light App Permission: ReadAccounts
     */
    public ScimResourceTypeResponse get()
            throws com.ringcentral.RestException, java.io.IOException {
        if (type == null) {

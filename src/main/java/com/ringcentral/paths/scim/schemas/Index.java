...
public class Index {
    ...
    /**
     * Returns the list of schemas HTTP Method: get Endpoint: /scim/{version}/Schemas Rate Limit
     * Group: Light App Permission: ReadAccounts
     */
    public ScimSchemaSearchResponse list()
    ...
    /**
     * Returns SCIM schema HTTP Method: get Endpoint: /scim/{version}/Schemas/{uri} Rate Limit
     * Group: Light App Permission: ReadAccounts
     */

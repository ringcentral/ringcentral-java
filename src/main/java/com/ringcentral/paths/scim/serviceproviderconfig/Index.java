...
public class Index {
    ...
    /**
     * Returns SCIM service provider configuration HTTP Method: get Endpoint:
     * /scim/{version}/ServiceProviderConfig Rate Limit Group: Light App Permission: ReadAccounts
     */

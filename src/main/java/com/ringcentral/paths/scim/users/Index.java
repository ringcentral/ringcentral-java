...
public class Index {
    ...
    /**
     * Returns the list of users satisfying search criteria HTTP Method: get Endpoint:
     * /scim/{version}/Users Rate Limit Group: Light App Permission: ReadAccounts
     */
    public ScimUserSearchResponse list(ScimSearchViaGet2Parameters queryParams)
    ...
    /**
     * Creates a new user HTTP Method: post Endpoint: /scim/{version}/Users Rate Limit Group: Heavy
     * App Permission: EditAccounts
     */
    public ScimUserResponse post(ScimUser scimUser)
            throws com.ringcentral.RestException, java.io.IOException {
    ...
    /**
     * Returns a user by ID HTTP Method: get Endpoint: /scim/{version}/Users/{scimUserId} Rate Limit
    ...
    /**
     * Updates a user HTTP Method: put Endpoint: /scim/{version}/Users/{scimUserId} Rate Limit
     * Group: Heavy App Permission: EditAccounts
     */
    public ScimUserResponse put(ScimUser scimUser)
            throws com.ringcentral.RestException, java.io.IOException {
        if (scimUserId == null) {
            throw new IllegalArgumentException("Parameter scimUserId cannot be null");
        }
    ...
    /**
     * Deletes a user HTTP Method: delete Endpoint: /scim/{version}/Users/{scimUserId} Rate Limit
     * Group: Heavy App Permission: EditAccounts
     */
    ...
    /**
     * Updates a user (partial update) HTTP Method: patch Endpoint:
     * /scim/{version}/Users/{scimUserId} Rate Limit Group: Heavy App Permission: EditAccounts
     */
    public ScimUserResponse patch(ScimUserPatch scimUserPatch)
            throws com.ringcentral.RestException, java.io.IOException {
        if (scimUserId == null) {
            throw new IllegalArgumentException("Parameter scimUserId cannot be null");
        }

...
class Index(val parent: com.ringcentral.paths.scim.Index, val id: String? = null) {
       ...
       */
      @JvmOverloads fun list(queryParams: com.ringcentral.definitions.SearchViaGet2Parameters? = null) : com.ringcentral.definitions.UserSearchResponse?
      {
      ...
      fun post(createUser: com.ringcentral.definitions.CreateUser) : com.ringcentral.definitions.UserResponse?
      {
        ...
        return com.ringcentral.Utils.gson.fromJson(rb.string(), com.ringcentral.definitions.UserResponse::class.java)

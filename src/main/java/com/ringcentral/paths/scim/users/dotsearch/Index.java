...
public class Index {
    ...
    /**
     * Returns the list of users satisfying search criteria HTTP Method: post Endpoint:
     * /scim/{version}/Users/dotSearch Rate Limit Group: Light App Permission: ReadAccounts
     */
    public ScimUserSearchResponse post(ScimSearchRequest scimSearchRequest)

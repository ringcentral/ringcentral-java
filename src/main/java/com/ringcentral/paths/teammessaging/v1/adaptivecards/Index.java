package com.ringcentral.paths.teammessaging.v1.adaptivecards;
...
public class Index {
    ...
    public Index(com.ringcentral.paths.teammessaging.v1.Index parent, String cardId) {
        this.parent = parent;
        this.rc = parent.rc;
        this.cardId = cardId;
    }
    ...
    /**
     * Returns adaptive card(s) with given id(s). HTTP Method: get Endpoint:
     * /team-messaging/v1/adaptive-cards/{cardId} Rate Limit Group: Medium App Permission:
     * TeamMessaging
     */
    ...
    /**
     * Updates an adaptive card. HTTP Method: put Endpoint:
     * /team-messaging/v1/adaptive-cards/{cardId} Rate Limit Group: Medium App Permission:
     * TeamMessaging
     */
    public AdaptiveCardShortInfo put(AdaptiveCardRequest adaptiveCardRequest)
    ...
    /**
     * Deletes an adaptive card by ID. HTTP Method: delete Endpoint:
     * /team-messaging/v1/adaptive-cards/{cardId} Rate Limit Group: Medium App Permission:
     * TeamMessaging
     */

...
public class Index {
    ...
    /**
     * Creates a new adaptive card in the chat specified in path. HTTP Method: post Endpoint:
     * /team-messaging/v1/chats/{chatId}/adaptive-cards Rate Limit Group: Medium App Permission:
     * TeamMessaging
     */
    public AdaptiveCardShortInfo post(AdaptiveCardRequest adaptiveCardRequest)

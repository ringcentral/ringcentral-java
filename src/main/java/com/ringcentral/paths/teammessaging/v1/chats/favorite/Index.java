...
public class Index {
    ...
    /**
     * Adds the specified chat to the users&#039;s list of favorite chats. HTTP Method: post
     * Endpoint: /team-messaging/v1/chats/{chatId}/favorite Rate Limit Group: Medium App Permission:
     * TeamMessaging
     */

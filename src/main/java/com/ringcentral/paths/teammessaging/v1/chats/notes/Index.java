...
public class Index {
    ...
    /**
     * Returns the list of chat notes. HTTP Method: get Endpoint:
     * /team-messaging/v1/chats/{chatId}/notes Rate Limit Group: Heavy App Permission: TeamMessaging
     */
    public TMNoteList get(ListChatNotesNewParameters queryParams)
    ...
    /**
     * Creates a new note in the specified chat. HTTP Method: post Endpoint:
     * /team-messaging/v1/chats/{chatId}/notes Rate Limit Group: Medium App Permission:
     * TeamMessaging
     */
    public TMNoteInfo post(TMCreateNoteRequest tMCreateNoteRequest)
            throws com.ringcentral.RestException, java.io.IOException {

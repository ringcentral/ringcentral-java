...
public class Index {
    ...
    /**
     * Returns the list of tasks of the specified chat. HTTP Method: get Endpoint:
     * /team-messaging/v1/chats/{chatId}/tasks Rate Limit Group: Heavy App Permission: TeamMessaging
     */
    public TMTaskList get(ListChatTasksNewParameters queryParams)
    ...
    /**
     * Creates a task in the specified chat. HTTP Method: post Endpoint:
     * /team-messaging/v1/chats/{chatId}/tasks Rate Limit Group: Medium App Permission:
     * TeamMessaging
     */
    public TMTaskInfo post(TMCreateTaskRequest tMCreateTaskRequest)
            throws com.ringcentral.RestException, java.io.IOException {

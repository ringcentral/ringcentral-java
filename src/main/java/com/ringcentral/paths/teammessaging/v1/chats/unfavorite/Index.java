...
public class Index {
    ...
    /**
     * Removes the specified chat from the users&#039;s list of favorite chats. HTTP Method: post
     * Endpoint: /team-messaging/v1/chats/{chatId}/unfavorite Rate Limit Group: Medium App

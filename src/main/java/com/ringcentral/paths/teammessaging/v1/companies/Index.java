package com.ringcentral.paths.teammessaging.v1.companies;
...
public class Index {
    ...
    public Index(com.ringcentral.paths.teammessaging.v1.Index parent, String companyId) {
        this.parent = parent;
        this.rc = parent.rc;
    ...
    /**
     * Returns information about one or more companies by their IDs. HTTP Method: get Endpoint:
     * /team-messaging/v1/companies/{companyId} Rate Limit Group: Light App Permission:
     * TeamMessaging
     */

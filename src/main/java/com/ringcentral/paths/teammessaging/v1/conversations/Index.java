...
public class Index {
     ...
     * sorted by creation time of a conversation in ascending order. Conversation is a chat of the
     * *Group* type. HTTP Method: get Endpoint: /team-messaging/v1/conversations Rate Limit Group:
     * Medium App Permission: TeamMessaging
     */
    public TMConversationList list(ListGlipConversationsNewParameters queryParams)
    ...
    /**
     * Creates a new conversation or opens the existing one. If the conversation already exists,
     * then its ID will be returned in response. A conversation is an adhoc discussion between a
     * particular set of users, not featuring any specific name or description; it is a chat of
     * &#039;Group&#039; type. If you add a person to the existing conversation (group), it creates
     * a whole new conversation. HTTP Method: post Endpoint: /team-messaging/v1/conversations Rate
     * Limit Group: Medium App Permission: TeamMessaging
     */
    public TMConversationInfo post(CreateConversationRequest createConversationRequest)
            throws com.ringcentral.RestException, java.io.IOException {
     ...
     * featuring any specific name or description; it is a chat of &#039;Group&#039; type. If you
     * add a person to the existing conversation, it creates a whole new conversation. HTTP Method:
     * get Endpoint: /team-messaging/v1/conversations/{chatId} Rate Limit Group: Light App

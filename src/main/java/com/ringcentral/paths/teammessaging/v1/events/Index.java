...
public class Index {
    ...
    /**
     * Returns all calendar events created by the current user. HTTP Method: get Endpoint:
     * /team-messaging/v1/events Rate Limit Group: Medium App Permission: TeamMessaging
     */
    public TMEventList list(ReadGlipEventsNewParameters queryParams)
    ...
    /**
     * Creates a new calendar event. HTTP Method: post Endpoint: /team-messaging/v1/events Rate
     * Limit Group: Medium App Permission: TeamMessaging
     */
    public TMEventInfo post(TMCreateEventRequest tMCreateEventRequest)
            throws com.ringcentral.RestException, java.io.IOException {
    ...
    /**
     * Returns the specified calendar event(s) by ID(s). HTTP Method: get Endpoint:
     * /team-messaging/v1/events/{eventId} Rate Limit Group: Medium App Permission: TeamMessaging
     */
    ...
    /**
     * Updates the specified calendar event. HTTP Method: put Endpoint:
     * /team-messaging/v1/events/{eventId} Rate Limit Group: Medium App Permission: TeamMessaging
     */
    public TMEventInfo put(TMCreateEventRequest tMCreateEventRequest)
            throws com.ringcentral.RestException, java.io.IOException {
        if (eventId == null) {
            throw new IllegalArgumentException("Parameter eventId cannot be null");
        }
    ...
    /**
     * Deletes the specified calendar event. HTTP Method: delete Endpoint:
     * /team-messaging/v1/events/{eventId} Rate Limit Group: Medium App Permission: TeamMessaging
     */

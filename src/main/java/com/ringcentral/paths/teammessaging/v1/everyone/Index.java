...
public class Index {
    ...
    /**
     * Returns information about &quot;Everyone&quot; chat (a company level chat which includes all
     * employees). HTTP Method: get Endpoint: /team-messaging/v1/everyone Rate Limit Group: Light
    ...
    /**
     * Updates &quot;Everyone&quot; chat information. HTTP Method: patch Endpoint:
     * /team-messaging/v1/everyone Rate Limit Group: Medium App Permission: TeamMessaging
     */
    public EveryoneTeamInfo patch(UpdateEveryoneTeamRequest updateEveryoneTeamRequest)

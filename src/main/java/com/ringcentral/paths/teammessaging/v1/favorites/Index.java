...
public class Index {
    ...
    /**
     * Returns a list of the current user&#039;s favorite chats. HTTP Method: get Endpoint:
     * /team-messaging/v1/favorites Rate Limit Group: Light App Permission: TeamMessaging
     */
    public TMChatListWithoutNavigation get(ListFavoriteChatsNewParameters queryParams)
    ...
    public TMChatListWithoutNavigation get()
            throws com.ringcentral.RestException, java.io.IOException {

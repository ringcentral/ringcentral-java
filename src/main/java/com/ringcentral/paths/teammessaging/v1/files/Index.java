...
public class Index {
    ...
    /**
     * Posts a file or multiple files. HTTP Method: post Endpoint: /team-messaging/v1/files Rate
     * Limit Group: Heavy App Permission: TeamMessaging
     */
    public TMAddFile[] post(
            CreateGlipFileNewRequest createGlipFileNewRequest,
            CreateGlipFileNewParameters queryParams)
    ...
    public TMAddFile[] post(CreateGlipFileNewRequest createGlipFileNewRequest)
            throws com.ringcentral.RestException, java.io.IOException {

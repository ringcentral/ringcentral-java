...
public class Index {
     ...
     * Users can only see their personal tasks and public tasks. HTTP Method: get Endpoint:
     * /team-messaging/v1/groups/{groupId}/events Rate Limit Group: Medium App Permission:
     * TeamMessaging
     */
    ...
    /**
     * Creates a new calendar event within the specified group. HTTP Method: post Endpoint:
     * /team-messaging/v1/groups/{groupId}/events Rate Limit Group: Medium App Permission:
     * TeamMessaging
     */

...
public class Index {
    ...
    /**
     * Returns webhooks which are available for the current user by group ID. HTTP Method: get
     * Endpoint: /team-messaging/v1/groups/{groupId}/webhooks Rate Limit Group: Medium App
    ...
    /**
     * Creates a new webhook. HTTP Method: post Endpoint:
     * /team-messaging/v1/groups/{groupId}/webhooks Rate Limit Group: Medium App Permission:
     * TeamMessaging
     */

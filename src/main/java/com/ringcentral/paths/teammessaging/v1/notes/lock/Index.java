...
public class Index {
    ...
    /**
     * Locks a note providing the user with the unique write access for 5 hours. HTTP Method: post
     * Endpoint: /team-messaging/v1/notes/{noteId}/lock Rate Limit Group: Light App Permission:
     * TeamMessaging
     */

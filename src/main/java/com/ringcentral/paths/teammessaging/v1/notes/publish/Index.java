...
public class Index {
    ...
    /**
     * Publishes a note making it visible to other users. HTTP Method: post Endpoint:
     * /team-messaging/v1/notes/{noteId}/publish Rate Limit Group: Medium App Permission:
     * TeamMessaging
     */

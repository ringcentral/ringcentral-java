...
public class Index {
    ...
    /**
     * Unlocks a note letting other users edit this note. Once the note is locked (by another user)
     * it cannot be unlocked during 5 hours since the lock datetime. HTTP Method: post Endpoint:
     * /team-messaging/v1/notes/{noteId}/unlock Rate Limit Group: Light App Permission:
     * TeamMessaging
     */

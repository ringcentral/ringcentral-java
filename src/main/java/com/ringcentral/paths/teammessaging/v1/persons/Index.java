...
public class Index {
    ...
    /**
     * Returns a user or multiple users by their ID(s). [Bulk
     * requests](https://developers.ringcentral.com/guide/basics/batch-requests) are supported.
     *
     * <p>HTTP Method: get Endpoint: /team-messaging/v1/persons/{personId} Rate Limit Group: Light

...
public class Index {
     ...
     * HTTP Method: get Endpoint: /team-messaging/v1/recent/chats Rate Limit Group: Light App
     * Permission: TeamMessaging
     */
    public TMChatListWithoutNavigation get(ListRecentChatsNewParameters queryParams)

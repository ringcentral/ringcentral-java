...
public class Index {
    ...
    /**
     * Returns information about the specified task(s) by ID(s). HTTP Method: get Endpoint:
     * /team-messaging/v1/tasks/{taskId} Rate Limit Group: Medium App Permission: TeamMessaging
     */
    ...
    /**
     * Deletes the specified task. HTTP Method: delete Endpoint: /team-messaging/v1/tasks/{taskId}
    ...
    /**
     * Updates the specified task by ID. HTTP Method: patch Endpoint:
     * /team-messaging/v1/tasks/{taskId} Rate Limit Group: Medium App Permission: TeamMessaging
     */
    public TMTaskList patch(TMUpdateTaskRequest tMUpdateTaskRequest)

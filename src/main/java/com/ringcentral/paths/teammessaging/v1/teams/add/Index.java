...
public class Index {
    ...
    /**
     * Adds members to the specified team. HTTP Method: post Endpoint:
     * /team-messaging/v1/teams/{chatId}/add Rate Limit Group: Medium App Permission: TeamMessaging
     */
    public String post(TMAddTeamMembersRequest tMAddTeamMembersRequest)

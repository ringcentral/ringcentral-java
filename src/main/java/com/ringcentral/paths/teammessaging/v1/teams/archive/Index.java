...
public class Index {
    ...
    /**
     * Changes the status of the specified team to &#039;Archived&#039;. HTTP Method: post Endpoint:
     * /team-messaging/v1/teams/{chatId}/archive Rate Limit Group: Medium App Permission:
     * TeamMessaging
     */

...
public class Index {
    ...
    /**
     * Adds the current user to the specified team. HTTP Method: post Endpoint:
     * /team-messaging/v1/teams/{chatId}/join Rate Limit Group: Medium App Permission: TeamMessaging
     */

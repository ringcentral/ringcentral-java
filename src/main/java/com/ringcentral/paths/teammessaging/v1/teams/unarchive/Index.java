...
public class Index {
    ...
    /**
     * Changes the status of the specified team to &#039;Active&#039;. HTTP Method: post Endpoint:
     * /team-messaging/v1/teams/{chatId}/unarchive Rate Limit Group: Medium App Permission:
     * TeamMessaging
     */

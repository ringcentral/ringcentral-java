...
public class Index {
    ...
    /**
     * Returns the list of all webhooks associated with the current account. HTTP Method: get
     * Endpoint: /team-messaging/v1/webhooks Rate Limit Group: Medium App Permission: TeamMessaging
     */
    ...
    /**
     * Returns webhooks(s) with the specified id(s). HTTP Method: get Endpoint:
     * /team-messaging/v1/webhooks/{webhookId} Rate Limit Group: Medium App Permission:
     * TeamMessaging
     */
    ...
    /**
     * Deletes a webhook by ID. HTTP Method: delete Endpoint:
     * /team-messaging/v1/webhooks/{webhookId} Rate Limit Group: Medium App Permission:
     * TeamMessaging
     */

package com.ringcentral.paths.teammessaging.webhooks;
...
public Index(com.ringcentral.paths.teammessaging.Index parent, String webhookId)
      {
this.parent = parent;
this.rc = parent.rc;
this.webhookId = webhookId;
  ...
  public String delete() throws com.ringcentral.RestException, java.io.IOException
  {
    ...
    public com.ringcentral.paths.teammessaging.webhooks.suspend.Index suspend()
  {
    return new com.ringcentral.paths.teammessaging.webhooks.suspend.Index(this);
  }


    public com.ringcentral.paths.teammessaging.webhooks.activate.Index activate()
  {
    return new com.ringcentral.paths.teammessaging.webhooks.activate.Index(this);
  }

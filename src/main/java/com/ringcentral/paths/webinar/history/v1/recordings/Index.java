...
public class Index {
     ...
     *
     * <p>HTTP Method: get Endpoint: /webinar/history/v1/recordings Rate Limit Group: Heavy App
     * Permission: ReadWebinars
     */
    public RecordingListResource list(RcwHistoryListRecordingsParameters queryParams)
    ...
    /**
     * Returns the webinar recording by ID (Webinar host&#039;s interface). This API also returns
     * sharing link if sharing is enabled.
     *
     * <p>HTTP Method: get Endpoint: /webinar/history/v1/recordings/{recordingId} Rate Limit Group:
     * Heavy App Permission: ReadWebinars
     */
    public RecordingItemExtendedModel get()
            throws com.ringcentral.RestException, java.io.IOException {
        if (recordingId == null) {

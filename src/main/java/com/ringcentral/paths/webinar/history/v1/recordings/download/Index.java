...
public class Index {
     ...
     *
     * <p>If called by a webinar host, the API returns error (403) if recording downloading is
     * prohibited by company settings. The admin user who has &quot;WebinarSettings&quot; permission
     * should be able to download recording regardless of current company settings.
     *
     * <p>HTTP Method: get Endpoint: /webinar/history/v1/recordings/{recordingId}/download Rate
     * Limit Group: Heavy App Permission: ReadWebinars
     */
    public RecordingDownloadModel get(RcwHistoryGetRecordingDownloadParameters queryParams)

...
public class Index {
    ...
    /**
     * Returns a historical webinar Session by ID. Access allowed to participants with original role
     * as Host or CoHost. HTTP Method: get Endpoint:
     * /webinar/history/v1/webinars/{webinarId}/sessions/{sessionId} Rate Limit Group: Heavy App
    ...
    public com.ringcentral.paths.webinar.history.v1.webinars.sessions.invitees.Index invitees(
            String inviteeId) {
        return new com.ringcentral.paths.webinar.history.v1.webinars.sessions.invitees.Index(
                this, inviteeId);
    }

    public com.ringcentral.paths.webinar.history.v1.webinars.sessions.participants.Index
            participants() {
        return new com.ringcentral.paths.webinar.history.v1.webinars.sessions.participants.Index(
                this);
    }
}

...
public class Index {
    ...
    public Index(
            com.ringcentral.paths.webinar.history.v1.webinars.sessions.Index parent,
            String inviteeId) {
        this.parent = parent;
        this.rc = parent.rc;
    ...
    /**
     * Returns the list of Invitees (co-hosts and panelists) of a given Webinar Session (host
     * interface). An implicit record created for a Webinar &#039;Host&#039; is always returned.
     *
     * <p>HTTP Method: get Endpoint:
     * /webinar/history/v1/webinars/{webinarId}/sessions/{sessionId}/invitees Rate Limit Group:
     * Heavy App Permission: ReadWebinars
     */
    public InviteeListResource list(RcwHistoryListInviteesParameters queryParams)
    ...
    /**
     * Returns a historical session invitee information by ID (host interface). HTTP Method: get
     * Endpoint: /webinar/history/v1/webinars/{webinarId}/sessions/{sessionId}/invitees/{inviteeId}
     * Rate Limit Group: Heavy App Permission: ReadWebinars
     */

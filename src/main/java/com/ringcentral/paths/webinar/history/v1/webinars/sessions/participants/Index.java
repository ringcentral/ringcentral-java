...
public class Index {
     ...
     * /webinar/history/v1/webinars/{webinarId}/sessions/{sessionId}/participants Rate Limit Group:
     * Heavy App Permission: ReadWebinars
     */
    public ParticipantListResource get(RcwHistoryListParticipantsParameters queryParams)
    ...
    public com.ringcentral.paths.webinar.history.v1.webinars.sessions.participants.self.Index
            self() {
        return new com.ringcentral.paths.webinar.history.v1.webinars.sessions.participants.self
                .Index(this);
    }
}

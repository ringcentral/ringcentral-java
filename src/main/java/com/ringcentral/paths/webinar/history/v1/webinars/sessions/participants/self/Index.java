...
public class Index {
    ...
    public Index(
            com.ringcentral.paths.webinar.history.v1.webinars.sessions.participants.Index parent) {
        this.parent = parent;
        this.rc = parent.rc;
    }
    ...
    /**
     * Returns the participant information specific to a webinar session. Accessible by any
     * authenticated participant. For a non-authenticated participant, API returns error.
     *
     * <p>HTTP Method: get Endpoint:
     * /webinar/history/v1/webinars/{webinarId}/sessions/{sessionId}/participants/self Rate Limit

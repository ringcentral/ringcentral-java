...
public class Index {
     ...
     *
     * <p>HTTP Method: get Endpoint: /webinar/registration/v1/sessions/{sessionId} Rate Limit Group:
     ...
     *
     * <p>This is a PARTIAL update (PATCH), client may call it providing only attributes which are
     * to be changed.
     *
     * <p>A caller must be an authorized user: either a host of the webinar or an IT Admin: a user
     * from host&#039;s account with &quot;WebinarSettings&quot; permission.
     *
     * <p>If a session record with given ID doesn&#039;t exist on Registration Service side the API
     * should return HTTP 404.
     *
     * <p>HTTP Method: patch Endpoint: /webinar/registration/v1/sessions/{sessionId} Rate Limit
     * Group: Heavy App Permission: EditWebinars
     */
    public RegSessionModel patch(RegSessionModel regSessionModel)
    ...
    public com.ringcentral.paths.webinar.registration.v1.sessions.registrants.Index registrants(
            String registrantId) {
        return new com.ringcentral.paths.webinar.registration.v1.sessions.registrants.Index(
                this, registrantId);
    }
}

...
public class Index {
     ...
     *
     * <p>This endpoint follows the [OpenID Connect Discovery
     * 1.0](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata)
     * specification. It provides a mechanism for an OpenID Connect Relying Party to discover the
     * End-User&#039;s OpenID Provider and obtain information needed to interact with it, including
     * its OAuth 2.0 endpoint locations.
     *
     * <p>HTTP Method: get Endpoint: /.well-known/openid-configuration Rate Limit Group:
     * NoThrottling
     */

...
public class BridgeTest {
    ...
    public void testFindBridgeByBridgeId() throws RestException, IOException {
        BridgeResponse bridgeResponse =
                rc.rcvideo()
                        ...
                        .bridges()
                        .post(ConstantContent.createBridgeRequest());
        BridgeResponse bridgeResponseByGet = rc.rcvideo().v2().bridges(bridgeResponse.id).get();
    ...
    public void testDeleteBridgeByBridgeId() throws RestException, IOException {
        BridgeResponse bridgeResponse =
                rc.rcvideo()
                        ...
                        .bridges()
                        .post(ConstantContent.createBridgeRequest());
        String deleteBridge = rc.rcvideo().v2().bridges(bridgeResponse.id).delete();
    ...
    public void testFindDefaultBridge() throws RestException, IOException {
        BridgeResponse bridgeResponse =
                rc.rcvideo().v2().account("~").extension("~").bridges().default1().get();
    ...
    @Test
    public void testfindBridgeUsingHostPSTPin() throws RestException, IOException {
        BridgeResponse bridgeResponse =
                rc.rcvideo()
                        .v2()
                        .account("~")
                        ...
                        .bridges()
                        .post(ConstantContent.createBridgeRequest());
        BridgeResponse bridgeResponseByhost =
                rc.rcvideo().v2().bridges().pin().pstn(bridgeResponse.pins.pstn.host).get();
    ...
    @Test
    public void testfindBridgeUsingParticipantPSTPin() throws RestException, IOException {
        BridgeResponse bridgeResponse =
                rc.rcvideo()
                        .v2()
                        .account("~")
                        ...
                        .post(ConstantContent.createBridgeRequest());
        BridgeResponse bridgeResponseByhost =
                rc.rcvideo().v2().bridges().pin().pstn(bridgeResponse.pins.pstn.participant).get();
        Assert.assertEquals("RC Video Test", bridgeResponseByhost.name);
        String deletedResponse = rc.rcvideo().v2().bridges(bridgeResponse.id).delete();
        Assert.assertEquals("", deletedResponse);
    }
    ...
    public void testfindBridgeUsingWebPin() throws RestException, IOException {
        BridgeResponse bridgeResponse =
                rc.rcvideo()
                        ...
                        .post(ConstantContent.createBridgeRequest());
        BridgeResponse bridgeResponseByhost =
                rc.rcvideo().v2().bridges().pin().web(bridgeResponse.pins.web).get();
        Assert.assertEquals("RC Video Test", bridgeResponseByhost.name);
        String deletedResponse = rc.rcvideo().v2().bridges(bridgeResponse.id).delete();
        Assert.assertEquals("", deletedResponse);
    }
